...
with open(r"D:\skills\skill-registry\clawhub_withdrawal_list.json", "r", encoding="utf-8") as f:
...
# Save results
with open(r"D:\skills\skill-registry\clawhub_delete_results.json", "w", encoding="utf-8") as f:
    json.dump({"success": success, "failed": failed}, f, indent=2, ensure_ascii=False)

print(f"Results saved to D:\\skills\\skill-registry\\clawhub_delete_results.json")
