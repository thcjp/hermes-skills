...
For detailed examples, see [EXAMPLES.md](/api/v1/skills/browser-automation/file?path=EXAMPLES.md&ownerHandle=peytoncasper).
For API reference, see [REFERENCE.md](/api/v1/skills/browser-automation/file?path=REFERENCE.md&ownerHandle=peytoncasper).
...
- Use when the user asks
- 触发关键词: using, interactions, automation, browser, natural, automate
