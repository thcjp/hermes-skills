...
license: MIT
description: |-
  Blockchain security API for AI agents。Scan tokens, simulate transactions,
  check addresses for th。Use when 需要AI模型调用、智能对话、Agent编排、LLM应用时使用。不适用于需要100%确定性的关键决策。
tags:
- Security
tools:
  - - read
