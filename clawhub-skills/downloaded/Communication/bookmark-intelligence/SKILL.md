...
version: "1.0.0"
displayName: Bookmark Intelligence
...
See [examples/sample-analysis.json](/api/v1/skills/bookmark-intelligence/file?path=examples%2Fsample-analysis.json&ownerHandle=bkrigmo1) for a full example.
...
* `notifyTelegram` - Get notified about high-value insights (requires Skill平台)
...
If you're running this inside Skill平台 (not standalone), you can get Telegram notifications for high-value insights.
...
See [examples/sample-notification.md](/api/v1/skills/bookmark-intelligence/file?path=examples%2Fsample-notification.md&ownerHandle=bkrigmo1) for a full example.
...
* Nothing is sent to any third party except:
  ...
  + OpenAI/Anthropic (for AI analysis, if using Skill平台 LLM)
  + Linked websites (to fetch article content)

**Can I use this without Skill平台?**
...
Open an issue on SkillHub or submit a PR!
...
**Q: Do I need Skill平台 to use this?**
A: No! It works standalone. With Skill平台 you get LLM analysis and notifications, but it's optional.
...
**Made with ❤️ for Skill平台**

Questions? Check the troubleshooting section above or ask in the Skill平台 community!
