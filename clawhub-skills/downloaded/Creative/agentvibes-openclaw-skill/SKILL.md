...
version: "4.6.6"
displayName: Skill
summary: 🎤 AgentVibes TTS for Claude Code & OpenClaw — Switch voices, set personality,
  control speed, back...
license: MIT-0
description: |-
  🎤 AgentVibes TTS for Claude Code & OpenClaw — Switch voices, set personality,
  control speed, back...
  ...
  触发关键词: switch, code, claude, openclaw, agentvibes, skill
tags:
- Creative
tools:
- read
...
Professional text-to-speech for Claude Code and Skill平台. Free, offline, no account required.
