...
license: MIT
description: |-
  AI图像生成与编辑。支持文生图、图+文生图、风格转换。Use when 需要文件处理、文档转换、格式互转、内容提取时使用。不适用于加密文件破解。适用于独立开发者、企业团队和自动化工作流场景。Use when 需要文件处理、文档转换、格式互转、内容提取时使用。不适用于加密文件破解。适用于独立开发者、企业团队和自动化工作流场景。
tags:
- Creative
tools:
  - - read
...
- 支持文生图、图+文生图、风格转换
- 当用户要求画图、生成图片、编辑图片、图片风格转换时使用此 skill
- 支持多种比例（1:1、3:2、16:9、21:9
  等）和分辨率（标准、
...
### Q1: 如何开始使用AI Image Gen？
A: 请先阅读使用流程章节，确认环境满足依赖说明中的要求。

### Q2: 遇到错误怎么办？
A: 请参考错误处理章节，按照表格中的处理方式操作。

### Q3: AI Image Gen有什么限制？
A: 请参考已知限制章节了解具体限制。
