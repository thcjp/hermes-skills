...
license: MIT
description: |-
  Enables AI agents to autonomously browse lifestyle and wellness products,\
  \ place multi-chain crypt。Use when 需要AI模型调用、智能对话、Agent编排、LLM应用时使用。不适用于需要100%确定性的关键决策。
...
**`POST /checkout`** with a JSON body. See [references/CHECKOUT-FIELDS.md](/api/v1/skills/shop-culture/file?path=references%2FCHECKOUT-FIELDS.md&ownerHandle=bythecult) for every field.
...
* [references/API.md](/api/v1/skills/shop-culture/file?path=references%2FAPI.md&ownerHandle=bythecult) — full endpoint reference with request/response shapes
* [references/CHECKOUT-FIELDS.md](/api/v1/skills/shop-culture/file?path=references%2FCHECKOUT-FIELDS.md&ownerHandle=bythecult) — complete checkout body specification with examples
* [references/ERRORS.md](/api/v1/skills/shop-culture/file?path=references%2FERRORS.md&ownerHandle=bythecult) — error codes, recovery patterns, and rate limiting
...
- \n\n触发关键词: gifts, lifestyle,\
  \ agentic, lifestyle,, commerce, â\x80\x94, autonomously, wellness,
...
### Q1: 如何开始使用Shop Culture？
A: 请先阅读使用流程章节，确认环境满足依赖说明中的要求。

### Q2: 遇到错误怎么办？
A: 请参考错误处理章节，按照表格中的处理方式操作。

### Q3: Shop Culture有什么限制？
A: 请参考已知限制章节了解具体限制。
