...
with open(str(DATA_DIR / "clawhub_published_slugs.json"), "r", encoding="utf-8") as f:
...
with open(r"data/reports/clawhub_withdrawal_list.json", "w", encoding="utf-8") as f:
    json.dump(withdrawal_list, f, indent=2, ensure_ascii=False)

print(f"\nWithdrawal list saved to data/reports/clawhub_withdrawal_list.json ({len(withdrawal_list)} skills)")
