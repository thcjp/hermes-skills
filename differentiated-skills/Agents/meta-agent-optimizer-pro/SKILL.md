...
license: Proprietary
edition: pro
description: "元代理调优器专业版是在免费版基础上的全功能升级，为AI Agent包含从日志记录到性能调优的完整闭环。专业版解锁性能指标采集、自发瓶颈诊断、调优建议产出、多平台Hook集成、技能自发提取五大高级功能，达成Agent自我进化的全自发闭环. 适用于需要meta agent optimizer相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 元代理优化
  - 性能指标
  - 瓶颈诊断
