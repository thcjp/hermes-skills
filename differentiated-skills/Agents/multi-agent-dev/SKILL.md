...
**处理**: 按照skill规范执行多代理开发是一个通过子代理编排操作,遵循单一意图原则。
**输出**: 返回多代理开发是一个通过子代理编排的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行针对传统子代理开发"协调开销大、上下文污操作,遵循单一意图原则。
**输出**: 返回针对传统子代理开发"协调开销大、上下文污的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行两阶段评审(规格合规→代码质量操作,遵循单一意图原则。
**输出**: 返回两阶段评审(规格合规→代码质量的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行选择性并行执行独立任务操作,遵循单一意图原则。
**输出**: 返回选择性并行执行独立任务的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
