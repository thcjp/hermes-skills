...
**处理**: 按照skill规范执行类型化实体系统（基础+增强）操作,遵循单一意图原则。
**输出**: 返回类型化实体系统（基础+增强）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行SQLite迁移（专业版独有）操作,遵循单一意图原则。
**输出**: 返回SQLite迁移（专业版独有）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行图可视化（专业版独有）操作,遵循单一意图原则。
**输出**: 返回图可视化（专业版独有）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行SPARQL-like高级查询（专业版独有）操作,遵循单一意图原则。
**输出**: 返回SPARQL-like高级查询（专业版独有）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行版本追踪与差异对比（专业版独有）操作,遵循单一意图原则。
**输出**: 返回版本追踪与差异对比（专业版独有）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行跨技能通信增强（专业版独有）操作,遵循单一意图原则。
**输出**: 返回跨技能通信增强（专业版独有）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多平台集成（专业版独有）操作,遵循单一意图原则。
**输出**: 返回多平台集成（专业版独有）的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行自定义类型与关系扩展（专业版独有）操作,遵循单一意图原则。
**输出**: 返回自定义类型与关系扩展（专业版独有）的执行结果,包含操作状态和输出数据。
