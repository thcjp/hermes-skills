...
**处理**: 按照skill规范执行记忆编排器是面向 AI Agent 的智操作,遵循单一意图原则。
**输出**: 返回记忆编排器是面向 AI Agent 的智的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行它用四层记忆架构（工作/短期/长期/重要操作,遵循单一意图原则。
**输出**: 返回它用四层记忆架构（工作/短期/长期/重要的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行(2) 记忆健康度仪表盘操作,遵循单一意图原则。
**输出**: 返回(2) 记忆健康度仪表盘的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
