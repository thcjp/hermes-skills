...
license: MIT
edition: free
description: "集群编码器免费版为AI Agent包含子代理驱动的开发执行系统，将\"一个人从头到尾做完所有任务\"升级为\"每任务分派新子代理+两阶段review\"的集群协作模式。基于\"新鲜上下文+规范review+质量review\"双阶段审查，达成高质量、快迭代、零上下文污染。Use. 适用于需要swarm coder相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 集群编码
  - 子代理开发
  - 代码审查
