...
**处理**: 按照skill规范执行分层分析策略操作,遵循单一意图原则。
**输出**: 返回分层分析策略的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行文档分块处理操作,遵循单一意图原则。
**输出**: 返回文档分块处理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行假设检测框架操作,遵循单一意图原则。
**输出**: 返回假设检测框架的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行结构化压缩操作,遵循单一意图原则。
**输出**: 返回结构化压缩的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行差异化文档比对操作,遵循单一意图原则。
**输出**: 返回差异化文档比对的执行结果,包含操作状态和输出数据。
