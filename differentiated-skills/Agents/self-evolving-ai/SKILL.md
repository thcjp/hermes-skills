...
**处理**: 按照skill规范执行三类结构化记忆操作,遵循单一意图原则。
**输出**: 返回三类结构化记忆的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自动痛点检测触发器操作,遵循单一意图原则。
**输出**: 返回自动痛点检测触发器的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行模式复发追踪与晋升操作,遵循单一意图原则。
**输出**: 返回模式复发追踪与晋升的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行分层文档加载策略操作,遵循单一意图原则。
**输出**: 返回分层文档加载策略的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多代理平台兼容与技能提取操作,遵循单一意图原则。
**输出**: 返回多代理平台兼容与技能提取的执行结果,包含操作状态和输出数据。
