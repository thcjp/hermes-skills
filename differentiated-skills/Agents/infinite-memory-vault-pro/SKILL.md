...
license: Proprietary
edition: pro
description: "面向需要超越 Agent 内置记忆的长期结构化存储场景的无限记忆库专业版。与 Agent 内置记忆并行工作，互不冲突，包含无限分类、语义搜索、自发同步、大规模索引能力。专业版解锁全部高级功能，适合团队/企业级知识管控与长期记忆需求. 适用于需要infinite memory vault相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 智能
  - memory
  - 内置记忆
