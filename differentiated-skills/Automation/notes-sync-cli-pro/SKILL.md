...
**处理**: 按照skill规范执行批量操作（专业版）操作,遵循单一意图原则。
**输出**: 返回批量操作（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多Vault并行管理（专业版）操作,遵循单一意图原则。
**输出**: 返回多Vault并行管理（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行模板系统（专业版）操作,遵循单一意图原则。
**输出**: 返回模板系统（专业版）的执行结果,包含操作状态和输出数据。
