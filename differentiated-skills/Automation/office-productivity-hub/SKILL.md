...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：解决批量炸裂、格式丢失、PII、模板难复用痛点、让文档、报表快速稳妥产出、常见办公流程自动、化中枢、覆盖文档处理、报表生成与工作流、聚焦批量操作容错、模板复用四大痛点、让繁琐办公快速稳、妥完成、Use、when、需要提升效率、自动化流程、批量处理、工作流优化时使用、不适用于需要人工、创意判断的任务、适用于独立开发者、企业团队和自动化、工作流场景等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 快速开始
