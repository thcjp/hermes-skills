...
version: 1.0.1
displayName: 办公效率中枢
summary: "解决批量炸裂、格式丢失、PII泄露、模板难复用痛点，让文档/数据/邮件/报表一键稳妥产出。常见办公流程自动化中枢，覆盖文档处理、数据整理、邮件管理、日程协调、报表生成与工作流编排。聚焦批量操"
license: Proprietary
description: "常见办公流程自动化中枢，覆盖文档处理、数据整理、邮件管理、日程协调、报表生成与工作流编排。聚焦批量操作容错、格式保真、PII 脱敏、模板复用四大痛点，让繁琐办公一键稳妥完成。Use
  when 需要提升效率、自动化流程、批量处理、工作流优化时使用。不适用于需要人工创意判断的任务。加速开发流程，提升代码质量与一致性。触发关键词：代码生成、文档生成、自动化、转换、图片、PDF"
