...
license: Proprietary
edition: pro
description: "Linear流程CLI（专业版）面向使用Linear进行复杂项目管控的工程团队与AI Agent运行时，在免费版基础上解锁全部高级能力：成批操作、dry-run预览、自发化策略、Slack/Ticket上下文集成、Git/JJ工作流联动、高级GraphQL查询模板、Webhook管控、跨团队Initiative管控。让AI"
tags:
  - Linear
  - 任务管理
  - Agent运行时
