...
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
| input | string | 是 | 系统控制器处理的输入数据或指令 |
...
**处理**: 解析系统控制器为 AI Agent 提供操作的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回系统控制器为 AI Agent 提供操作的响应数据,包含状态码、结果和日志.
...
**处理**: 解析它把 Linux/macOS/Windo的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回它把 Linux/macOS/Windo的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析明确聚焦"系统层"控制的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回明确聚焦"系统层"控制的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
