...
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
| input | string | 是 | Linear工作流机器人处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "Linear工作流机器人处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "linear workflow bot"
    }
  },
