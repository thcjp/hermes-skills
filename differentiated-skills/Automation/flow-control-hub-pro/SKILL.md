...
license: Proprietary
edition: pro
description: "桌面流程控制中枢专业版是面向企业级RPA场景的完整桌面自发化解决方案。在免费版核心能力之上，专业版解锁图像识别定位、多显示器兼容、审批模式、操作日志回放、自定义移动曲线五大高级功能，满足高精度、高安全、高可靠的自发化需求. 适用于需要flow control hub相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 桌面自动化
  - 企业RPA
  - 图像识别
...
```json
{
  "success": true,
  "data": {
    "result": "桌面流程控制中枢(专业版)处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "flow control hub pro"
    }
  },
