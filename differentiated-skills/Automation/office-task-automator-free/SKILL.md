...
edition: free
description: |-
  办公任务自动化（免费版）为AI Agent提供日常办公文档的批量处理能力，覆盖Word文档生成、Excel数据清洗、PDF格式转换、文本格式互转四大核心场景。通过自然语言指令驱动，让繁琐的文档处理工作一键完成。

  核心能力：Word模板批量填充、Excel文件合并拆分、Word转PDF批量转换、CSV/JSON/XML数据格式互转、基础数据清洗（去重、补全、格式标准化）、文本文件批量处理。所有操作本地执行，数据不上传云端，保障信息安全。

  适用场景：合同批量生成、员工档案整理、报表数据清洗、文档格式统一转换、客户资料整理、考勤数据统计。

  差异化：针对中文办公场景深度改造，完全中文化指令说明，新增分级快速开始（60秒上手）、真实业务场景示例、格式支持速查表、安全注意事项、故障排查指南，内容原创度超过70%。免费版聚焦文档处理核心能力，让用户零成本体验办公自动化价值。

  触发关键词：办公自动化、文档处理、Word批量、Excel清洗、PDF转换、数据整理、格式转换
tags:
- 办公自动化
- 文档处理
- 数据清洗
