...
license: Proprietary
edition: pro
description: "图纸解析（专业版）面向工程团队与造价咨询机构，在免费版基础上解锁全部高级能力：无上限成批处置、DWG原生解析、扫描件OCR预处置、跨图纸索引产出、中文注释智能分类、自定义正则模板、版本差异剖析。覆盖从单图纸解析到项目级图纸资产管控的完整工作流. 适用于需要drawing insight相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 图纸解析
  - 建筑工程
  - DWG解析
