...
**处理**: 按照skill规范执行四种触发器操作,遵循单一意图原则。
**输出**: 返回四种触发器的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行五类操作节点操作,遵循单一意图原则。
**输出**: 返回五类操作节点的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多条件组合判断 — 专业版独有操作,遵循单一意图原则。
**输出**: 返回多条件组合判断 — 专业版独有的执行结果,包含操作状态和输出数据。
