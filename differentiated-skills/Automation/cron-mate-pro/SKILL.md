...
**输入**: 用户提供高级特殊字符（专业版）所需的指令和必要参数。
**处理**: 按照skill规范执行高级特殊字符（专业版）操作,遵循单一意图原则。
**输出**: 返回高级特殊字符（专业版）的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供时区转换（专业版）所需的指令和必要参数。
**处理**: 按照skill规范执行时区转换（专业版）操作,遵循单一意图原则。
**输出**: 返回时区转换（专业版）的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供冲突检测（专业版）所需的指令和必要参数。
**处理**: 按照skill规范执行冲突检测（专业版）操作,遵循单一意图原则。
**输出**: 返回冲突检测（专业版）的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供优化建议（专业版）所需的指令和必要参数。
**处理**: 按照skill规范执行优化建议（专业版）操作,遵循单一意图原则。
**输出**: 返回优化建议（专业版）的执行结果,包含操作状态和输出数据。

### 执行时间预览（专业版）

预计算未来N次执行时间，便于验证表达式正确性。

**输入**: 用户提供执行时间预览（专业版）所需的指令和必要参数。
**处理**: 按照skill规范执行执行时间预览（专业版）操作,遵循单一意图原则。
**输出**: 返回执行时间预览（专业版）的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供多平台适配（专业版）所需的指令和必要参数。
**处理**: 按照skill规范执行多平台适配（专业版）操作,遵循单一意图原则。
**输出**: 返回多平台适配（专业版）的执行结果,包含操作状态和输出数据。
