...
**处理**: 按照skill规范执行功能一：完整CDP API操作,遵循单一意图原则。
**输出**: 返回功能一：完整CDP API的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能二：平台踩坑指南 — 专业版启用操作,遵循单一意图原则。
**输出**: 返回功能二：平台踩坑指南 — 专业版启用的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能三：SPA内部导航策略 — 专业版启用操作,遵循单一意图原则。
**输出**: 返回功能三：SPA内部导航策略 — 专业版启用的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行功能四：连接管理器 — 专业版启用操作,遵循单一意图原则。
**输出**: 返回功能四：连接管理器 — 专业版启用的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行功能五：反自动化检测应对 — 专业版启用操作,遵循单一意图原则。
**输出**: 返回功能五：反自动化检测应对 — 专业版启用的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能六：Cookie高级处理 — 专业版启用操作,遵循单一意图原则。
**输出**: 返回功能六：Cookie高级处理 — 专业版启用的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能七：多标签页管理 — 专业版启用操作,遵循单一意图原则。
**输出**: 返回功能七：多标签页管理 — 专业版启用的执行结果,包含操作状态和输出数据。
