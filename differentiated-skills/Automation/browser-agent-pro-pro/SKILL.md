...
**处理**: 按照skill规范执行功能一：反检测策略操作,遵循单一意图原则。
**输出**: 返回功能一：反检测策略的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能二：多标签页与会话管理操作,遵循单一意图原则。
**输出**: 返回功能二：多标签页与会话管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能三：代理与网络配置操作,遵循单一意图原则。
**输出**: 返回功能三：代理与网络配置的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能四：分页抓取与无限滚动操作,遵循单一意图原则。
**输出**: 返回功能四：分页抓取与无限滚动的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能五：动态内容抓取操作,遵循单一意图原则。
**输出**: 返回功能五：动态内容抓取的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能六：登录态持久化操作,遵循单一意图原则。
**输出**: 返回功能六：登录态持久化的执行结果,包含操作状态和输出数据。
