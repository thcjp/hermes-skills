...
**处理**: 按照skill规范执行功能一：8+新闻源聚合操作,遵循单一意图原则。
**输出**: 返回功能一：8+新闻源聚合的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供功能二：多关键词组合搜索所需的指令和必要参数。
**处理**: 按照skill规范执行功能二：多关键词组合搜索操作,遵循单一意图原则。
**输出**: 返回功能二：多关键词组合搜索的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供功能三：10+海报主题与自定义模板所需的指令和必要参数。
**处理**: 按照skill规范执行功能三：10+海报主题与自定义模板操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能四：情感分析与趋势检测操作,遵循单一意图原则。
**输出**: 返回功能四：情感分析与趋势检测的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供功能五：多格式导出所需的指令和必要参数。
**处理**: 按照skill规范执行功能五：多格式导出操作,遵循单一意图原则。
**输出**: 返回功能五：多格式导出的执行结果,包含操作状态和输出数据。
...
**输出**: 返回功能六：多时段定时调度的执行结果,包含操作状态和输出数据。
...
**输出**: 返回功能七：品牌水印与Logo定制的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能八：增量更新与去重操作,遵循单一意图原则。
**输出**: 返回功能八：增量更新与去重的执行结果,包含操作状态和输出数据。
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全功能新闻聚合系、多格式导出与品牌、支撑企业级资讯场、每日新闻摘要专业、版是面向团队与企、业的全功能新闻聚、合与可视化系统、在免费版基础上解、品牌水印定制、登录态抓取八大高、级能力、Use、when、需要数据分析、报表生成、统计洞察、数据可视化时使用、不适用于实时流数、据处理等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
