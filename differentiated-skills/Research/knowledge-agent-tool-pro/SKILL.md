...
**输入**: 用户提供团队共享知识库(专业版新增)所需的指令和必要参数。
**处理**: 按照skill规范执行团队共享知识库(专业版新增)操作,遵循单一意图原则。
**输出**: 返回团队共享知识库(专业版新增)的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供语义检索(专业版新增)所需的指令和必要参数。
**处理**: 按照skill规范执行语义检索(专业版新增)操作,遵循单一意图原则。
**输出**: 返回语义检索(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**输入**: 用户提供自动摘要与关键词提取(专业版新增)所需的指令和必要参数。
**处理**: 按照skill规范执行自动摘要与关键词提取(专业版新增)操作,遵循单一意图原则。
**输出**: 返回自动摘要与关键词提取(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**输入**: 用户提供知识图谱构建(专业版新增)所需的指令和必要参数。
**处理**: 按照skill规范执行知识图谱构建(专业版新增)操作,遵循单一意图原则。
**输出**: 返回知识图谱构建(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**输入**: 用户提供权限管理(专业版新增)所需的指令和必要参数。
**处理**: 按照skill规范执行权限管理(专业版新增)操作,遵循单一意图原则。
**输出**: 返回权限管理(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**输入**: 用户提供操作审计与监控统计(专业版新增)所需的指令和必要参数。
**处理**: 按照skill规范执行操作审计与监控统计(专业版新增)操作,遵循单一意图原则。
**输出**: 返回操作审计与监控统计(专业版新增)的执行结果,包含操作状态和输出数据。
