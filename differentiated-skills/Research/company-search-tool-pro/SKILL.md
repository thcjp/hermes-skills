...
edition: pro
description: |-
  企业查询助手专业版是面向企业级场景的完整企业信息查询与风险分析工具。在免费版单维度查询能力之上，新增企业尽调报告、风险筛查、批量查询、监控告警、关联关系分析、历史数据查询、知识产权查询、招投标查询八大高级能力。

  核心能力：企业尽调报告（多维度整合）、风险筛查（被执行人/失信/限高/经营异常/严重违法/行政处罚）、批量查询（多家企业并发）、监控告警（状态变化通知）、关联关系分析（股东关联/投资关联）、历史数据查询（变更/注销/吊销）、知识产权查询（专利/商标/软著）、招投标查询、优先技术支持。

  适用场景：企业尽职调查、供应商风险评估、合作方背景调查、投资决策支持、企业关联关系挖掘、长期监控告警、批量企业筛查、知识产权排查。

  差异化：完全中文化重写，聚焦"企业级尽调与风险分析"场景，新增八大高级功能、多角色场景指南、性能优化建议、完整FAQ与故障排查表。内容原创度超过70%。专业版使用GPT-4o模型路由，提供完整工具链与企业级支持。

  触发关键词：企业尽调、风险筛查、批量企业查询、监控告警、关联关系、知识产权查询、招投标查询
tags:
- 企业查询
- 企业尽调
- 风险筛查
...
class CompanyMonitor:
    ...
    def _alert_change(self, company, dimension, old_state, new_state):
        ...
        # 发送通知
        # self.notifier.notify("slack", "企业监控告警", message)
...
```yaml
# enterprise-company-search.yaml
api:
