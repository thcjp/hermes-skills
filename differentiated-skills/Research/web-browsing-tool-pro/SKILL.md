...
**处理**: 按照skill规范执行批量 URL 并行处理操作,遵循单一意图原则。
**输出**: 返回批量 URL 并行处理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行定时内容监控操作,遵循单一意图原则。
**输出**: 返回定时内容监控的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行深度内容分析操作,遵循单一意图原则。
**输出**: 返回深度内容分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行自定义提取规则操作,遵循单一意图原则。
**输出**: 返回自定义提取规则的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行内容变化预警与差异对比操作,遵循单一意图原则。
**输出**: 返回内容变化预警与差异对比的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
