...
**处理**: 按照skill规范执行远程浏览器集群操作,遵循单一意图原则。
**输出**: 返回远程浏览器集群的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量任务调度操作,遵循单一意图原则。
**输出**: 返回批量任务调度的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行代理网络与验证码处理操作,遵循单一意图原则。
**输出**: 返回代理网络与验证码处理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行会话持久化与团队协作操作,遵循单一意图原则。
**输出**: 返回会话持久化与团队协作的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
