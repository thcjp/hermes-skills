...
**处理**: 按照skill规范执行团队共享归档库(专业版新增)操作,遵循单一意图原则。
**输出**: 返回团队共享归档库(专业版新增)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行版本控制与历史追溯(专业版新增)操作,遵循单一意图原则。
**输出**: 返回版本控制与历史追溯(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行全文检索与高级筛选(专业版新增)操作,遵循单一意图原则。
**输出**: 返回全文检索与高级筛选(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行权限管理与操作审计(专业版新增)操作,遵循单一意图原则。
**输出**: 返回权限管理与操作审计(专业版新增)的执行结果,包含操作状态和输出数据。
