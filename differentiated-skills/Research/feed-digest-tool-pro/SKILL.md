...
**处理**: 按照skill规范执行AI深度摘要操作,遵循单一意图原则。
**输出**: 返回AI深度摘要的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多源聚合操作,遵循单一意图原则。
**输出**: 返回多源聚合的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行定时推送操作,遵循单一意图原则。
**输出**: 返回定时推送的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队共享操作,遵循单一意图原则。
**输出**: 返回团队共享的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行个性化推荐操作,遵循单一意图原则。
**输出**: 返回个性化推荐的执行结果,包含操作状态和输出数据。
