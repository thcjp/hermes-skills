...
**处理**: 按照skill规范执行子任务数量上限操作,遵循单一意图原则。
**输出**: 返回子任务数量上限的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行仅支持通用搜索代理(不支持学术操作,遵循单一意图原则。
**输出**: 返回仅支持通用搜索代理(不支持学术的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行不支持日期约束搜索操作,遵循单一意图原则。
**输出**: 返回不支持日期约束搜索的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行不支持搜索任务模板操作,遵循单一意图原则。
**输出**: 返回不支持搜索任务模板的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行不支持结果质量评分与排序操作,遵循单一意图原则。
**输出**: 返回不支持结果质量评分与排序的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
