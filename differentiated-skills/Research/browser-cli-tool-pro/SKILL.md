...
**处理**: 按照skill规范执行并发会话管理(专业版新增)操作,遵循单一意图原则。
**输出**: 返回并发会话管理(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行错误重试机制(专业版新增)操作,遵循单一意图原则。
**输出**: 返回错误重试机制(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行任务队列与调度(专业版新增)操作,遵循单一意图原则。
**输出**: 返回任务队列与调度(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
