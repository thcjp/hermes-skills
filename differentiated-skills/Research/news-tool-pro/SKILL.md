...
edition: pro
description: |-
  个性化新闻助手专业版，面向团队和企业用户提供多用户管理、定时自动推送、阅读行为分析与API集成能力。

  核心能力:
  - 多用户/多租户管理，独立兴趣画像
  - 定时自动推送（早报/午报/晚报/突发新闻）
  - 阅读行为深度分析与偏好预测
  - 自定义新闻源接入与质量评级
  ...
  - 新增多用户管理、定时推送、阅读分析等企业级能力
  - 支持自定义新闻源与API集成
  - 提供优先技术支持与定制化服务

  触发关键词: 多用户新闻, 定时推送, 阅读分析, 企业新闻, 新闻API, 多语言新闻, news pro
tags:
- 新闻
- 企业级
- 个性化
