...
edition: pro
description: |-
  搜索工具专业版为企业团队提供高阶LLM优化网页搜索与信息检索能力。
  ...
  差异化:专业版在免费版基础搜索与域名过滤基础上,扩展批量搜索、主题分类、全文提取、图片搜索与缓存能力。与免费版完全兼容,API Key与命令行参数可直接复用。

  触发关键词: 搜索, search, Tavily, 批量, 主题, 全文, 图片, 缓存, 企业, 新闻, 金融, 舆情
tags:
- 研究工具
- 搜索
- 企业级
