...
edition: pro
description: |-
  多源研究助手专业版，面向研究机构和企业用户提供企业级多源数据采集与分析能力。

  核心能力:
  - 批量多主题并行研究，一次处理10+个研究课题
  - 6类数据源 + 自定义数据源接入
  - 语义级去重与智能排序（标题+内容+语义三重匹配）
  - 多格式导出（Markdown/PDF/Word/HTML）
  - 研究历史记录与版本管理
  - 多租户团队协作与权限管理
  - REST API 集成与自动化研究工作流
  ...
  - 新增批量研究、语义去重、自定义数据源等企业级能力
  - 支持多租户团队协作与版本管理
  - 提供API集成与自动化工作流

  触发关键词: 批量研究, 语义去重, 研究报告, 尽职调查, 行业研究, 团队协作, 自定义数据源, multi-source pro
tags:
- 研究
- 企业级
- 文献分析
