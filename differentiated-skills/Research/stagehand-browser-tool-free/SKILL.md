...
edition: free
description: |-
  浏览器自动化工具免费版,面向个人用户提供基础的网页自动化能力。
  通过自然语言指令驱动本地 Chrome 浏览器,实现页面导航、元素操作、数据提取等核心功能。

  核心能力:
  - 自然语言驱动的浏览器操作,无需编写复杂脚本
  - 支持本地 Chrome 浏览器模式,开箱即用
  - 提供导航、点击、提取、截图等基础命令
  - 轻量级部署,适合个人开发与日常任务
  ...
  - 移除所有外部平台依赖,纯净本地运行
  - 增强中文触发关键词,提升中文环境识别率
  - 完全适配 SkillHub 平台规范,安全合规

  触发关键词: 浏览器自动化, 自然语言操作, 网页操作, Chrome 控制, 页面导航, 数据提取, browser, stagehand, cli
tags:
- 研究工具
- 浏览器自动化
- 个人效率
