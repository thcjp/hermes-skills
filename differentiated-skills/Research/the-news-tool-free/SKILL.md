...
edition: free
description: |-
  全球新闻速递免费版,面向个人用户提供覆盖 20 个国家的实时头条新闻聚合能力。
  通过统一的公共 API 获取多语种新闻快照,支持实时查询和基础历史回溯。
  ...
  差异化:
  - 免费版聚焦个人资讯场景,调用次数适中
  - 移除外部平台依赖,纯净公共 API 调用
  - 增强中文触发关键词,提升中文环境识别率
  - 完全适配 SkillHub 平台规范

  触发关键词: 新闻, 头条, 快讯, 国际新闻, 全球新闻, 突发新闻, news, headlines, breaking news, global news
tags:
- 研究工具
- 新闻资讯
- 信息获取
