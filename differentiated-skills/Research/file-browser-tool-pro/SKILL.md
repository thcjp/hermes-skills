...
**处理**: 按照skill规范执行文件监控操作,遵循单一意图原则。
**输出**: 返回文件监控的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行压缩解压操作,遵循单一意图原则。
**输出**: 返回压缩解压的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行文件比较操作,遵循单一意图原则。
**输出**: 返回文件比较的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行云存储集成操作,遵循单一意图原则。
**输出**: 返回云存储集成的执行结果,包含操作状态和输出数据。
