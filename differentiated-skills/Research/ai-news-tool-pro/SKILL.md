...
**处理**: 按照skill规范执行多源新闻聚合(专业版新增)操作,遵循单一意图原则。
**输出**: 返回多源新闻聚合(专业版新增)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行AI 自动摘要与关键词提取(专业版新增)操作,遵循单一意图原则。
**输出**: 返回AI 自动摘要与关键词提取(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行个性化推荐与订阅(专业版新增)操作,遵循单一意图原则。
**输出**: 返回个性化推荐与订阅(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行历史新闻全文检索(专业版新增)操作,遵循单一意图原则。
**输出**: 返回历史新闻全文检索(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行定时推送与告警(专业版新增)操作,遵循单一意图原则。
**输出**: 返回定时推送与告警(专业版新增)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行趋势分析与热点追踪(专业版新增)操作,遵循单一意图原则。
**输出**: 返回趋势分析与热点追踪(专业版新增)的执行结果,包含操作状态和输出数据。
