...
edition: "pro"
description: |-
  多搜索引擎工具专业版，集成20+全球搜索引擎。Use when 需要SEO优化、关键词分析、排名提升、搜索流量优化时使用。不适用于黑帽SEO手段。适用于独立开发者、企业团队和自动化工作流场景。Use when 需要SEO优化、关键词分析、排名提升、搜索流量优化时使用。不适用于黑帽SEO手段。适用于独立开发者、企业团队和自动化工作流场景。
tags:
  - 搜索
  - 研究
  - 企业级
...
**处理**: 按照skill规范执行PRO 专属搜索引擎操作,遵循单一意图原则。
**输出**: 返回PRO 专属搜索引擎的执行结果,包含操作状态和输出数据。
...
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全球搜索引擎、支持批量搜索、结果自动聚合去重、与企业级、多搜索引擎工具专、Use、when、SEO、关键词分析、排名提升、搜索流量优化时使、不适用于黑帽、适用于独立开发者、企业团队和自动化、工作流场景等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
