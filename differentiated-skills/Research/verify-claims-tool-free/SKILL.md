...
edition: free
description: |-
  事实核查助手免费版,面向个人用户提供基础的事实核查能力。
  通过对接全球专业事实核查机构,对用户提供的声明进行多源交叉验证。

  核心能力:
  - 对接全球专业事实核查机构(Snopes、FactCheck.org 等)
  - 多源交叉验证,确保结论可靠性
  - 区域相关性匹配,选择合适的核查源
  - 语言匹配,优先使用用户母语核查源
  - 结构化结果呈现,清晰展示验证结论
  ...
  触发关键词: 事实核查, 辟谣, 真假验证, 信息核实, 新闻真假, fact check, verify claims, misinformation, debunk
tags:
- 研究工具
- 事实核查
- 信息鉴别
