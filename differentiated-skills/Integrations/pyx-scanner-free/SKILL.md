...
**处理**: 按照skill规范执行能力一：Skill 标识解析操作,遵循单一意图原则。
**输出**: 返回能力一：Skill 标识解析的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力二：扫描 API 调用操作,遵循单一意图原则。
**输出**: 返回能力二：扫描 API 调用的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力三：五种判定结果处理操作,遵循单一意图原则。
**输出**: 返回能力三：五种判定结果处理的执行结果,包含操作状态和输出数据。
