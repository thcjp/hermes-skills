...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级知识库爬取、与检索平台、支持多工作空间、分布式调度、增量索引、全文检索与自定义、适合团队与企业规、模化使用、智能爬虫、是面向团队与企业、的全功能知识库爬、在免费版基础上新、增多工作空间管理、全文检索引擎、自定义导出等高级、核心能力等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
