...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全功能、Jira、任务管理与团队工、时分析、支持批量操作、自定义报表与自动、化集成、Flow、专业版面向团队负、责人与项目经理、在免费版基础上解、锁批量任务操作、多项目工时对比、自定义报表模板与、团队工时聚合视图、核心能力、单条命令完成批量、跨项目工时对比报、自定义工时模板导、Markdown、CSV、JSON、团队成员工时聚合、自动化触发、并发请求与缓存优等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
