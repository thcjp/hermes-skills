...
edition: free
description: |-
  GitHub管理器(免费版)是一款面向个人开发者的GitHub日常协作助手,通过gh命令行工具封装常用操作,帮助用户高效管理Issue、Pull Request与CI工作流。
  ...
  差异化: 完全中文化表达,聚焦"查询-检查-定位"三步流程,内置命令速查表与故障排查清单,帮助用户快速上手gh CLI。

  触发关键词: GitHub、gh命令、Issue管理、PR检查、工作流、CI状态、代码审查、仓库管理
tags:
- GitHub
- 协作
- CI/CD
