...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全功能、Linear、管理工具、支持批量操作、高级分析与自定义、工具箱、是面向团队与项目、管理者的全功能、交互工具、在免费版基础上新、增批量操作、查询模板等高级能、完整的问题查询、项目管理与团队协、作能力、批量操作引擎、支持批量创建、事件订阅与自动化等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
