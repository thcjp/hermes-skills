...
edition: free
description: |-
  仓库管理器(免费版)是一款基于MCP工具协议的GitHub仓库管理工具,通过统一的工具调用接口管理仓库、Issue、Pull Request、提交与分支,无需手动配置API认证。
  ...
  差异化: 完全中文化表达,聚焦MCP工具协议实战,提供工具发现-预览-确认-执行的安全流程,内置错误处理与故障排查指南。

  触发关键词: 仓库管理、MCP工具、Issue管理、PR管理、分支管理、代码仓库、GitHub集成、工具调用
tags:
- GitHub
- 仓库管理
- MCP工具
