...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：MongoDB、企业级管理与优化、全功能版、含分片集群、副本集高可用、与基准测试、运维与架构师的企、业级全功能专业版、在免费版基础上新、增分片集群配置、性能基准测试套件、容量规划模型等高、级能力、配套面向、DBA、架构师、SRE、的多角色场景指南、Use、when、SEO、关键词分析、排名提升、搜索流量优化时使、不适用于黑帽等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
