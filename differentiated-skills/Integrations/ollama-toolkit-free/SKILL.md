...
edition: free
description: |-
  Ollama工具箱免费版是一款面向本地AI模型运行的命令行辅助Skill，让AI Agent能够通过Ollama在本地环境运行大语言模型，实现无需云端API的私有化AI推理。

  核心能力：模型列表查询、单轮对话推理、模型拉取下载、运行状态检查、基础参数配置。覆盖本地AI部署的基础使用需求。

  适用场景：离线环境下的AI辅助、数据隐私敏感的文本处理、本地模型能力评估、开发调试与原型验证。

  差异化：相比云端API调用，本地运行零成本、零延迟、完全私密。免费版提供基础推理能力，适合个人开发者和研究者试用。

  触发关键词：ollama、本地模型、离线AI、模型推理、私有化部署、llama
tags:
- 本地AI
- 模型推理
- 私有化部署
