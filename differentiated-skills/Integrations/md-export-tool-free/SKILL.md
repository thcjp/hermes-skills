...
edition: free
description: |-
  面向内容创作者与开发者的Markdown多格式导出工具。通过命令行将Markdown文本一键转换为DOCX、PDF、HTML、XLSX、CSV、JSON、XML等主流格式，免去手动排版与格式调整的繁琐工作，特别适合技术文档、报告、数据表导出场景。

  核心能力：
  - 支持12+种目标格式，覆盖办公文档、网页、数据、代码
  - 命令行接口简洁统一，所有命令遵循相同参数规范
  - 支持中英文混排，PDF/DOCX输出兼容中文显示
  - 表格、代码块、列表等Markdown扩展语法完整支持
  - 支持自定义模板，复用品牌样式

  适用场景：
  - 技术文档从Markdown导出为Word/PDF分发
  - 数据报告从Markdown表格导出Excel/CSV
  - 代码示例从Markdown提取为独立代码文件

  差异化：原创中文使用指南，按场景拆分示例，覆盖常见转换问题与中文显示修复方案，配套批量处理与模板定制最佳实践。

  触发关键词：markdown导出、格式转换、docx、pdf、xlsx、html
tags:
- 集成工具
- 文档转换
- Markdown
