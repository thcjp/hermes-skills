...
edition: free
description: |-
  免费资源发现器(免费版)是一款面向独立开发者的免费AI模型资源发现与切换工具,帮助用户在众多免费模型中快速找到合适的选项,并完成基础配置。
  ...
  差异化: 完全中文化表达,聚焦"发现-切换-验证"三步流程,内置模型质量评估维度,帮助用户避开免费模型的常见陷阱(限速、不稳定、能力参差)。

  触发关键词: 免费模型、AI资源、模型切换、免费API、OpenRouter、模型发现、成本控制、白嫖AI
tags:
- AI模型
- 资源发现
- 免费工具
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务,核心功能需要free-finder CLI
