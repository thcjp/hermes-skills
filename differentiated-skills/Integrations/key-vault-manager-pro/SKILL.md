...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级密钥安全管、支持多保险箱、密钥轮换与团队共、密钥保险箱、是面向团队与企业、的全功能密钥安全、管理工具、在免费版基础上新、增多保险箱管理、享等高级能力、完整的本地密钥验、脱敏读取与、代理能力、全量审计日志、自动化密钥轮换、支持定时更新与到、团队密钥共享、加密分发与细粒度、合规报告生成等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
