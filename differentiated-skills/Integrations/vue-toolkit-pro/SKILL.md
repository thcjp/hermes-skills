...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全栈实战、架构与团队规范、工具箱、专业版、面向中高级、开发者与团队、在免费版陷阱清单、的基础上新增性能、状态管理、测试与团队规范六、大模块、目标是让、Agent、能够输出、架构级、建议而不仅是单点、when、需要代码生成、编程辅助、调试测试、开发部署时使用、不适用于无明确技、术栈的模糊需求等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
