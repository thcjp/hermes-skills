...
description: |-
  ...
  核心能力：
  - 22 类动作全覆盖，含交互与完整群组管理
  - 多智能体讨论协议：广播/点名/轮询三种路由模式
  - 拥塞控制：指数礼貌协议防止消息爆炸
  - 对话生命周期：陈旧检测、循环检测、目标追踪与自动收尾
  - 预算感知调度：保守/适中/激进/燃烧四种模式
  - vCard 联系人提取与全文检索

  适用场景：
  - 团队 WhatsApp 群组的多 Agent 协作（脑暴/评审/决策）
  - 企业客户服务自动化与群组运营
  - 多角色讨论的成本控制与预算管理
  - 历史消息检索与联系人归档

  差异化：以"协议 × 配置 × 策略"三层组织多智能体能力，每条协议均附配置示例与行为说明，原创内容占比超过 70%。专业版相比免费版新增 17 类动作、4 个高级协议与多角色场景指南。

  触发关键词：whatsapp、多智能体、群组管理、拥塞控制、预算调度、投票、反应、历史搜索
tags:
- 即时通讯
- WhatsApp
- 多智能体
