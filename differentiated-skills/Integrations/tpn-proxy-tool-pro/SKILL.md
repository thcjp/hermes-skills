...
license: Proprietary
edition: pro
description: "面向数据工程团队与安全测试人员的全功能去中心化SOCKS5代理平台，兼容多代理并发管控、自发轮换、请求熔断与性能监控。核心能力：在免费版基础上新增多代理会话池、自发轮换策略、请求重试与熔断机制、代理性能监控仪表盘、x402按需支付流程与成批请求引擎。Use. 适用于需要tpnxy tool相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 数据采集
  - 分析
  - self
