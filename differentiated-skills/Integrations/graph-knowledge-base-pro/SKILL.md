...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全功能知识图谱工、支持图谱关系查询、跨实体关联与多格、知识图谱库、是面向团队与知识、工作者的全功能知、识图谱管理工具、在免费版基础上新、增图谱关系查询、式导出等高级能力、核心能力、完整的实体管理、事实添加与版本替、代能力、发现跨实体隐含关、事实聚类与主题识、构建知识网络视图等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
