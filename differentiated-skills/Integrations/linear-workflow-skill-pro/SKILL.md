...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全功能、Linear、工作流工具、支持冲刺规划、批量操作与迭代报、是面向敏捷团队的、全功能工作流管理、在免费版基础上新、增冲刺规划自动化、告等高级能力、完整的问题管理、团队查询与项目管、理能力、冲刺规划自动化、智能创建迭代问题、与分配、依赖链管理与阻塞、可视化依赖关系、批量操作引擎、支持批量创建、迭代报告生成等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
