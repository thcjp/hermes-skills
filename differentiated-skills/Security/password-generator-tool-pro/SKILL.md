...
description: |-
  ...
  差异化:
  - 企业级密码策略引擎,支持合规框架映射
  - 批量生成与多格式导出(CSV/JSON/SARIF)
  - 实时泄露检测,防止使用已泄露密码
  - 与免费版完全兼容,可平滑升级

  触发关键词: 密码, 生成密码, 批量密码, 密码策略, passphrase, 泄露检测, password, enterprise, compliance, NIST, PCI-DSS
tags:
- 安全
- 密码管理
- 企业安全
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务,核心功能依赖Python脚本执行
