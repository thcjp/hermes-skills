...
**处理**: 按照skill规范执行云安全组管理(专业版独有)操作,遵循单一意图原则。
**输出**: 返回云安全组管理(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行nftables高级配置(专业版独有)操作,遵循单一意图原则。
**输出**: 返回nftables高级配置(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量多机部署(专业版独有)操作,遵循单一意图原则。
**输出**: 返回批量多机部署(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行CIS安全基线审计(专业版独有)操作,遵循单一意图原则。
**输出**: 返回CIS安全基线审计(专业版独有)的执行结果,包含操作状态和输出数据。
