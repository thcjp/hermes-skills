...
description: |-
  ...
  Markdown多格式导出、行业基准对比、高级预测模型与自定义报告模板。
  内置OCR引擎支持扫描版PDF，全面满足专业财报分析需求。

  核心能力:
  - 批量处理：多文件并行分析与对比报告生成
  - 多格式导出：HTML/PDF/DOCX/Markdown
  - OCR识别：扫描版PDF财务数据提取
  - 行业基准：同业对标与百分位排名
  - 高级预测：ARIMA/线性回归/机器学习预测
  - 自定义模板：企业品牌化报告模板
  ...
  触发关键词: 财报分析, 批量处理, 多格式导出, OCR, 行业基准, 预测模型, 报告模板, report, analyze, batch
tags:
- Finance
- 财报分析
- 企业级
