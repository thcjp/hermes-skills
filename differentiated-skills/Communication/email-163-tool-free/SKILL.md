...
description: |-
  ...
  搜索与文件夹管理等核心能力，无需复杂配置即可快速上手。

  核心能力:
  - 163邮箱 SMTP/IMAP 双通道邮件收发
  - 支持纯文本与 HTML 邮件格式
  - 单文件与多附件发送
  - 按发件人、主题、日期搜索邮件
  - 基础文件夹管理（列出、创建、删除）
  ...
  差异化: 免费版聚焦个人高频使用场景，提供开箱即用的基础邮件管理能力，配置简洁、操作直观，
  满足绝大多数日常邮件处理需求。专业版在此基础上增加批量操作、高级搜索与企业级特性。

  触发关键词: 163邮箱, 网易邮箱, 邮件发送, 邮件读取, 邮件搜索, 附件发送, IMAP, SMTP, 邮件管理
tags:
- 沟通协作
- 邮件管理
- 163邮箱
...
- **说明**: 基于Markdown的AI Skill，通过自然语言指令驱动Agent执行任务，核心邮件操作通过命令行工具完成
