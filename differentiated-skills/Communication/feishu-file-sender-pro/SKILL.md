...
edition: pro
description: |-
  飞书文件发送专业版面向企业用户与高效能个人用户，在免费版文件与图片发送能力之上
  扩展批量分发、多接收者群发、文件管理、发送队列、重试机制、审计日志与发送分析
  等企业级特性。
  ...
  差异化: 专业版在免费版全部能力基础上向下兼容，额外提供批量分发引擎、文件管理、
  发送队列、审计日志与分析报告，面向企业级文件分发场景深度优化。

  触发关键词: 飞书文件, 批量分发, 文件群发, 文件管理, 发送队列, 重试机制, 审计日志, 文件分发, 大文件上传, 企业通知
tags:
- 沟通协作
- 飞书
- 文件发送
