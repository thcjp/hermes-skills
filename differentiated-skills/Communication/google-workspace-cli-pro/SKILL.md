...
edition: pro
description: |-
  谷歌办公命令行工具专业版,面向企业与专业用户提供 Gmail、Calendar、Drive、Contacts、Sheets、Docs 全六大服务的深度操作能力。
  ...
  差异化:专业版完全兼容免费版命令体系,额外提供 Sheets/Docs/Contacts 高级操作、批量处理能力与企业级自动化脚本模板,适合团队协作与规模化办公场景。

  触发关键词: gmail, google, workspace, sheets, docs, contacts, 邮件, 日历, drive, 批量, 企业, 自动化, 命令行, cli
tags:
- 沟通协作
- 邮件管理
- 谷歌办公
