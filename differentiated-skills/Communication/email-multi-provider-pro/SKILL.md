...
**处理**: 按照skill规范执行批量操作引擎操作,遵循单一意图原则。
**输出**: 返回批量操作引擎的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多账户 Profile 隔离操作,遵循单一意图原则。
**输出**: 返回多账户 Profile 隔离的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行高级过滤策略操作,遵循单一意图原则。
**输出**: 返回高级过滤策略的执行结果,包含操作状态和输出数据。
