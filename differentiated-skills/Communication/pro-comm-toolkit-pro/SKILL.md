...
description: |-
  ...
  差异化: 在免费版基础上增加批量处理、多语言支持、自定义模板、危机沟通等高级能力，完全兼容免费版格式与规则。

  触发关键词: 企业沟通, 批量邮件, 多语言翻译, 危机公关, 跨文化沟通, 自定义模板, professional, batch, multilingual
tags:
- 沟通协作
- 企业级
- 写作助手
...
- **说明**: 基于Markdown的AI Skill，通过自然语言指令驱动Agent执行任务，专业版支持脚本化批量处理
