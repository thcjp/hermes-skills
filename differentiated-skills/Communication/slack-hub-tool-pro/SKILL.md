...
**处理**: 按照skill规范执行批量消息发送与多频道分发操作,遵循单一意图原则。
**输出**: 返回批量消息发送与多频道分发的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行高级搜索与结果过滤操作,遵循单一意图原则。
**输出**: 返回高级搜索与结果过滤的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行智能限流处理操作,遵循单一意图原则。
...
**输出**: 返回工作区频道深度管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行搜索结果导出操作,遵循单一意图原则。
**输出**: 返回搜索结果导出的执行结果,包含操作状态和输出数据。
