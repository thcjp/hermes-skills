...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级、Discord、管理工具、支持批量操作、角色权限与自定义、表情贴纸、面向企业运营与社、区管理团队的、全功能管理工具、核心能力、批量消息发送、清理与定时发布、完整审核管理、与角色权限管理、自定义表情与贴纸、上传管理、频道批量信息查询、与导出、语音状态查询与日、程事件管理等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
