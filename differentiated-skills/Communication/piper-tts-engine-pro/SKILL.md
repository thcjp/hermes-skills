...
description: |-
  ...
  适用关键词: 语音合成, 批量TTS, 自定义音色, 多语言, SSML, piper, 有声书, 企业语音
tags:
- 语音合成
- 批量TTS
- 自定义音色
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级本地、TTS、支持批量合成、自定义音色训练、多语言、SSML、标记与、API、服务化、面向团队与企业的、本地离线文字转语、音引擎、核心能力、批量合成、多语言支持、语音后处理、跨平台部署、适用场景、内容批量配音、多语言客服、有声书制作、无障碍服务、企业通知语音化、差异化、专业版在免费版基、础上新增批量处理、与音色定制、兼容免费版合成命、令与音色模型、适用关键词、语音合成、自定义音色、piper、有声书、企业语音等。
