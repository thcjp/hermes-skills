...
edition: free
description: |-
  谷歌办公命令行工具免费版,为个人用户提供Gmail邮件管理、Google日历日程查询、Google Drive文件搜索等核心能力。
  ...
  差异化:免费版聚焦高频核心场景,配置简单,适合个人开发者与轻量办公需求,无需复杂部署即可上手。

  触发关键词: gmail, google, workspace, 邮件, 日历, drive, 命令行, cli, 谷歌办公
tags:
- 沟通协作
- 邮件管理
- 谷歌办公
