...
**处理**: 按照skill规范执行多邮箱聚合操作,遵循单一意图原则。
**输出**: 返回多邮箱聚合的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行AI 智能摘要操作,遵循单一意图原则。
**输出**: 返回AI 智能摘要的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行定时报告推送操作,遵循单一意图原则。
**输出**: 返回定时报告推送的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行智能分类与标签操作,遵循单一意图原则。
**输出**: 返回智能分类与标签的执行结果,包含操作状态和输出数据。
