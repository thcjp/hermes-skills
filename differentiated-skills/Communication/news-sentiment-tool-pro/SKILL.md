...
**处理**: 按照skill规范执行一、批量多股票扫描(专业版独有)操作,遵循单一意图原则。
**输出**: 返回一、批量多股票扫描(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行二、自定义权重配置(专业版独有)操作,遵循单一意图原则。
**输出**: 返回二、自定义权重配置(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行三、结构化报告导出(专业版独有)操作,遵循单一意图原则。
**输出**: 返回三、结构化报告导出(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行四、历史趋势对比(专业版独有)操作,遵循单一意图原则。
**输出**: 返回四、历史趋势对比(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行五、异常情绪预警(专业版独有)操作,遵循单一意图原则。
**输出**: 返回五、异常情绪预警(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行六、行业板块对比(专业版独有)操作,遵循单一意图原则。
**输出**: 返回六、行业板块对比(专业版独有)的执行结果,包含操作状态和输出数据。
