...
license: MIT
edition: free
description: "WhatsApp 消息工具（免费版）面向个人用户与独立开发者，封装 WhatsApp CLI 的基础消息能力：文本消息发送、文件发送、聊天列表查询、消息搜索与基础认证流程。通过命令行工具驱动，可剖析提升工作效率. 适用于需要whatsapp msg tool相关能力的开发场景,提供结构化的工作流程和配置指引."
tags:
  - 沟通协作
  - 即时通讯
  - WhatsApp
