...
license: Proprietary
edition: free
description: 'WhatsApp样式工具免费版,确保发送到WhatsApp的消息遵循平台专属格式语法。核心能力:
...
**输入**: 用户提供WhatsApp格式语法速查所需的指令和必要参数。
**处理**: 按照skill规范执行WhatsApp格式语法速查操作,遵循单一意图原则。
**输出**: 返回WhatsApp格式语法速查的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供Markdown符号自动清理所需的指令和必要参数。
**处理**: 按照skill规范执行Markdown符号自动清理操作,遵循单一意图原则。
**输出**: 返回Markdown符号自动清理的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供格式校验工具所需的指令和必要参数。
**处理**: 按照skill规范执行格式校验工具操作,遵循单一意图原则。
**输出**: 返回格式校验工具的执行结果,包含操作状态和输出数据。
