...
description: |-
  ...
  自动化发送，支持 Gmail、Outlook、Yahoo、QQ邮箱等主流服务商，提供附件发送、
  HTML 邮件、抄送密送等核心能力。

  核心能力:
  - 跨平台邮件发送（Gmail/Outlook/Yahoo/QQ/自定义SMTP）
  - 纯文本与 HTML 邮件格式
  - 单文件与多附件发送
  - 抄送（CC）与密送（BCC）
  - 测试邮件功能
  ...
  差异化: 免费版聚焦个人邮件发送场景，提供简洁的配置与 Python API，开箱即用。
  专业版在此基础上增加批量发送、模板系统、定时调度与企业级自动化特性。

  触发关键词: 邮件发送, 附件发送, Gmail, Outlook, Yahoo, QQ邮箱, SMTP, HTML邮件, 邮件自动化, Python
tags:
- 沟通协作
- 邮件管理
- 邮件发送
