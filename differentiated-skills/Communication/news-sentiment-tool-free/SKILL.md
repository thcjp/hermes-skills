...
license: MIT
edition: free
description: "舆情情绪剖析工具免费版,为个人投资者包含股票舆情监控与情绪打分能力,扫描公告、新闻、研报、社交媒体等渠道。核心能力:. 适用于需要news sentiment tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 沟通协作
  - 舆情监控
  - 情绪分析
