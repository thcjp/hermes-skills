...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：多源批量采集并智、支持群组推送与企、业级内容运营工作、面向内容团队与企、业级运营的多源、内容采集与智能排、名平台、核心能力、跨平台多源采集、微博等、支持批量白名单与、多关键词组、基于语义相似度与、质量评估的多维智、能排名算法、群组自动推送、定时调度、批量日报生成、企业级权限隔离与、多租户配置管理等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
