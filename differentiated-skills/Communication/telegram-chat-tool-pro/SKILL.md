...
**输出**: 返回一、多 Bot 统一管理(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行二、主动消息推送(专业版独有)操作,遵循单一意图原则。
**输出**: 返回二、主动消息推送(专业版独有)的执行结果,包含操作状态和输出数据。
...
**输出**: 返回三、消息归档与审计(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行四、群组批量管理(专业版独有)操作,遵循单一意图原则。
**输出**: 返回四、群组批量管理(专业版独有)的执行结果,包含操作状态和输出数据。
...
**输出**: 返回五、跨群组广播(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行六、Webhook 集成与自动化(专业版独有)操作,遵循单一意图原则。
**输出**: 返回六、Webhook 集成与自动化(专业版独有)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行七、消息模板与定时发送(专业版独有)操作,遵循单一意图原则。
