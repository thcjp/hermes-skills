...
description: |-
  ...
  适用关键词: telegram, 多agent, 团队通信, 批量通知, 账号映射, 审计, 调度, 电报
tags:
- 通信
- 电报
- 团队协作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：Agent、Telegram、通信中枢、支持账号映射、批量调度、审计日志与优先级、面向团队与企业的、通信管理规范、媒体发送、适用场景、协作汇报、企业通知分发、定时批量推送、跨角色工作流编排、差异化、专业版在免费版基、础上扩展多账号体、系与调度能力、兼容免费版配置、支持团队级通信治、适用关键词、团队通信、批量通知等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
