...
**处理**: 按照skill规范执行多店铺管理操作,遵循单一意图原则。
**输出**: 返回多店铺管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行Shopify App 开发操作,遵循单一意图原则。
**输出**: 返回Shopify App 开发的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行Headless 电商操作,遵循单一意图原则。
**输出**: 返回Headless 电商的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行企业级 SEO操作,遵循单一意图原则。
**输出**: 返回企业级 SEO的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行性能优化操作,遵循单一意图原则。
**输出**: 返回性能优化的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行A/B 测试操作,遵循单一意图原则。
**输出**: 返回A/B 测试的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行CI/CD 自动化操作,遵循单一意图原则。
**输出**: 返回CI/CD 自动化的执行结果,包含操作状态和输出数据。
**技术参数**：使用`input_params`和`output_format`参数控制执行行为,支持`json`/`text`/`csv`输出格式。
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：开发平台、支持多店铺管理、电商与高级、开发工具专业版、面向电商团队与代、运营机构、核心能力、多店铺统一管理与、自定义开发、与结构化数据、性能优化与、测试与转化率优化、团队协作与代码审、与自动化部署等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
