...
**处理**: 按照skill规范执行多目标批量监控操作,遵循单一意图原则。
**输出**: 返回多目标批量监控的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行告警升级机制操作,遵循单一意图原则。
**输出**: 返回告警升级机制的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多通道告警通知操作,遵循单一意图原则。
**输出**: 返回多通道告警通知的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行监控模板与自动发现操作,遵循单一意图原则。
**输出**: 返回监控模板与自动发现的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行SLA 报告与看板操作,遵循单一意图原则。
**输出**: 返回SLA 报告与看板的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队协作与权限操作,遵循单一意图原则。
**输出**: 返回团队协作与权限的执行结果,包含操作状态和输出数据。
