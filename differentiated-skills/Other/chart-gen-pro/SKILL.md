...
edition: pro
description: |-
  面向专业数据可视化场景的全功能图表生成器，在免费版基础上扩展批量生成、自定义主题、实时数据源接入、多图表联动仪表盘、位图导出、模板库等高级能力。
  ...
  - 企业级数据周报/月报的批量图表生成
  - 数据分析师构建可复用模板库，提升团队协作效率
  - 产品团队生成符合品牌规范的运营数据看板

  差异化：相比免费版新增6项高级能力，配套完整FAQ、故障排查表、性能优化策略与多平台集成示例，并提供优先支持渠道。

  触发关键词：批量图表、企业可视化、自定义主题、数据看板、模板库、品牌图表、PNG导出
tags:
- 数据可视化
- 企业图表
- 批量生成
...
本工具通过`scripts/chart.sh`脚本提供十余种图表类型的终端原生输出能力，专业版额外提供：
