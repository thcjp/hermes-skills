...
edition: free
description: |-
  Agent身份助手是一套面向AI助手的人格定义与边界设计工具，帮助开发者用清晰的结构化语言刻画"AI是谁"——它的存在目的、不可妥协的价值观、看待世界的视角以及与用户的相处方式。

  核心能力：提供身份三层模型（目标-价值观-视角）、语调行为化定义法、边界分级与升级机制、人格模板库（管家/同事/导师/朋友四种基调），帮助Agent在多场景中保持一致且可信赖的对话风格。

  适用场景：客服机器人品牌人格塑造、教育陪伴类助手的耐心人格、企业内部助手的同事风格、个人助理的温暖基调，以及对AI"何时需要请示人类、何时可以自主执行"有明确要求的合规场景。

  差异化：相比堆砌形容词的传统做法，本工具强调"用行为而非形容词定义语调"，并通过反语调（Anti-Voice）清单避免AI常见的谄媚话术，让助手像真正的同事一样直接而有判断力。

  触发关键词：人格定义、Agent身份、语调设计、助手边界、品牌人格、对话风格、Anti-Voice、身份模板
tags:
- 智能助手
- 人格设计
- 对话风格
