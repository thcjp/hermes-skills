...
**处理**: 按照skill规范执行数据分析与可视化操作,遵循单一意图原则。
**输出**: 返回数据分析与可视化的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行智能回顾报告操作,遵循单一意图原则。
**输出**: 返回智能回顾报告的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多平台同步操作,遵循单一意图原则。
**输出**: 返回多平台同步的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行AI 辅助洞察操作,遵循单一意图原则。
**输出**: 返回AI 辅助洞察的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自定义字段操作,遵循单一意图原则。
**输出**: 返回自定义字段的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行Web 与移动端操作,遵循单一意图原则。
**输出**: 返回Web 与移动端的执行结果,包含操作状态和输出数据。
