...
edition: free
description: |-
  DOGE节点免费版是一款面向Dogecoin全节点运维者的轻量级管理Skill，封装dogecoin-cli命令并提供结构化的节点状态与钱包信息输出。
  ...
  差异化：相比直接使用dogecoin-cli，本Skill提供智能化的结果解读与故障定位建议，将原始JSON输出转化为可读表格。免费版覆盖个人节点的日常查询需求，专业版提供自动化运维与打赏系统。

  触发关键词：Dogecoin、DOGE、节点、dogecoin-cli、RPC、钱包、区块、同步
tags:
- Dogecoin
- 区块链节点
- 钱包管理
