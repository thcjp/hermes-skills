...
description: |-
  ...
  差异化:免费版提供基础文件加密能力。PRO版扩展批量加密、密钥管理、企业策略与审计日志。

  触发关键词: encrypt, decrypt, 加密, 解密, safe, quantum-safe, 量子安全, 文件加密, passphrase
tags:
- 加密
- 安全
- 量子安全
