...
**处理**: 按照skill规范执行九种图表类型（基础+增强）操作,遵循单一意图原则。
**输出**: 返回九种图表类型（基础+增强）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行语义化配色系统（基础+增强）操作,遵循单一意图原则。
**输出**: 返回语义化配色系统（基础+增强）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量图表生成（专业版）操作,遵循单一意图原则。
**输出**: 返回批量图表生成（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自定义配色方案（专业版）操作,遵循单一意图原则。
**输出**: 返回自定义配色方案（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行图表模板库（专业版）操作,遵循单一意图原则。
**输出**: 返回图表模板库（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行SVG转PNG高清导出（专业版）操作,遵循单一意图原则。
**输出**: 返回SVG转PNG高清导出（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行图表版本管理（专业版）操作,遵循单一意图原则。
**输出**: 返回图表版本管理（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行交互式图表（专业版）操作,遵循单一意图原则。
**输出**: 返回交互式图表（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行图表组件库（专业版）操作,遵循单一意图原则。
**输出**: 返回图表组件库（专业版）的执行结果,包含操作状态和输出数据。
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：全功能、图表系统、含批量生成、版本管理与交互式、图表制作大师专业、版是技术文档图表、制作的完整解决方、在免费版基础上解、锁批量图表生成、图表组件库七大高、级功能、帮助团队建立统一、可复用的图表制作、when、需要设计创作、海报制作、品牌视觉时使用、不适用于、建模和动画制作等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
