...
license: MIT
edition: free
description: "翻译工具免费版，面向个人用户的轻量级文本翻译工具。核心能力:，可自发提升工作效率. 适用于需要translate toolkit相关能力的开发场景,包含结构化的工作流程和可复用的模板,帮助用户快速完成任务并保持代码质量. 适用于需要translate toolkit相关能力的开发场景,包含结构化的工作流程和配置指引."
tags:
  - 翻译
  - translate
  - toolkit
