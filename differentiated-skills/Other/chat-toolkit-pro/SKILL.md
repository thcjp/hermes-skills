...
edition: pro
description: |-
  面向团队与企业的全功能沟通偏好管理工具，在免费版基础上扩展多用户共享、版本历史、跨设备同步、偏好分析、场景化切换与跨Agent迁移等高级能力。
  ...
  差异化：相比免费版新增6项高级能力，配套完整FAQ、故障排查表、版本迁移指南与多平台集成示例，提供优先支持渠道。

  触发关键词：团队偏好、偏好版本、跨设备同步、偏好分析、场景化沟通、偏好迁移
tags:
- 团队偏好
- 偏好管理
- 版本历史
