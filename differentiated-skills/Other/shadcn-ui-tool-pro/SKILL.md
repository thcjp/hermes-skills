...
**处理**: 按照skill规范执行设计系统与令牌管理操作,遵循单一意图原则。
**输出**: 返回设计系统与令牌管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自定义组件库操作,遵循单一意图原则。
**输出**: 返回自定义组件库的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行Storybook 集成操作,遵循单一意图原则。
**输出**: 返回Storybook 集成的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多主题与品牌操作,遵循单一意图原则。
**输出**: 返回多主题与品牌的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行国际化组件操作,遵循单一意图原则。
**输出**: 返回国际化组件的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行无障碍合规操作,遵循单一意图原则。
**输出**: 返回无障碍合规的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行CI/CD 与测试操作,遵循单一意图原则。
**输出**: 返回CI/CD 与测试的执行结果,包含操作状态和输出数据。
