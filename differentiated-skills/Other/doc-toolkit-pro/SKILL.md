...
edition: pro
description: |-
  文档工具箱专业版是面向企业文档团队的DOCX全生命周期管理Skill，在免费版基础上扩展了批量处理、模板库、邮件合并、图片编辑、版本对比、水印加密、多格式导出等高级能力。
  ...
  - 目录自动生成与刷新，交叉引用管理
  - 与MCP工具集成，支持自然语言驱动文档流水线

  适用场景：
  - 企业合同、报价单、通知函的批量个性化生成
  - 技术文档中心的多格式同步发布
  - 法务团队的合同版本管理与条款对比
  - HR批量生成offer、合同、调薪通知
  - 市场团队从数据源生成定制化报告

  差异化：专业版构建了"模板-数据-生成-校验-发布"的完整文档自动化流水线。相比免费版的单文档处理，专业版支持从数据源到多格式交付的一键自动化，配合MCP工具集成可融入企业现有IT系统。是企业文档标准化与规模化的核心工具。

  触发关键词：DOCX、批量文档、模板管理、邮件合并、文档对比、水印加密、多格式导出、文档自动化
tags:
- 文档处理
- 企业工具
- 批量自动化
