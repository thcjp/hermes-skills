...
edition: free
description: |-
  图表工具免费版是一款面向开发者与技术写作者的智能图表生成Skill，支持通过自然语言描述快速产出标准化Mermaid图表。
  ...
  差异化：相比通用绘图工具，本Skill聚焦"少即是多"的设计哲学，强制节点数量上限与一致命名规范，让图表真正承担沟通职责而非炫技。免费版覆盖日常80%的图表需求，足以应对绝大多数文档配图场景。

  触发关键词：图表、流程图、时序图、架构图、ER图、Mermaid、可视化、结构图
tags:
- 图表生成
- 可视化
- 文档辅助
