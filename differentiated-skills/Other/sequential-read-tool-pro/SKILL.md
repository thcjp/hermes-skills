...
**处理**: 按照skill规范执行多人协作阅读操作,遵循单一意图原则。
**输出**: 返回多人协作阅读的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行知识图谱构建操作,遵循单一意图原则。
**输出**: 返回知识图谱构建的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行AI 深度分析操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行多格式支持操作,遵循单一意图原则。
**输出**: 返回多格式支持的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行跨文档关联操作,遵循单一意图原则。
**输出**: 返回跨文档关联的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行阅读报告操作,遵循单一意图原则。
**输出**: 返回阅读报告的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队读书会操作,遵循单一意图原则。
**输出**: 返回团队读书会的执行结果,包含操作状态和输出数据。
