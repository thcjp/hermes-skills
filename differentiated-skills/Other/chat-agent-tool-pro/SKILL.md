...
**处理**: 按照skill规范执行能力1：多房间并发管理操作,遵循单一意图原则。
**输出**: 返回能力1：多房间并发管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力2：消息持久化与回放操作,遵循单一意图原则。
**输出**: 返回能力2：消息持久化与回放的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力3：企业级鉴权操作,遵循单一意图原则。
**输出**: 返回能力3：企业级鉴权的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力5：自定义品牌Web UI操作,遵循单一意图原则。
**输出**: 返回能力5：自定义品牌Web UI的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力6：完整审计日志操作,遵循单一意图原则。
**输出**: 返回能力6：完整审计日志的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力7：高可用与负载均衡操作,遵循单一意图原则。
**输出**: 返回能力7：高可用与负载均衡的执行结果,包含操作状态和输出数据。
