...
**输入**: 用户提供插件市场所需的指令和必要参数。
**处理**: 按照skill规范执行插件市场操作,遵循单一意图原则。
**输出**: 返回插件市场的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供权限管控(RBAC)所需的指令和必要参数。
**处理**: 按照skill规范执行权限管控(RBAC)操作,遵循单一意图原则。
**输出**: 返回权限管控(RBAC)的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供热更新所需的指令和必要参数。
**处理**: 按照skill规范执行热更新操作,遵循单一意图原则。
**输出**: 返回热更新的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供插件间通信所需的指令和必要参数。
**处理**: 按照skill规范执行插件间通信操作,遵循单一意图原则。
**输出**: 返回插件间通信的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供沙箱隔离所需的指令和必要参数。
**处理**: 按照skill规范执行沙箱隔离操作,遵循单一意图原则。
**输出**: 返回沙箱隔离的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供开发脚手架所需的指令和必要参数。
**处理**: 按照skill规范执行开发脚手架操作,遵循单一意图原则。
**输出**: 返回开发脚手架的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供企业 UI 组件库所需的指令和必要参数。
**处理**: 按照skill规范执行企业 UI 组件库操作,遵循单一意图原则。
**输出**: 返回企业 UI 组件库的执行结果,包含操作状态和输出数据。
