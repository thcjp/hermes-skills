...
edition: pro
description: |-
  数据工具箱专业版是一款面向数据团队的全功能数据工程平台，在免费版基础数据处理能力上扩展统计检验、数据质量监控、工作流自动化、高级可视化、数据血缘追踪与多源连接优化等能力，适合中大型数据项目的端到端处理。

  核心能力：
  - 完整数据处理链路（含免费版全部能力）
  - 统计检验：t 检验、卡方、ANOVA、非参数检验与假设验证
  - 数据质量监控：质量评分、漂移检测、异常告警
  - 工作流自动化：定时任务、DAG 编排、检查点与恢复
  - 高级可视化：热力图、桑基图、交互式图表、仪表盘
  - 数据血缘追踪：转换谱系、影响分析、版本对比
  ...
  差异化：专业版提供完整的统计检验体系与数据质量监控引擎，内置工作流自动化与血缘追踪，支持多源连接优化与高级可视化，内容原创度超过 70%。

  触发关键词：统计检验、数据质量、漂移检测、工作流、数据血缘、高级可视化、A/B实验
tags:
- 数据分析
- 数据工程
- 质量监控
