...
**处理**: 按照skill规范执行四大审计领域（基础+增强）操作,遵循单一意图原则。
**输出**: 返回四大审计领域（基础+增强）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行三步审计协议（基础+增强）操作,遵循单一意图原则。
**输出**: 返回三步审计协议（基础+增强）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量审计自动化（专业版）操作,遵循单一意图原则。
**输出**: 返回批量审计自动化（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行实时监控告警（专业版）操作,遵循单一意图原则。
**输出**: 返回实时监控告警（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多标准交叉合规分析（专业版）操作,遵循单一意图原则。
**输出**: 返回多标准交叉合规分析（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行审计历史趋势分析（专业版）操作,遵循单一意图原则。
**输出**: 返回审计历史趋势分析（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自定义审计模板（专业版）操作,遵循单一意图原则。
**输出**: 返回自定义审计模板（专业版）的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行加密认证签发（专业版）操作,遵循单一意图原则。
**输出**: 返回加密认证签发（专业版）的执行结果,包含操作状态和输出数据。
