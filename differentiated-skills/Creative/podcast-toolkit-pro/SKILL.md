...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级播客创作与、运营工具包、支持多节目管理、变现策略与、适配团队协作、面向团队与专业创、作者的播客创作与、核心能力、涵盖免费版全部能、检查清单、多节目矩阵管理、增长分析与数据驱、变现策略与商业化、辅助内容生成、切片文案、团队协作与角色分、跨平台发布与、嘉宾关系管理等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent完成操作。专业版支持多节目管理、增长分析、变现策略与 AI 辅助生成,适合专业创作者与团队的企业级播客运营。
