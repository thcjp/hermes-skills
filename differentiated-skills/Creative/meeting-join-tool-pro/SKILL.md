...
edition: pro
description: |-
  AI会议助手专业版为企业与团队提供全方位的智能会议机器人解决方案。
  在免费版语音会议能力之上,增加可视化头像、屏幕共享、实时网页协作、
  多种语音策略、批量会议调度与团队管理能力。
  ...
  触发关键词: meeting, 会议, join, video, avatar, 屏幕共享, screenshare, 协作, batch, 批量, enterprise, 企业
tags:
- 会议
- 语音转写
- AI助手
