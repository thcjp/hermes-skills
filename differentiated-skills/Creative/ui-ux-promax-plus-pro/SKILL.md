...
**处理**: 按照skill规范执行完整UI风格库(含深度分析)操作,遵循单一意图原则。
**输出**: 返回完整UI风格库(含深度分析)的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行配色方案与语义令牌系统操作,遵循单一意图原则。
**输出**: 返回配色方案与语义令牌系统的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行25种数据可视化图表推荐操作,遵循单一意图原则。
**输出**: 返回25种数据可视化图表推荐的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行UX交互模式库操作,遵循单一意图原则。
**输出**: 返回UX交互模式库的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行常用组件设计规范操作,遵循单一意图原则。
**输出**: 返回常用组件设计规范的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行完整设计决策矩阵操作,遵循单一意图原则。
**输出**: 返回完整设计决策矩阵的执行结果,包含操作状态和输出数据。
