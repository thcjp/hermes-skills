...
**处理**: 按照skill规范执行批量视频生产操作,遵循单一意图原则。
**输出**: 返回批量视频生产的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多语言 TTS 配音操作,遵循单一意图原则。
**输出**: 返回多语言 TTS 配音的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自定义动画模板操作,遵循单一意图原则。
**输出**: 返回自定义动画模板的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行A/B 变体生成操作,遵循单一意图原则。
**输出**: 返回A/B 变体生成的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行品牌一致性管理操作,遵循单一意图原则。
**输出**: 返回品牌一致性管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行渲染队列与优先级调度操作,遵循单一意图原则。
**输出**: 返回渲染队列与优先级调度的执行结果,包含操作状态和输出数据。
