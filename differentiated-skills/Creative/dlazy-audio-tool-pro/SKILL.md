...
description: |-
  ...
  差异化：专业版在免费版基础上扩展至全部15+音频模型，支持语音克隆、音乐生成、多角色对话与管道链接。与免费版完全兼容。

  触发关键词: audio, TTS, 语音合成, 语音克隆, 音乐生成, 多角色对话, 音效, 播客, dlazy, voice clone, music
tags:
- Creative
- Audio
- Enterprise
