---
slug: openai-whisper-v1-tool-free
name: openai-whisper-v1-tool-free
version: "1.0.0"
...
edition: free
description: |-
  基于 Whisper v1 稳定版本的本地语音转文字工具(免费版)。
  ...
  - 完全本地运行,零 API 成本,保护隐私
  - 聚焦核心转录能力,降低学习门槛
  - 命令行简洁,适合脚本化调用

  触发关键词: whisper, v1, stable, transcription, 语音转文字, 转录, 字幕, 本地, stable, free
tags:
- 创意设计
- 语音转文字
- 本地工具
...
免费版聚焦核心转录能力,专业版(`openai-whisper-v1-tool-pro`)在此基础上提供批量处理、模型管理、性能调优与服务化部署等高级能力。
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务。免费版基于 v1 稳定版本,接口固化,适合长期维护的个人转录场景。
