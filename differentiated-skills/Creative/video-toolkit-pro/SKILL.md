---
slug: video-toolkit-pro
name: video-toolkit-pro
version: "1.0.0"
...
| 标准发布 | 23 | medium | 128k | 平衡(默认) |
| 平台压缩 | 28 | slow | 96k | 最小文件 |
...
| 时长正确 | `ffprobe ... duration` | 符合平台限制 |
| 文件大小 | `du -h output.mp4` | 在平台限制内 |
| 编码格式 | `ffprobe ... codec_name` | H.264+AAC |
| 分辨率 | `ffprobe ... width,height` | 符合目标比例 |
