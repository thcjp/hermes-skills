...
**输入**: 用户提供视频发布管理所需的指令和必要参数。
**处理**: 按照skill规范执行视频发布管理操作,遵循单一意图原则。
**输出**: 返回视频发布管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量下载与队列管理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行数据追踪与对比分析操作,遵循单一意图原则。
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级、站运营工具、支持高清下载、批量操作、数据追踪与凭证安、面向专业、主与企业运营的全、核心能力、高清视频下载、超清画质下载、草稿管理、视频编辑、批量下载与处理、数据追踪监控、定时追踪视频播放、点赞等指标变化、视频对比分析等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
