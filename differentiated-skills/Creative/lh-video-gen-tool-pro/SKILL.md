...
**处理**: 按照skill规范执行批量视频生成操作,遵循单一意图原则。
**输出**: 返回批量视频生成的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行视频质量审计操作,遵循单一意图原则。
**输出**: 返回视频质量审计的执行结果,包含操作状态和输出数据。
