...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级、Tailwind、CSS、工具包、支持自定义插件、性能优化与组件库、适配团队协作与大、型项目、面向团队与企业用、核心能力、涵盖免费版全部能、自定义插件开发与、Purge、包体分析、组件库抽象与复用、多主题与品牌切换、与主流框架集成、React、Vue、Next等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent完成操作。专业版支持自定义插件、设计系统与性能优化,适合企业级前端项目与团队协作。
