...
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级视觉偏好管、理系统、支持多媒介、团队协作与批量设、计生成、设计偏好工具箱专、面向团队与企业的、视觉偏好管理平台、五大媒介的偏好管、多用户团队偏好档、案与角色权限控制、品牌系统一致性校、验与自动修正、跨媒介偏好同步与、冲突消解、偏好导入导出与团、队共享机制、批量设计任务的偏、好自动注入等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
