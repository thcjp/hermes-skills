...
**处理**: 解析视频格式转换与压缩的输入参数,完成核心逻辑,返回结构化响应。
**输出**: 返回视频格式转换与压缩的响应数据,包含状态码、结果和日志。
...
**处理**: 解析字幕生成(Whisper本地转录)的输入参数,完成核心逻辑,返回结构化响应。
**输出**: 返回字幕生成(Whisper本地转录)的响应数据,包含状态码、结果和日志。
...
**处理**: 解析宽高比调整的输入参数,完成核心逻辑,返回结构化响应。
**输出**: 返回宽高比调整的响应数据,包含状态码、结果和日志。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析音频处理的输入参数,完成核心逻辑,返回结构化响应。
**输出**: 返回音频处理的响应数据,包含状态码、结果和日志。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析视频信息检测的输入参数,完成核心逻辑,返回结构化响应。
**输出**: 返回视频信息检测的响应数据,包含状态码、结果和日志。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析主流平台规格的输入参数,完成核心逻辑,返回结构化响应。
**输出**: 返回主流平台规格的响应数据,包含状态码、结果和日志。
