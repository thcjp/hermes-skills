...
**处理**: 按照skill规范执行批量目录扫描操作,遵循单一意图原则。
**输出**: 返回批量目录扫描的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行自定义输出模板操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行元数据提取操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行文档质量审计操作,遵循单一意图原则。
**输出**: 返回文档质量审计的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行转换历史与版本管理操作,遵循单一意图原则。
**输出**: 返回转换历史与版本管理的执行结果,包含操作状态和输出数据。
