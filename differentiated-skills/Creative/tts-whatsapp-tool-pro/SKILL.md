...
edition: pro
description: |-
  面向团队与企业用户的 WhatsApp 语音消息工具(专业版)。
  ...
  触发关键词: whatsapp, tts, piper, broadcast, batch, schedule, template, group, 群发, 广播, 批量, 定时, 模板, pro
tags:
- 创意设计
- 语音合成
- WhatsApp
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务。专业版支持群发广播、定时发送与 API 服务化,适合企业级语音消息触达场景。
