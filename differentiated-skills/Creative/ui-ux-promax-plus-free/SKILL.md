...
**处理**: 解析UI风格库的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回UI风格库的响应数据,包含状态码、结果和日志.
### 2. 配色方案查询
...
**处理**: 解析配色方案查询的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回配色方案查询的响应数据,包含状态码、结果和日志.
### 3. 字体配对推荐
...
**处理**: 解析字体配对推荐的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回字体配对推荐的响应数据,包含状态码、结果和日志.
### 4. 设计决策框架
...
| 参数名 | 类型 | 必填 | 说明 |
|:---:|:---:|:---:|:---:|
| input | string | 是 | UI/UX ProMax+免费版处理的输入数据或指令 |
...
**处理**: 解析设计决策框架的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回设计决策框架的响应数据,包含状态码、结果和日志.
...
**处理**: 解析Tailwind CSS快速应用的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回Tailwind CSS快速应用的响应数据,包含状态码、结果和日志.
...
```json
{
  "success": true,
  "data": {
    "result": "UI/UX ProMax+免费版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "ui ux promax plus"
    }
  },
