...
**处理**: 按照skill规范执行多品牌管理操作,遵循单一意图原则。
**输出**: 返回多品牌管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行批量资产生成操作,遵循单一意图原则。
**输出**: 返回批量资产生成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行品牌策略分析操作,遵循单一意图原则。
**输出**: 返回品牌策略分析的执行结果,包含操作状态和输出数据。
