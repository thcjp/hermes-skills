...
edition: pro
description: |-
  游戏资产生成工具专业版，面向游戏团队的全栈资产生成平台。

  核心能力：
  - 2D + 3D 全栈资产生成（含 GLB 格式 3D 模型）
  - 完整游戏设计文档（GDD）自动生成
  - 批量资产生成（一次生成 10+ 模型/精灵）
  - 7种艺术风格全覆盖（像素/手绘/扁平/低多边形/动漫/写实/3D）
  - 角色一致性保持（跨资产统一风格）
  - 游戏概念设计（故事/机制/世界观）
  - 粒子特效与动画资产
  ...
  差异化：专业版在免费版基础上扩展至3D模型、GDD生成、批量操作与全风格覆盖。与免费版2D资产能力完全兼容。

  触发关键词: game, asset, 3D模型, GDD, 游戏设计文档, 批量生成, GLB, Unity, Unreal, Godot, 游戏开发, 角色一致性
tags:
- Creative
- GameDev
- Enterprise
