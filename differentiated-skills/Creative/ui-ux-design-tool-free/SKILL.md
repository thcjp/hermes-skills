...
license: MIT
edition: free
description: "面向个人开发者和小型团队的UI/UX设计入门指南,包含移动优先的设计原则、. 适用于需要ui ux design tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 设计
  - UI
  - UX
...
**处理**: 解析移动优先设计原则的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回移动优先设计原则的响应数据,包含状态码、结果和日志.
### 2. 视觉层次构建
...
**处理**: 解析视觉层次构建的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回视觉层次构建的响应数据,包含状态码、结果和日志.
### 3. 配色系统
...
**处理**: 解析配色系统的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回配色系统的响应数据,包含状态码、结果和日志.
### 4. 字体排版体系(8px基准)
...
**处理**: 解析字体排版体系(8px基准)的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回字体排版体系(8px基准)的响应数据,包含状态码、结果和日志.
### 5. 布局模式
...
**处理**: 解析布局模式的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回布局模式的响应数据,包含状态码、结果和日志.
...
**处理**: 解析基础微交互的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回基础微交互的响应数据,包含状态码、结果和日志.
...
免费版提供基础设计参考建议。专业版包含对Linear、Stripe、Vercel、Notion等高级产品的深度设计分析和可借鉴的具体模式.
## 依赖说明
