...
description: |-
  ...
  差异化:免费版聚焦核心设计原则和基础工具链,提供Tailwind CSS快速上手指引,
  适合个人开发者快速建立设计意识。去除企业级组件库和深度无障碍审计功能。

  触发关键词: 设计指南, 配色系统, 字体排版, 响应式设计, 移动优先, 微交互, Tailwind, CSS Grid, Flexbox, 视觉层次
tags:
- 设计
- UI
- UX
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务。项目初始化和Tailwind CSS配置需要exec工具执行npm/npx命令。
