...
license: MIT
edition: free
description: "精英前端设计工具免费版，面向个人开发者的前端UI设计规范与产出工具。核心能力：. 适用于需要elite frontend tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - Creative
  - Frontend
  - UI
...
1. **字体对比优秀**：字重 100 vs 900，字号至少 3 倍跳跃.
