...
edition: pro
description: |-
  综合生成工具专业版，面向专业团队的全模态AI生成平台。

  核心能力：
  - 40+ 模型全覆盖（图片、视频、音频三大模态）
  - 高质量图片生成（seedream-4.5, veo-3.1, recraft-v4-pro等）
  - 视频生成（t2v, i2v, r2v, 首尾帧, 视频编辑）
  - 音频生成（TTS, 语音克隆, 音乐, 音效）
  - 矢量图生成（SVG输出，Logo/图标制作）
  - 管道链接（Pipe Chaining）串联多步骤工作流
  - 批量生成与自动化处理
  ...
  差异化：专业版在免费版基础上扩展至全模态40+模型，支持视频生成、矢量图、管道链接与批量处理。与免费版完全兼容。

  触发关键词: generate, image, video, audio, 图片生成, 视频生成, 音频生成, 文生视频, 图生视频, 矢量图, dlazy, multimodal, 管道链接
tags:
- Creative
- ImageGeneration
- VideoGeneration
