...
**处理**: 按照skill规范执行跨渠道消息管理与统一收件箱操作,遵循单一意图原则。
**输出**: 返回跨渠道消息管理与统一收件箱的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行情感分析与沟通健康度监测操作,遵循单一意图原则。
**输出**: 返回情感分析与沟通健康度监测的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行关系图谱操作,遵循单一意图原则。
**输出**: 返回关系图谱的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行沟通策略优化建议与 A/B 测操作,遵循单一意图原则。
**输出**: 返回沟通策略优化建议与 A/B 测的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行团队沟通规范与品牌语调一致性检操作,遵循单一意图原则。
**输出**: 返回团队沟通规范与品牌语调一致性检的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
