...
license: Proprietary
edition: pro
description: '核心能力: 沟通协作领域的专业化 AI 辅助工具,提供企业级高级功能支持.
...
**输入**: 用户提供跨渠道消息管理与统一收件箱所需的指令和必要参数.
...
**输入**: 用户提供沟通策略优化建议与 A/B 测所需的指令和必要参数.
...
**输入**: 用户提供团队沟通规范与品牌语调一致性检所需的指令和必要参数.
