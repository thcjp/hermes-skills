...
summary: "企业级任务规划系统,支持里程碑管理、资源分配、风险追踪与项目进度可视化。核心能力: 任务管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 任务管控领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要task planner tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 任务规划
  - 项目管理
  - 子任务
...
**处理**: 解析里程碑管理与关键路径分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回里程碑管理与关键路径分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 资源分配与工作量平衡
资源分配与工作量平衡

**处理**: 解析资源分配与工作量平衡的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回资源分配与工作量平衡的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 风险追踪与缓解计划管理
风险追踪与缓解计划管理

**处理**: 解析风险追踪与缓解计划管理的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回风险追踪与缓解计划管理的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 项目进度可视化
项目进度可视化:甘特图与燃尽图

**处理**: 解析项目进度可视化的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回项目进度可视化的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 多项目组合管理与优先级排序
多项目组合管理与优先级排序

**处理**: 解析多项目组合管理与优先级排序的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多项目组合管理与优先级排序的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级任务规划系、支持里程碑管理、风险追踪与项目进、核心能力、任务管理领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 任务规划器专业版处理的输入数据或指令 |
