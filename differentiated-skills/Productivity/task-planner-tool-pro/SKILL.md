...
**处理**: 按照skill规范执行里程碑管理与关键路径分析操作,遵循单一意图原则。
**输出**: 返回里程碑管理与关键路径分析的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行资源分配与工作量平衡操作,遵循单一意图原则。
**输出**: 返回资源分配与工作量平衡的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行风险追踪与缓解计划管理操作,遵循单一意图原则。
**输出**: 返回风险追踪与缓解计划管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行项目进度可视化操作,遵循单一意图原则。
**输出**: 返回项目进度可视化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行多项目组合管理与优先级排序操作,遵循单一意图原则。
**输出**: 返回多项目组合管理与优先级排序的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
