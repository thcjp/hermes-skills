...
**处理**: 按照skill规范执行多项目管理与标签分类系统操作,遵循单一意图原则。
**输出**: 返回多项目管理与标签分类系统的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队任务共享与分配操作,遵循单一意图原则。
**输出**: 返回团队任务共享与分配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与日历集成自动安排任务操作,遵循单一意图原则。
**输出**: 返回与日历集成自动安排任务的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行数据导出 CSV/JSON 供操作,遵循单一意图原则。
**输出**: 返回数据导出 CSV/JSON 供的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
