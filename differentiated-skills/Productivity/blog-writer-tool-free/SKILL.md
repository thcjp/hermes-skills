...
**处理**: 按照skill规范执行根据示例文章学习并匹配个人写作操作,遵循单一意图原则。
**输出**: 返回根据示例文章学习并匹配个人写作的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行整合用户提供的研究材料与链接操作,遵循单一意图原则。
**输出**: 返回整合用户提供的研究材料与链接的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行生成 800-1500 词结构操作,遵循单一意图原则。
**输出**: 返回生成 800-1500 词结构的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行支持多轮修改迭代操作,遵循单一意图原则。
**输出**: 返回支持多轮修改迭代的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行自动添加子标题与段落优化操作,遵循单一意图原则。
**输出**: 返回自动添加子标题与段落优化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
