...
license: Proprietary
edition: pro
description: "核心能力: 效率管控领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要personald tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 个人效率
  - 时间管理
  - 拖延症
...
**处理**: 解析团队效率基准对比与优秀实践分享的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队效率基准对比与优秀实践分享的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
