...
summary: "企业级个人效率系统,支持能量周期分析、习惯追踪、AI 教练与团队效率基准对比。核心能力: 效率管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: '核心能力: 效率管理领域的专业化 AI 辅助工具,提供企业级高级功能支持.
...
**输入**: 用户提供能量周期分析所需的指令和必要参数.
**处理**: 解析能量周期分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回能量周期分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 习惯追踪与行为模式分析
习惯追踪与行为模式分析

**输入**: 用户提供习惯追踪与行为模式分析所需的指令和必要参数.
**处理**: 解析习惯追踪与行为模式分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回习惯追踪与行为模式分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### AI 效率教练
AI 效率教练:个性化建议与每日复盘

**输入**: 用户提供AI 效率教练所需的指令和必要参数.
...
**输入**: 用户提供团队效率基准对比与最佳实践分享所需的指令和必要参数.
**处理**: 解析团队效率基准对比与最佳实践分享的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队效率基准对比与最佳实践分享的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与可穿戴设备集成的生物数据分析
与可穿戴设备集成的生物数据分析

**输入**: 用户提供与可穿戴设备集成的生物数据分析所需的指令和必要参数.
**处理**: 解析与可穿戴设备集成的生物数据分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回与可穿戴设备集成的生物数据分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级个人效率系、支持能量周期分析、教练与团队效率基、核心能力、效率管理领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 个人效率顾问专业版处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "个人效率顾问专业版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "personal prod pro"
    }
  },
