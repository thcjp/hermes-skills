...
**处理**: 按照skill规范执行能量周期分析操作,遵循单一意图原则。
**输出**: 返回能量周期分析的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行习惯追踪与行为模式分析操作,遵循单一意图原则。
**输出**: 返回习惯追踪与行为模式分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行AI 效率教练操作,遵循单一意图原则。
**输出**: 返回AI 效率教练的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行团队效率基准对比与最佳实践分享操作,遵循单一意图原则。
**输出**: 返回团队效率基准对比与最佳实践分享的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与可穿戴设备集成的生物数据分析操作,遵循单一意图原则。
**输出**: 返回与可穿戴设备集成的生物数据分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
