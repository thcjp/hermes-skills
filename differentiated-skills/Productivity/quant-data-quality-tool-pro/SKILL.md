...
**处理**: 按照skill规范执行自动化数据质量检查流水线操作,遵循单一意图原则。
**输出**: 返回自动化数据质量检查流水线的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行异常检测与实时告警通知操作,遵循单一意图原则。
**输出**: 返回异常检测与实时告警通知的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行数据血缘追踪与影响分析操作,遵循单一意图原则。
**输出**: 返回数据血缘追踪与影响分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行多数据源交叉验证与一致性检查操作,遵循单一意图原则。
**输出**: 返回多数据源交叉验证与一致性检查的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行数据质量评分卡与趋势分析操作,遵循单一意图原则。
**输出**: 返回数据质量评分卡与趋势分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
