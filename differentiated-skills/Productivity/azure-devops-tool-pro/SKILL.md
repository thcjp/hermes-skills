...
**输入**: 用户提供批量创建与流转工作项所需的指令和必要参数。
**处理**: 按照skill规范执行批量创建与流转工作项操作,遵循单一意图原则。
**输出**: 返回批量创建与流转工作项的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### CI/CD 流水线状态监控与构
CI/CD 流水线状态监控与构建失败告警

**输入**: 用户提供CI/CD 流水线状态监控与构所需的指令和必要参数。
**处理**: 按照skill规范执行CI/CD 流水线状态监控与构操作,遵循单一意图原则。
**输出**: 返回CI/CD 流水线状态监控与构的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 多项目跨仓库批量创建 PR 并
多项目跨仓库批量创建 PR 并自动添加审阅者

**输入**: 用户提供多项目跨仓库批量创建 PR 并所需的指令和必要参数。
**处理**: 按照skill规范执行多项目跨仓库批量创建 PR 并操作,遵循单一意图原则。
**输出**: 返回多项目跨仓库批量创建 PR 并的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队权限与安全策略审计
团队权限与安全策略审计,生成合规报告

**输入**: 用户提供团队权限与安全策略审计所需的指令和必要参数。
**处理**: 按照skill规范执行团队权限与安全策略审计操作,遵循单一意图原则。
**输出**: 返回团队权限与安全策略审计的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 工作项看板导出为 Excel/
工作项看板导出为 Excel/CSV 供离线分析

**输入**: 用户提供工作项看板导出为 Excel/所需的指令和必要参数。
**处理**: 按照skill规范执行工作项看板导出为 Excel/操作,遵循单一意图原则。
**输出**: 返回工作项看板导出为 Excel/的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
