...
license: Proprietary
edition: pro
description: '核心能力: 可视化工具领域的专业化 AI 辅助工具,提供企业级高级功能支持。
...
**输入**: 用户提供自定义品牌主题与企业视觉规范适所需的指令和必要参数。
**处理**: 按照skill规范执行自定义品牌主题与企业视觉规范适操作,遵循单一意图原则。
**输出**: 返回自定义品牌主题与企业视觉规范适的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 批量图表渲染与高清输出(SVG
批量图表渲染与高清输出(SVG/PDF/PNG)

**输入**: 用户提供批量图表渲染与高清输出(SVG所需的指令和必要参数。
**处理**: 按照skill规范执行批量图表渲染与高清输出(SVG操作,遵循单一意图原则。
**输出**: 返回批量图表渲染与高清输出(SVG的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 图表版本管理与变更对比
图表版本管理与变更对比

**输入**: 用户提供图表版本管理与变更对比所需的指令和必要参数。
**处理**: 按照skill规范执行图表版本管理与变更对比操作,遵循单一意图原则。
**输出**: 返回图表版本管理与变更对比的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与文档系统集成的图表嵌入
与文档系统集成的图表嵌入

**输入**: 用户提供与文档系统集成的图表嵌入所需的指令和必要参数。
**处理**: 按照skill规范执行与文档系统集成的图表嵌入操作,遵循单一意图原则。
**输出**: 返回与文档系统集成的图表嵌入的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 图表模板库与团队共享
图表模板库与团队共享

**输入**: 用户提供图表模板库与团队共享所需的指令和必要参数。
**处理**: 按照skill规范执行图表模板库与团队共享操作,遵循单一意图原则。
**输出**: 返回图表模板库与团队共享的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
