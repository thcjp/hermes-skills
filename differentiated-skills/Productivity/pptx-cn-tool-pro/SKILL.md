...
**处理**: 按照skill规范执行中文排版引擎操作,遵循单一意图原则。
**输出**: 返回中文排版引擎的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行本地化品牌模板库与多地区适配操作,遵循单一意图原则。
**输出**: 返回本地化品牌模板库与多地区适配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行中英混排自动调整与字体配对操作,遵循单一意图原则。
**输出**: 返回中英混排自动调整与字体配对的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行批量中文演示文稿生成操作,遵循单一意图原则。
**输出**: 返回批量中文演示文稿生成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行中文可读性评分与内容优化建议操作,遵循单一意图原则。
**输出**: 返回中文可读性评分与内容优化建议的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
