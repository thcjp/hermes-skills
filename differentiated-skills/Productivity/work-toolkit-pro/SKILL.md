...
**处理**: 按照skill规范执行企业文档管理与版本控制操作,遵循单一意图原则。
**输出**: 返回企业文档管理与版本控制的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行审批流程自动化与跟踪操作,遵循单一意图原则。
**输出**: 返回审批流程自动化与跟踪的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行团队协作空间与知识共享操作,遵循单一意图原则。
**输出**: 返回团队协作空间与知识共享的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行智能文档分类与全文检索操作,遵循单一意图原则。
**输出**: 返回智能文档分类与全文检索的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与企业 OA/ERP/CRM 操作,遵循单一意图原则。
**输出**: 返回与企业 OA/ERP/CRM 的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
