...
**处理**: 按照skill规范执行多项目管理与任务依赖追踪操作,遵循单一意图原则。
**输出**: 返回多项目管理与任务依赖追踪的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队任务分配与协作操作,遵循单一意图原则。
**输出**: 返回团队任务分配与协作的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行甘特图与项目时间线可视化操作,遵循单一意图原则。
**输出**: 返回甘特图与项目时间线可视化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行任务数据分析操作,遵循单一意图原则。
**输出**: 返回任务数据分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
