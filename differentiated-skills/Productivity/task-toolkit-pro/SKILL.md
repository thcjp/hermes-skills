...
slug: task-toolkit-pro
name: task-toolkit-pro
version: 1.0.0
displayName: 任务工具包专业版
summary: "企业级任务管理系统,支持多项目管理、团队协作、甘特图与自动化工作流。核心能力: 任务管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 任务管控领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要task toolkit相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 任务管理
  - 待办
  - 日程
...
本工具是 **任务管理** 领域的 **PRO 版本** AI Skill,专为企业级场景与专业用户设计。通过自然语言指令驱动 AI Agent 执行任务,提供高级功能、批量操作与团队协同.
...
**处理**: 解析多项目管理与任务依赖追踪的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多项目管理与任务依赖追踪的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队任务分配与协作
团队任务分配与协作

**处理**: 解析团队任务分配与协作的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队任务分配与协作的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 甘特图与项目时间线可视化
甘特图与项目时间线可视化

**处理**: 解析甘特图与项目时间线可视化的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回甘特图与项目时间线可视化的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 自动化工作流
自动化工作流:状态变更触发通知

**处理**: 解析自动化工作流的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回自动化工作流的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 任务数据分析
任务数据分析:完成率/延期率/工作量分布

**处理**: 解析任务数据分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回任务数据分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级任务管理系、支持多项目管理、甘特图与自动化工、核心能力、任务管理领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 任务工具包专业版处理的输入数据或指令 |
