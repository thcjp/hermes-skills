...
**处理**: 按照skill规范执行自动从 Git/日历/任务系统操作,遵循单一意图原则。
**输出**: 返回自动从 Git/日历/任务系统的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多人日报聚合与团队汇总操作,遵循单一意图原则。
**输出**: 返回多人日报聚合与团队汇总的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行日报趋势分析操作,遵循单一意图原则。
**输出**: 返回日报趋势分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行管理者仪表盘操作,遵循单一意图原则。
**输出**: 返回管理者仪表盘的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行日报模板自定义与企业品牌适配操作,遵循单一意图原则。
**输出**: 返回日报模板自定义与企业品牌适配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
