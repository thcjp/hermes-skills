...
license: Proprietary
edition: pro
description: "核心能力: 工作汇报领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要daily report tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 日报
  - 工作总结
  - Markdown
...
**处理**: 解析自动从 Git/日历/任务系统的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回自动从 Git/日历/任务系统的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 多人日报聚合与团队汇总
多人日报聚合与团队汇总

**处理**: 解析多人日报聚合与团队汇总的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多人日报聚合与团队汇总的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 日报趋势分析
日报趋势分析:工作量变化与阻塞模式

**处理**: 解析日报趋势分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回日报趋势分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 管理者仪表盘
管理者仪表盘:团队状态可视化

**处理**: 解析管理者仪表盘的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回管理者仪表盘的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 日报模板自定义与企业品牌适配
日报模板自定义与企业品牌适配

**处理**: 解析日报模板自定义与企业品牌适配的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回日报模板自定义与企业品牌适配的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级日报系统、支持自动采集、趋势分析与管理者、核心能力、工作汇报领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
