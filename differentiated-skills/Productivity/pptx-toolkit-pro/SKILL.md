...
**处理**: 按照skill规范执行品牌模板管理与多模板切换操作,遵循单一意图原则。
**输出**: 返回品牌模板管理与多模板切换的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量演示文稿生成与数据驱动幻灯操作,遵循单一意图原则。
**输出**: 返回批量演示文稿生成与数据驱动幻灯的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行团队协作审阅与版本管理操作,遵循单一意图原则。
**输出**: 返回团队协作审阅与版本管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行多格式导出(PDF/图片/视频操作,遵循单一意图原则。
**输出**: 返回多格式导出(PDF/图片/视频的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行演示文稿分析操作,遵循单一意图原则。
**输出**: 返回演示文稿分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
