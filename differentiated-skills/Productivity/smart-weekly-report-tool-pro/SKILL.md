...
version: 1.0.0
displayName: 智能周报专业版
summary: "企业级智能周报系统,支持多源数据采集、团队聚合、进度追踪与管理者仪表盘。核心能力: 工作汇报领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 工作汇报领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要smart weekly report tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 周报
  - 工作总结
  - 待办清单
...
**处理**: 解析多源数据采集的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多源数据采集的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队周报聚合与管理者汇总视图
团队周报聚合与管理者汇总视图

**处理**: 解析团队周报聚合与管理者汇总视图的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队周报聚合与管理者汇总视图的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 项目进度追踪与里程碑状态更新
项目进度追踪与里程碑状态更新

**处理**: 解析项目进度追踪与里程碑状态更新的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回项目进度追踪与里程碑状态更新的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 智能风险识别与延期预警
智能风险识别与延期预警

**处理**: 解析智能风险识别与延期预警的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回智能风险识别与延期预警的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 周报趋势分析
周报趋势分析:工作量变化与效率趋势

**处理**: 解析周报趋势分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回周报趋势分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级智能周报系、支持多源数据采集、团队聚合、进度追踪与管理者、仪表盘、核心能力、工作汇报领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 智能周报专业版处理的输入数据或指令 |
...
```json
{
  ...
  "data": {
    ...
    "metadata": {
      "version": "1.0",
      "processor": "smart weekly report pro"
    }
  },
