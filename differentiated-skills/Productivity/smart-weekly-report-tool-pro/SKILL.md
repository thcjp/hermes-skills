...
**处理**: 按照skill规范执行多源数据采集操作,遵循单一意图原则。
**输出**: 返回多源数据采集的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队周报聚合与管理者汇总视图操作,遵循单一意图原则。
**输出**: 返回团队周报聚合与管理者汇总视图的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行项目进度追踪与里程碑状态更新操作,遵循单一意图原则。
**输出**: 返回项目进度追踪与里程碑状态更新的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行周报趋势分析操作,遵循单一意图原则。
**输出**: 返回周报趋势分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
- `-W06-draft`: 命令参数,用于指定操作选项
- `-W07-todo`: 命令参数,用于指定操作选项
- `-Table`: 命令参数,用于指定操作选项
- `-E`: 命令参数,用于指定操作选项
