...
summary: "企业级智能效率系统,支持 AI 驱动的工作流优化、团队效率分析与预测性建议。核心能力: 效率管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
...
**输入**: 用户提供AI 驱动的工作流优化建议所需的指令和必要参数.
**处理**: 解析AI 驱动的工作流优化建议的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回AI 驱动的工作流优化建议的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队效率分析与基准对比
团队效率分析与基准对比

**输入**: 用户提供团队效率分析与基准对比所需的指令和必要参数.
...
**输入**: 用户提供预测性任务规划所需的指令和必要参数.
**处理**: 解析预测性任务规划的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回预测性任务规划的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 智能日程优化
智能日程优化:自动安排最优工作顺序

**输入**: 用户提供智能日程优化所需的指令和必要参数.
**处理**: 解析智能日程优化的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回智能日程优化的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与企业系统集成
与企业系统集成:日历/邮件/IM/项目管理

**输入**: 用户提供与企业系统集成所需的指令和必要参数.
**处理**: 解析与企业系统集成的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回与企业系统集成的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级智能效率系、团队效率分析与预、测性建议、核心能力、效率管理领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 效率助手 v4 专业版处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "效率助手 v4 专业版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "prod helper v4 pro"
    }
  },
