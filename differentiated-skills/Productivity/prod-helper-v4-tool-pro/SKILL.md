...
**处理**: 按照skill规范执行AI 驱动的工作流优化建议操作,遵循单一意图原则。
**输出**: 返回AI 驱动的工作流优化建议的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行团队效率分析与基准对比操作,遵循单一意图原则。
**输出**: 返回团队效率分析与基准对比的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行预测性任务规划操作,遵循单一意图原则。
**输出**: 返回预测性任务规划的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行智能日程优化操作,遵循单一意图原则。
**输出**: 返回智能日程优化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与企业系统集成操作,遵循单一意图原则。
**输出**: 返回与企业系统集成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
