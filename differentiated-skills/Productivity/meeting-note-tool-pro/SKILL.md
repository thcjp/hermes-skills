...
**处理**: 按照skill规范执行多轮深度阅读操作,遵循单一意图原则。
**输出**: 返回多轮深度阅读的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行专家圆桌操作,遵循单一意图原则。
**输出**: 返回专家圆桌的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行决策轨迹追踪操作,遵循单一意图原则。
**输出**: 返回决策轨迹追踪的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行隐含假设与风险机会识别操作,遵循单一意图原则。
**输出**: 返回隐含假设与风险机会识别的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行会议知识网络管理与索引入网操作,遵循单一意图原则。
**输出**: 返回会议知识网络管理与索引入网的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
