...
**处理**: 按照skill规范执行智能布局引擎操作,遵循单一意图原则。
**输出**: 返回智能布局引擎的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行数据驱动幻灯片操作,遵循单一意图原则。
**输出**: 返回数据驱动幻灯片的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行协作审阅流水线操作,遵循单一意图原则。
**输出**: 返回协作审阅流水线的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行多版本管理与变更对比操作,遵循单一意图原则。
**输出**: 返回多版本管理与变更对比的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行演示文稿 SEO 与可访问性检操作,遵循单一意图原则。
**输出**: 返回演示文稿 SEO 与可访问性检的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
