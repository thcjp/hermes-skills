...
**处理**: 按照skill规范执行多源数据聚合操作,遵循单一意图原则。
**输出**: 返回多源数据聚合的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行AI 智能摘要与关键信息提炼操作,遵循单一意图原则。
**输出**: 返回AI 智能摘要与关键信息提炼的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行报告模板管理与企业品牌适配操作,遵循单一意图原则。
**输出**: 返回报告模板管理与企业品牌适配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行自动分发操作,遵循单一意图原则。
**输出**: 返回自动分发的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行报告数据分析操作,遵循单一意图原则。
**输出**: 返回报告数据分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
