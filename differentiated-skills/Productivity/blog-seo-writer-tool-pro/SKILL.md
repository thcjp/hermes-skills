...
**输入**: 用户提供竞品内容差距分析所需的指令和必要参数。
**处理**: 按照skill规范执行竞品内容差距分析操作,遵循单一意图原则。
**输出**: 返回竞品内容差距分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 长尾关键词矩阵生成
长尾关键词矩阵生成,支持单次产出 20+ 篇主题集群

**输入**: 用户提供长尾关键词矩阵生成所需的指令和必要参数。
**处理**: 按照skill规范执行长尾关键词矩阵生成操作,遵循单一意图原则。
**输出**: 返回长尾关键词矩阵生成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 多语言多地区 SEO 适配与 
多语言多地区 SEO 适配与 hreflang 标签建议

**输入**: 用户提供多语言多地区 SEO 适配与 所需的指令和必要参数。
**处理**: 按照skill规范执行多语言多地区 SEO 适配与 操作,遵循单一意图原则。
**输出**: 返回多语言多地区 SEO 适配与 的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与 CMS 发布管道集成自动发
与 CMS 发布管道集成自动发布

**输入**: 用户提供与 CMS 发布管道集成自动发所需的指令和必要参数。
**处理**: 按照skill规范执行与 CMS 发布管道集成自动发操作,遵循单一意图原则。
**输出**: 返回与 CMS 发布管道集成自动发的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 结构化数据标记建议(Schem
结构化数据标记建议(Schema.org)

**输入**: 用户提供结构化数据标记建议(Schem所需的指令和必要参数。
**处理**: 按照skill规范执行结构化数据标记建议(Schem操作,遵循单一意图原则。
**输出**: 返回结构化数据标记建议(Schem的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
