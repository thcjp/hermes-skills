...
**处理**: 按照skill规范执行多配置文件管理(persona操作,遵循单一意图原则。
**输出**: 返回多配置文件管理(persona的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行数据库架构变更与差异对比操作,遵循单一意图原则。
**输出**: 返回数据库架构变更与差异对比的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行批量数据导入导出与格式转换操作,遵循单一意图原则。
**输出**: 返回批量数据导入导出与格式转换的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
