...
license: Proprietary
edition: free
description: '核心能力: 办公效率领域的专业化 AI 辅助工具,提供核心基础功能支持.
...
**处理**: 解析快速定位与打开常用文件的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回快速定位与打开常用文件的响应数据,包含状态码、结果和日志.
...
**处理**: 解析管理日程与提醒的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回管理日程与提醒的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析邮件草稿生成与回复建议的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回邮件草稿生成与回复建议的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析会议记录与待办提取的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回会议记录与待办提取的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析常用文档模板快速创建的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回常用文档模板快速创建的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
| input | string | 是 | 办公工具包基础版处理的输入数据或指令 |
