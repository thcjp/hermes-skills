...
license: Proprietary
edition: pro
description: "核心能力: 内容创作领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要blog writer tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 博客写作
  - 内容创作
  - 品牌语调
...
**处理**: 解析品牌语调管理的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回品牌语调管理的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 多人协作审稿工作流
多人协作审稿工作流:草稿到定稿全流程

**处理**: 解析多人协作审稿工作流的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多人协作审稿工作流的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 内容库治理
内容库治理:自动归档去重与版本控制

**处理**: 解析内容库治理的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回内容库治理的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 发布管道集成
发布管道集成:一键发布至主流平台

**处理**: 解析发布管道集成的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回发布管道集成的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### SEO 与可读性双重评分
SEO 与可读性双重评分

**处理**: 解析SEO 与可读性双重评分的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回SEO 与可读性双重评分的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级内容生产流、支持品牌语调管理、多人协作审稿与发、布自动化、核心能力、内容创作领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
