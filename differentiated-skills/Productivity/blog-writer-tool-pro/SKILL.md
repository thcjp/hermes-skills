...
**处理**: 按照skill规范执行品牌语调管理操作,遵循单一意图原则。
**输出**: 返回品牌语调管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多人协作审稿工作流操作,遵循单一意图原则。
**输出**: 返回多人协作审稿工作流的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行内容库治理操作,遵循单一意图原则。
**输出**: 返回内容库治理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行发布管道集成操作,遵循单一意图原则。
**输出**: 返回发布管道集成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行SEO 与可读性双重评分操作,遵循单一意图原则。
**输出**: 返回SEO 与可读性双重评分的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
