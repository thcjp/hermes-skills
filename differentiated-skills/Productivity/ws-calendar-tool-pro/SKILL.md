...
**处理**: 按照skill规范执行多平台日历聚合与统一视图操作,遵循单一意图原则。
**输出**: 返回多平台日历聚合与统一视图的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行智能调度操作,遵循单一意图原则。
**输出**: 返回智能调度的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行团队日历共享与权限管理操作,遵循单一意图原则。
**输出**: 返回团队日历共享与权限管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行会议室与资源预订系统操作,遵循单一意图原则。
**输出**: 返回会议室与资源预订系统的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行日历数据分析操作,遵循单一意图原则。
**输出**: 返回日历数据分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
