...
**处理**: 按照skill规范执行批量页面创建与属性映射操作,遵循单一意图原则。
**输出**: 返回批量页面创建与属性映射的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行数据库模板管理与自动应用操作,遵循单一意图原则。
**输出**: 返回数据库模板管理与自动应用的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行多数据源同步与跨工作区复制操作,遵循单一意图原则。
**输出**: 返回多数据源同步与跨工作区复制的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行工作流自动化操作,遵循单一意图原则。
**输出**: 返回工作流自动化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与外部系统集成的数据管道操作,遵循单一意图原则。
**输出**: 返回与外部系统集成的数据管道的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
