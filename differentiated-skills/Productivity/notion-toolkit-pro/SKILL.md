...
**输入**: 用户提供多数据源同步与跨工作区复制所需的指令和必要参数.
...
```bash
curl -X POST "https://api.notion.com/v1/pages" -H "Authorization: Bearer $NOTION_KEY" -H "Notion-Version: 2025-09-03" -d '{"parent":{"database_id":"xxx"},"properties":{"Name":{"title":[{"text":{"content":"New Item"}}]}}}'
```
