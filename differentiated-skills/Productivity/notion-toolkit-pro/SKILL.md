...
```bash
notion.com/v1/pages" -H "Authorization: Bearer $NOTION_KEY" -H "Notion-Version: 2025-09-03" -d '{"parent":{"database_id":"xxx"},"properties":{"Name":{"title":[{"text":{"content":"New Item"}}]}}}'
```
