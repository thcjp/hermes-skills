...
**处理**: 按照skill规范执行OAuth 认证与安全凭证管理操作,遵循单一意图原则。
**输出**: 返回OAuth 认证与安全凭证管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行批量页面操作与模板应用操作,遵循单一意图原则。
**输出**: 返回批量页面操作与模板应用的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行工作区安全审计与权限管理操作,遵循单一意图原则。
**输出**: 返回工作区安全审计与权限管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与外部系统的数据同步管道操作,遵循单一意图原则。
**输出**: 返回与外部系统的数据同步管道的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
