...
**输入**: 用户提供批量日程创建与会议邀请自动化所需的指令和必要参数。
**处理**: 按照skill规范执行批量日程创建与会议邀请自动化操作,遵循单一意图原则。
**输出**: 返回批量日程创建与会议邀请自动化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 组织架构集成
组织架构集成:按部门批量查询闲忙

**输入**: 用户提供组织架构集成所需的指令和必要参数。
**处理**: 按照skill规范执行组织架构集成操作,遵循单一意图原则。
**输出**: 返回组织架构集成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 会议室资源优化
会议室资源优化:智能推荐最优会议室

**输入**: 用户提供会议室资源优化所需的指令和必要参数。
**处理**: 按照skill规范执行会议室资源优化操作,遵循单一意图原则。
**输出**: 返回会议室资源优化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 重复日程与周期会议批量管理
重复日程与周期会议批量管理

**输入**: 用户提供重复日程与周期会议批量管理所需的指令和必要参数。
**处理**: 按照skill规范执行重复日程与周期会议批量管理操作,遵循单一意图原则。
**输出**: 返回重复日程与周期会议批量管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 日程数据分析
日程数据分析:会议时间分布与成本统计

**输入**: 用户提供日程数据分析所需的指令和必要参数。
**处理**: 按照skill规范执行日程数据分析操作,遵循单一意图原则。
**输出**: 返回日程数据分析的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
