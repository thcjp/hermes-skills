...
**处理**: 按照skill规范执行自动数据采集操作,遵循单一意图原则。
**输出**: 返回自动数据采集的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行峰值效率时段识别与任务匹配操作,遵循单一意图原则。
**输出**: 返回峰值效率时段识别与任务匹配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行工作生活平衡指标与预警操作,遵循单一意图原则。
**输出**: 返回工作生活平衡指标与预警的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
