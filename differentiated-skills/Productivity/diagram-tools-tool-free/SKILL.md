...
**输入**: 用户提供使用 Mermaid 语法生成所需的指令和必要参数.
...
**输入**: 用户提供使用 Graphviz DOT所需的指令和必要参数.
...
**输入**: 用户提供支持思维导图、甘特图、饼图等多所需的指令和必要参数.
...
**输入**: 用户提供生成数据图表(柱状图/折线图/所需的指令和必要参数.
