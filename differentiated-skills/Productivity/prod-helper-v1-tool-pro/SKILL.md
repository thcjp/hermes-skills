...
**处理**: 按照skill规范执行工作效率数据分析与可视化操作,遵循单一意图原则。
**输出**: 返回工作效率数据分析与可视化的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行智能提醒操作,遵循单一意图原则。
**输出**: 返回智能提醒的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行与日历/邮件集成的工作流操作,遵循单一意图原则。
**输出**: 返回与日历/邮件集成的工作流的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
