...
summary: "企业级效率助手,支持团队协作、数据分析、智能提醒与工作流自动化。核心能力: 效率管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 效率管控领域的专业化 AI 辅助工具,包含企业级高级功能兼容. 适用于需要prod helper v1 tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 效率助手
  - 任务管理
  - 笔记
...
**处理**: 解析工作效率数据分析与可视化的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回工作效率数据分析与可视化的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 智能提醒
智能提醒:基于工作模式自动提醒

**处理**: 解析智能提醒的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回智能提醒的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析与日历/邮件集成的工作流的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回与日历/邮件集成的工作流的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级效率助手、支持团队协作、智能提醒与工作流、核心能力、效率管理领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 效率助手 v1 专业版处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "效率助手 v1 专业版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "prod helper v1 pro"
    }
  },
