...
**处理**: 按照skill规范执行读取日志记录或对话上下文操作,遵循单一意图原则。
**输出**: 返回读取日志记录或对话上下文的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行生成结构化周报草稿(本周完成/操作,遵循单一意图原则。
**输出**: 返回生成结构化周报草稿(本周完成/的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行自动生成待办事项清单操作,遵循单一意图原则。
**输出**: 返回自动生成待办事项清单的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行配置报告目录与模板操作,遵循单一意图原则。
**输出**: 返回配置报告目录与模板的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行标记需要手动确认的内容操作,遵循单一意图原则。
**输出**: 返回标记需要手动确认的内容的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
