...
license: Proprietary
edition: pro
description: '面向企业运维团队的容器诊断平台。兼容Podman与Docker，支持批量

  容器检查、智能异常诊断、历史趋势分析、远程主机管理与安全审计。Use when 需要安全检测、合规审计、漏洞扫描、加密防护时使用。不适用于渗透测试未授权目标。适用于独立开发者、企业团队和自动化工作流场景。Use
