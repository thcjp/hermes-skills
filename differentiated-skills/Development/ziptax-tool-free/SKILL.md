...
edition: free
description: |-
  销售税查询工具免费版为个人开发者提供美国销售税率查询能力,支持按地址、邮编、经纬度查询,含基础CLI封装与税率解析。
  ...
  差异化:免费版聚焦个人开发者的基础税率查询需求,每月100次免费额度。Pro版扩展批量查询、缓存、税务合规报告与企业级集成。

  触发关键词: 销售税, sales tax, ziptax, 税率查询, 地址查询, 邮编查询, 经纬度查询, 税务
tags:
- 销售税
- 税务
- API集成
