...
edition: free
description: |-
  UI/UX设计助手免费版为个人开发者提供基础的UI/UX设计指导,涵盖布局方向、配色系统、排版规模与设计令牌输出。
  ...
  差异化:免费版聚焦个人开发者的基础设计需求,输出ASCII友好令牌。Pro版扩展完整设计系统、用户体验流程、可访问性审查与企业级规范。

  触发关键词: ui, ux, 设计, 布局, 配色, 排版, design tokens, 响应式, 设计令牌
tags:
- UI/UX
- 设计系统
- 前端开发
