...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级、Java、代码审查方案、支持批量审查、报告与、面向企业级、开发团队的代码审、查治理工具、Use、when、需要代码生成、编程辅助、调试测试、开发部署时使用、不适用于无明确技、术栈的模糊需求、适用于独立开发者、企业团队和自动化、工作流场景等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
### 场景一：全项目批量审查
团队需要对整个项目进行全面的代码审查.
```bash
