...
**处理**: 按照skill规范执行自动化代码审查操作,遵循单一意图原则。
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级、支持批量分支操作、自动化审查、管理与、流水线集成、面向企业研发团队、的高级、管理工具、提供批量分支操作、历史分析与、核心能力、批量分支管理与清、自动化代码审查与、提交规范强制执行、仓库历史深度分析等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
