...
edition: pro
description: |-
  知识图谱工具(专业版)面向团队与企业,提供完整的嵌入式知识图谱能力,含加密保险库、离线可视化、跨Agent协作与内存自动导入。
  ...
  差异化:
  - 完全兼容免费版查询与KGML格式
  - 新增保险库、可视化、多Agent、内存导入四大模块
  - 提供团队级配置治理与定期整理策略
  - 中英双语命令文档,适配国际化团队

  触发关键词: 知识图谱, knowledge, graph, 实体, 关系, vault, 保险库, 可视化, 多Agent, 内存导入, KGML, 团队知识
tags:
- Development
- Knowledge
- 团队知识库
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务。PRO版面向团队与企业,提供加密保险库、可视化、多Agent协作与内存导入能力,完全兼容免费版查询与KGML格式。
