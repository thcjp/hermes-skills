...
license: MIT
edition: free
description: "面向开发者的代码理解辅助工具,通过类比、ASCII图表和逐步遍历帮助理解代码逻辑。核心能力:，可处置提升工作效率. 适用于需要explain code tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 开发工具
  - 代码理解
  - 技术学习
...
### 可用性分类
- **分类**:MD+EXEC模式纯 Markdown 指令,部分功能需要 exec 读取文件)
