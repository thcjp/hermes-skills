...
**处理**: 按照skill规范执行批量多目标巡检操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行防火墙规则审计操作,遵循单一意图原则。
**输出**: 返回防火墙规则审计的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行持续监控与告警操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行网络路径分析操作,遵循单一意图原则。
