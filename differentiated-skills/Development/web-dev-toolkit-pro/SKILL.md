...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：面向团队的企业级、开发平台、含性能工程、企业部署与监控、开发工具集专业版、为团队与企业提供、端到端、开发工程能力、涵盖性能工程化、可访问性审查、企业级部署与监控、核心能力、可访问性审查与改等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持。
