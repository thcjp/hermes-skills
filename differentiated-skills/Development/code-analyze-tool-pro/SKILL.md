...
**处理**: 按照skill规范执行六大领域深度分析操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行批量分析与聚合报告操作,遵循单一意图原则。
**输出**: 返回批量分析与聚合报告的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行多视角交叉验证操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行自定义分析框架操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行历史存档与趋势追踪操作,遵循单一意图原则。
