...
edition: free
description: |-
  Mermaid图表工具(免费版)为个人用户从文本描述生成符合语法的Mermaid图表代码,支持流程图、时序图、脑图、状态图等基础类型。
  ...
  触发关键词: mermaid, 图表, 流程图, 时序图, 脑图, 状态图, diagram, 流程, 可视化
tags:
- Development
- 文档
- Mermaid
...
- **说明**: 基于Markdown的AI Skill,通过自然语言指令驱动Agent执行任务。免费版聚焦个人用户的7种基础Mermaid图表生成。
