...
**处理**: 按照skill规范执行多任务并行委派操作,遵循单一意图原则。
**输出**: 返回多任务并行委派的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行任务队列管理操作,遵循单一意图原则。
**输出**: 返回任务队列管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行写入保护与权限治理操作,遵循单一意图原则。
**输出**: 返回写入保护与权限治理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行团队协作会话操作,遵循单一意图原则。
**输出**: 返回团队协作会话的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行质量审计与代码审查操作,遵循单一意图原则。
**输出**: 返回质量审计与代码审查的执行结果,包含操作状态和输出数据。
