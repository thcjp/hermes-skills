...
summary: "面向团队的企业级UI/UX设计工程平台,含完整设计系统、UX流程、可访问性审查与脚本生成.。UI/UX设计助手专业版为团队与企业提供端到端UI/UX设计工程能力,涵盖完整设计系统、用户体验流"
license: Proprietary
edition: pro
description: "UI/UX设计助手专业版为团队与企业包含端到端UI/UX设计工程能力,涵盖完整设计系统、用户体验流程、WCAG AA可访问性审查与设计系统脚本产出。核心能力:. 适用于需要ui uxmax tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - UI/UX
  - 设计系统
  - 企业开发
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：面向团队的企业级、设计工程平台、含完整设计系统、可访问性审查与脚、设计助手专业版为、团队与企业提供端、设计工程能力、涵盖完整设计系统、用户体验流程、可访问性审查与设、计系统脚本生成、核心能力、动效令牌、用户体验流程图与、关键路径设计、可访问性审查与增、生成与令牌导出、组件规范与状态定、实施计划与文件级等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
