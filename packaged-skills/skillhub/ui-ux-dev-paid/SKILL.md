...
- 执行`批量图片转换与优化报告`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`批量图片转换与优化报告`相关配置参数进行设置
### 2. 设计系统持久化与引用
...
本skill还覆盖以下能力场景: React、项目生成、面向团队的专业页、面开发引擎、面向开发团队和代、理机构的专业级、页面生成引擎、支持多页面项目管、自动化截图审查循、批量图片处理和、核心能力、多页面项目管理与、配置持久化、设计系统引用与跨、页面一致性保障、打包导出与独立部、署支持、企业级设计原则自、动应用与质量门禁、组件化、开发与状态管理。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
1. `-gt`: 命令参数,用于指定操作选项
2. `-auto`: 命令参数,用于指定操作选项
3. `-pointer`: 命令参数,用于指定操作选项
4. `-primary`: 命令参数,用于指定操作选项
5. `-convert-images`: 命令参数,用于指定操作选项

**结果处理**: 执行完成后,查看输出结果确认操作状态。成功时输出包含处理摘要和结果数据;失败时根据错误信息排查问题,参考错误处理章节获取恢复步骤。

### 命令参数说明

- `-banner`: 命令参数,用于指定操作选项
- `-dom`: 命令参数,用于指定操作选项
- `-CN`: 命令参数,用于指定操作选项
- `-lg`: 命令参数,用于指定操作选项
- `-slate-50`: 命令参数,用于指定操作选项

### 命令参数说明

- `-enterprise-app`: 命令参数,用于指定操作选项
- `-serif`: 命令参数,用于指定操作选项
- `-f1`: 命令参数,用于指定操作选项
- `-slate-900`: 命令参数,用于指定操作选项
- `-between`: 命令参数,用于指定操作选项

### 命令参数说明

- `-CN`: 命令参数,用于指定操作选项
- `-portrait`: 命令参数,用于指定操作选项
- `-slate-600`: 命令参数,用于指定操作选项
- `-photos`: 命令参数,用于指定操作选项
- `-center`: 命令参数,用于指定操作选项

### 命令参数说明

- `-colors`: 命令参数,用于指定操作选项
- `-h-screen`: 命令参数,用于指定操作选项
- `-xl`: 命令参数,用于指定操作选项
- `-full`: 命令参数,用于指定操作选项
- `-w-7xl`: 命令参数,用于指定操作选项
...
- `-width`: 命令参数,用于指定操作选项
- `-progress`: 命令参数,用于指定操作选项
- `-screenshot`: 命令参数,用于指定操作选项
- `-default`: 命令参数,用于指定操作选项
- `-scale`: 命令参数,用于指定操作选项
