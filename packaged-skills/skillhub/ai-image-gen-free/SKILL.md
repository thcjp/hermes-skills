...
本skill还覆盖以下能力场景: 文生图基础版、支持标准与、种画面比例、图像生成基础版、通过执行脚本调用、完成文本生成图像、核心能力、文本提示词生成图、支持主体、色调描述、多比例、双分辨率、壁纸快速生成、个人创作者图片原、型与灵感草图、学习试用与轻量图、像生产。这些能力在上述核心功能中均有对应处理逻辑。
## 认证与配置
