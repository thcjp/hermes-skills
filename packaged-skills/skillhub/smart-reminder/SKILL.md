...
本skill还覆盖以下能力场景: 自然语言事件捕获、与提醒助手专业版、含自定义偏移、语义搜索与完整重、智能提醒助手专业、版是在免费版基础、上的全功能升级、Agent、提供企业级自然语、言事件管理能力、专业版解锁自定义、事件更新与归档等、高级特性、实现复杂事件场景、的智能管理、模型调用、智能对话、LLM、应用时使用、不适用于需要、确定性的关键决策。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
