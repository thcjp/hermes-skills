...
本skill还覆盖以下能力场景: 本地优先的图表生、成免费版、两种基础类型、无需联网、适合快速可视化、成引擎免费版、提供柱状图与折线、图两种基础类型、matplotlib、所有数据与产物仅、两种基础图表类型、生成图片、存储初始化、一键初始化本地存、升级付费版专享。这些能力在上述核心功能中均有对应处理逻辑。
## 存储路径
