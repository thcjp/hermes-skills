...
- 执行`腰臀比汇总`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`腰臀比汇总`相关配置参数进行设置
### 能力覆盖范围

本skill还覆盖以下能力场景: 企业级、Telegram、体测测量平台、支持批量扫描、团队管理与高级分、面向健身工作室、运动队与健康管理、团队的批量体测测、量平台、核心能力、团队数据管理、适用场景、健身工作室会员管、运动队体测跟踪、企业健康项目、医疗康复监测、差异化、专业版在免费版基、础上新增批量处理、与团队治理、兼容免费版提交接、口与返回格式。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
