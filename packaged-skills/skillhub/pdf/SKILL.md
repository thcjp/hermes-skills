...
本skill还覆盖以下能力场景: Comprehensive、manipulation、toolkit、extracting、text、tables、creating、new、PDFs、merging、Use、需要文件处理、文档转换、格式互转、内容提取时使用、不适用于加密文件、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
### 源能力映射
...
### 领域术语
本skill涉及以下领域术语: `canvas`, `simpledoctemplate`, `world`, `paragraph`, `protection`, `subject`, `layout`, `hello`, `extraction`, `watermark`, `images`, `best`, `pagebreak`, `tasks`, `title`
