...
summary_zh: "PDF全操作工具箱,提取文本表格/建PDF/合并/填表。Comprehensive PDF manipulation toolkit for extracting text and tabl"
license: "MIT"
description: |-
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | pdf处理的内容输入 |,  |
| content | string | 否 | pdf处理的内容输入 |, 可选值: json/text/markdown |
