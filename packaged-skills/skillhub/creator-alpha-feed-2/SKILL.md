---
name: creator-alpha-feed-2
slug: creator-alpha-feed-2
displayName: "Creator Alpha Feed"
version: "1.0.8"
summary: "为创作者发布流收集并排序每日AI内容"
description: "为创作者发布流收集并排序每日AI内容。Collect and rank daily AI content for creator-focused publishing workflows。Use when users ask fo。触发关键词: collect, feed, content, alpha, creator, daily, rank。"
license: "MIT"
tools:
  - read
---
