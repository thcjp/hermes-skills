...
本skill还覆盖以下能力场景: WhatsApp、全能力版、多智能体协作、预算调度、历史检索、类动作、专业版、面向团队与企业用、的全部、消息发送、群组管理、参与者、管理员、邀请链接、历史检索与多智能、体协作、配套拥塞控制、对话生命周期与预、算感知调度三大高、级协议。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
