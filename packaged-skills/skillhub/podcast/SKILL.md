...
| 源能力点 | 支持状态 | 实现方式 |
|:---------|:---------|:---------|
| Cadence | 支持 | 通过核心功能实现对应能力 |
| Niche | 支持 | 通过核心功能实现对应能力 |
...
### 领域术语
本skill涉及以下领域术语: `before`, `post`, `project`, `hook`, `performance`, `cover`, `consistency`, `engage`, `better`, `checklist`, `edit`, `guest`, `formats.md`, `outline`, `growth.md`
