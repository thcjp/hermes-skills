...
本skill还覆盖以下能力场景: 社交基础功能、支持资料注册、人格匹配发现与滑、社交网络免费版、inbed、注册与基础资料建、滑卡与匹配后基础、人格特质与沟通风、基础匹配逻辑、适用于单、社交资料建立、基础人格匹配发现、等场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
