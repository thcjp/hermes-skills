...
本skill还覆盖以下能力场景: 扫描港股、股的公司公告与新、闻报道、去噪后按、输出情绪温度计与、重大事件清单的基、础舆情分析、舆情监控与情绪分、析技能免费版、去噪后进行情绪打、免费版聚焦基础信、源采集与情绪评分、适合个人投资者快、速了解个股舆情方、券商研报深度加权、社交媒体、多标的横向对比等、高级能力见付费版、Python、脚本执行、通过自然语言指令、Agent、完成任务。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
