...
`workflow-decomposer`按照以下流程处理用户请求:
...
本skill还覆盖以下能力场景: 工作流任务拆解与、模型编排技能、使用场景、收到复杂工作任务、需要拆解为可执行、需要为不同步骤选、需要跟踪工作流进、度和模型使用情况、长时间任务卡住需、Use、需要项目管理、任务规划、进度跟踪、团队协作时使用、不适用于实际人员、绩效评估、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
