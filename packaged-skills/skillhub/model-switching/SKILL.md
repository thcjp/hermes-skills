...
本skill还覆盖以下能力场景: 团队级、Claude、模型切换套件、含成本仪表盘、自定义规则与监控、模型切换工具、专业版、面向团队与企业、在三层、模型切换基础上、扩展成本分析仪表、批量任务分发、自定义切换规则、实时监控告警与团、队策略治理能力、核心能力、自定义规则引擎、团队追踪成本、批量任务分发与并、切换白名单。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
