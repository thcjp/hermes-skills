...
**输出**: 返回画布区域浏览与像素调查的执行结果,包含操作状态和输出数据。

- 执行`画布区域浏览与像素调查`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
...
**输出**: 返回排行榜与统计数据的执行结果,包含操作状态和输出数据。

- 执行`排行榜与统计数据`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
...
**输出**: 返回聊天交互的执行结果,包含操作状态和输出数据。

- 执行`聊天交互`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`聊天交互`相关配置参数进行设置
### 6. 状态追踪与进度管理
