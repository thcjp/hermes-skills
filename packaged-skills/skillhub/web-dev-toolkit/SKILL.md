...
执行基础 Web 开发操作,处理用户输入并返回结果。

**输入**: 用户提供基础 Web 开发所需的参数和指令。

**输出**: 返回基础 Web 开发的处理结果。

- 执行`基础 Web 开发`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`基础 Web 开发`相关配置参数进行设置
### 性能工程化

执行性能工程化操作,处理用户输入并返回结果。

**输入**: 用户提供性能工程化所需的参数和指令。

**输出**: 返回性能工程化的处理结果。

- 执行`性能工程化`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`性能工程化`相关配置参数进行设置
### SEO 深度优化

执行SEO 深度优化操作,处理用户输入并返回结果。

**输入**: 用户提供SEO 深度优化所需的参数和指令。

**输出**: 返回SEO 深度优化的处理结果。

- 执行`SEO 深度优化`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`SEO 深度优化`相关配置参数进行设置
### 能力覆盖范围

本skill还覆盖以下能力场景: 面向团队的企业级、开发平台、含性能工程、企业部署与监控、开发工具集专业版、为团队与企业提供、端到端、开发工程能力、涵盖性能工程化、可访问性审查、企业级部署与监控、核心能力、可访问性审查与改。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
- `--reporter`: 命令参数,用于指定操作选项
- `-JP`: 命令参数,用于指定操作选项
- `-US`: 命令参数,用于指定操作选项

### 命令参数说明

- `-blocking-time`: 命令参数,用于指定操作选项
- `-CN`: 命令参数,用于指定操作选项
- `-euo`: 命令参数,用于指定操作选项
...
- `-Green`: 命令参数,用于指定操作选项
- `-zA-Z0-9`: 命令参数,用于指定操作选项
- `-dev-toolkit-green`: 命令参数,用于指定操作选项
...
- `-JP`: 命令参数,用于指定操作选项
- `-CN`: 命令参数,用于指定操作选项
- `-contentful-paint`: 命令参数,用于指定操作选项
