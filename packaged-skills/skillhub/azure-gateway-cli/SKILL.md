...
displayName: "azure-gateway-cli"
version: "1.0.0"
summary: "桥接Azure Claude与Skill平台的轻量Node代理"
description: "桥接Azure Claude与Skill平台的轻量Node代理。This skill is a disclosed local proxy for routing SkillHub requests。触发关键词: local, azure, disclosed, proxy, llm-provider, skill。"
license: "MIT"
tools:
  - Read
  - Write
...
```bash
export AZURE__ENDPOINT="your-resource.llm-provider.azure.com"
export AZURE__DEPLOYMENT="o"
export AZURE__API_VERSION="2025-01-01-preview"
...
| `AZURE__ENDPOINT` | — | Azure resource hostname |
| `AZURE__DEPLOYMENT` | `o` | Deployment name |
| `AZURE__API_VERSION` | `2025-01-01-preview` | API version |
...
- This skill is a disclosed local proxy for routing SkillHub requests
