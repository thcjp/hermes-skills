...
summary_zh: "涵盖设计原则、配色系统、Shadcn/ui+Tailwind栈、响应式设计与WCAG 2.2无障碍的完整指南。"
license: "MIT"
description: |-
...
### UI设计五法则（The 5 Laws of Beautiful UI）
...
### 快速参考与构建前检查清单（Quick Reference & Pre-Build Checklist）
编码前需确认的检查清单：
