...
1. `--group-id`: 命令参数,用于指定操作选项
2. `--section-id`: 命令参数,用于指定操作选项
3. `--add-users`: 命令参数,用于指定操作选项
4. `--email`: 命令参数,用于指定操作选项
5. `-user-to-workspace`: 命令参数,用于指定操作选项

**结果处理**: 执行完成后,查看输出结果确认操作状态。成功时输出包含处理摘要和结果数据;失败时根据错误信息排查问题,参考错误处理章节获取恢复步骤。

### 命令参数说明

- `-workspace-manager-pro`: 命令参数,用于指定操作选项
- `-create-channels`: 命令参数,用于指定操作选项
- `-canvas-sections`: 命令参数,用于指定操作选项
- `-enterprise-teams`: 命令参数,用于指定操作选项
- `--title`: 命令参数,用于指定操作选项

### 命令参数说明

- `--enterprise-grid`: 命令参数,用于指定操作选项
- `-alpha-general`: 命令参数,用于指定操作选项
- `--canvas-id`: 命令参数,用于指定操作选项
- `--days`: 命令参数,用于指定操作选项
- `-alpha-eng`: 命令参数,用于指定操作选项

### 命令参数说明

- `-leads`: 命令参数,用于指定操作选项
- `-user-group`: 命令参数,用于指定操作选项
