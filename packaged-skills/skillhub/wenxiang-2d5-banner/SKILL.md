...
本skill还覆盖以下能力场景: 用户需要、Wenxiang、Banner、相关功能时使用、不适用于超出本技、能能力范围的复杂。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
- `--resolution`: 命令参数,用于指定操作选项
- `-dramatic-sky`: 命令参数,用于指定操作选项
- `--input-image`: 命令参数,用于指定操作选项

### 命令参数说明

- `-japanese-garden`: 命令参数,用于指定操作选项
- `-banana-pro`: 命令参数,用于指定操作选项
