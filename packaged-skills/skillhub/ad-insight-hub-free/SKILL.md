...
本skill还覆盖以下能力场景: AdMapix、广告情报、API、基础查询、参数翻译、应用画像、面向广告投放场景、的广告情报数据查、询工具、免费版、之上提供参数自然、语言翻译与、基础创意搜索能力、支持广告创意搜索、查询两大基础能力、内置高频行业码与、国家码中文映射、支持单端点查询与、基础参数翻译、适用于买量团队竞、品创意监控、应用信息查询等基、础场景。这些能力在上述核心功能中均有对应处理逻辑。
## 参数映射表
