...
summary: "SkillHub实时运营仪表盘,监控会话/成本/cron/网关"
license: "Proprietary"
description: |-
...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| Real-time operations dashboard for SkillHub | 支持 | 支持 |
| Monitors sessions, costs, | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | openclaw-dashboard处理的内容输入 |,  |
...
中间产物模板参考: `assets/openclaw-dashboard_template`
