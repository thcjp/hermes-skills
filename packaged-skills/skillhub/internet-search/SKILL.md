...
本skill还覆盖以下能力场景: SEO、关键词分析、排名提升、搜索流量优化时使、不适用于黑帽。这些能力在上述核心功能中均有对应处理逻辑。
### 领域术语
本skill涉及以下领域术语: `scholar`, `bing`, `count`, `pubmed`, `social`, `fire`, `academic`, `meaning`, `wikipedia`, `opinions`, `reddit`, `general`, `repeating`, `google`, `brave`
