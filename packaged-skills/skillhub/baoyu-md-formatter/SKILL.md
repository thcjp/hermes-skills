...
description: "格式化纯文本与Markdown,补frontmatter/标题/摘要/列表。Formats plain text or markdown files with frontmatter, titles, summaries,。触发关键词: files, format, text, baoyu, plain, formats, markdown。"
license: "MIT-0"
tools:
  - Read
  - Write
