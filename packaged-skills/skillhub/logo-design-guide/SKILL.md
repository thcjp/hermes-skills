...
**处理**: 按照skill规范执行辨识度设计三大要素操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行多格式交付操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行多平台适配尺寸操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行布局变体操作,遵循单一意图原则。
**输出**: 返回布局变体的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行字体系统操作,遵循单一意图原则。
**输出**: 返回字体系统的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行一致性指南操作,遵循单一意图原则。
**输出**: 返回一致性指南的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行制作与优化工具操作,遵循单一意图原则。
