...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| 带货直播、娱乐直播、知识直播话术、互动设计、开场预热、逼单话术、互动话术库 | 支持 | 支持 |
| Live stream script generator | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | live-stream-script处理的内容输入 |,  |
| content | string | 否 | live-stream-script处理的内容输入 |, 可选值: json/text/markdown |
