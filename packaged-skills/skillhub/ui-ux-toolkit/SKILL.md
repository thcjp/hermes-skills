...
description: "可搜UI/UX设计库,50+风格/97色板/57字体对/99规则(社区下载版)。Searchable UI/UX design databases: 50+ styles, 97 palettes, 57 font。触发关键词: databases, palettes, design, styles, searchable。"
license: "MIT"
tools:
  - read
---
...
```bash
npx SkillHub@latest install ui-ux-pro-max
```
...
- 触发关键词: databases, palettes, design, styles, searchable
