...
description: "解析生成RFC 4180合规CSV,跨工具通用。Parse and generate RFC 4180 compliant CSV that works across tools。触发关键词: generate, compliant, parse, csv, works。提供专业能力支持,覆盖多场景工作流,支持自动化处理。"
license: "MIT"
tools:
  - read
---
...
- **Agent平台**: CSV技能需要支持SKILL.md的AI Agent，如 Code、Cursor、Codex、 CLI等。
