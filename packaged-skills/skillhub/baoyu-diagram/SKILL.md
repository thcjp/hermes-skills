...
description: "生成专业暗色主题SVG图表:架构图、流程图、时序图,一键产出高质量技术可视化。Create professional, dark-themed SVG diagrams of any type — architecture。触发关键词: themed, create, diagram, diagrams, baoyu, professional, dark。"
license: "MIT-0"
tools:
  - read
---
...
<g transform="translate(X, Y)">
  ...
  <text x="60" y="40" fill="white" font-size="11" font-weight="600" text-anchor="middle">关系型数据库</text>
</g>
```
