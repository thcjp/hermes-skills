...
### 领域术语
本skill涉及以下领域术语: `track`, `anticipate`, `reliability`, `maintain`, `prioritize`, `summarize`, `communicate`, `minimize`, `prepare`, `完全适配`, `information`, `follow`, `confirm`, `protect`, `remember`
