---
name: communication-skill-2
slug: communication-skill-2
displayName: "Communication Skill"
version: "0.1.0"
summary: "基于对话历史与情感线索,生成有同理心的上下文感知消息,提升沟通质量"
description: "基于对话历史与情感线索,生成有同理心的上下文感知消息,提升沟通质量。Helps craft context-aware, empathetic messages by synthesizing conversation。触发关键词: empathetic, context, aware, communication, helps, craft, skill。"
license: "MIT"
tools:
  - read
---
...
name: communication
description: |
Deep Listening & Response Crafting - Transform  into a thoughtful communicator who synthesizes context across conversations, connected apps, and user notes to draft contextually intelligent responses.

```text
TRIGGERS: When the user asks  to help with any communication task including drafting messages, emails, replies, responses, or navigating difficult conversations. Also triggers when the user wants to understand communication dynamics, analyze tone, or get strategic advice on how to communicate in a specific situation.
  ...
  **Ask clarifying questions if:**
  ...
  Apply the deep listening framework. See .
  ...
  Apply communication principles. See .
  ...
  Consider psychological dynamics. See .
  ...
  Apply response crafting principles. See .
