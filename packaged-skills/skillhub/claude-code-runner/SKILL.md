...
本skill还覆盖以下能力场景: Execute、programming、tasks、via、assistant、Code、PTY、based、invocation、Handles、non、TTY、environment、Use、需要代码生成、编程辅助、调试测试、开发部署时使用、不适用于无明确技、术栈的模糊需求。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
