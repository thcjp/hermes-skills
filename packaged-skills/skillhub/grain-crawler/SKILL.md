...
执行本地优先检索,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供本地优先检索相关的配置参数、输入数据和处理选项。

**输出**: 返回本地优先检索的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`本地优先检索`相关配置参数进行设置
### 笔记搜索

执行笔记搜索,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供笔记搜索相关的配置参数、输入数据和处理选项。

**输出**: 返回笔记搜索的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`笔记搜索`相关配置参数进行设置
### 笔记详情

执行笔记详情,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供笔记详情相关的配置参数、输入数据和处理选项。

**输出**: 返回笔记详情的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`笔记详情`相关配置参数进行设置
#
## 适用场景
