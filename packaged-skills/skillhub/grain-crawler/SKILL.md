...
summary: "全功能 Granola"
summary_zh: "全功能 Granola 归档检索，含同步、SQL、转录稿、面板、批量导出。。全功能 Granola 归档检索。Use when 需要提升效率、自动化流程、批量处理、工作流优化时使用。不适用于"
license: "MIT"
edition: "pro"
description: |-
...
针对本地优先检索,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应.
**输入**: 用户提供本地优先检索相关的配置参数、输入数据和处理选项.
**输出**: 返回本地优先检索的处理结果。- 验证返回数据的完整性和格式正确性
- 参考`本地优先检索`的配置文档进行参数调优
### 笔记搜索

针对笔记搜索,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应.
**输入**: 用户提供笔记搜索相关的配置参数、输入数据和处理选项.
**输出**: 返回笔记搜索的处理结果。- 验证返回数据的完整性和格式正确性
- 参考`笔记搜索`的配置文档进行参数调优
### 笔记详情

针对笔记详情,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应.
**输入**: 用户提供笔记详情相关的配置参数、输入数据和处理选项.
