...
| 源能力点 | 支持状态 | 实现方式 |
|:---------|:---------|:---------|
| Common proxy issues | 支持 | 通过核心功能实现对应能力 |
...
### 领域术语
本skill涉及以下领域术语: `diagnosing`, `dig`, `cname`, `closed`, `ttfb`, `ubuntu`, `post`, `listen`, `dkim`, `aaaa`, `authority`, `applicationfirewall`, `valid`, `firewall`, `verbose`
...
- `-enddate`: 命令参数,用于指定操作选项
- `-noout`: 命令参数,用于指定操作选项
- `-CAfile`: 命令参数,用于指定操作选项
- `-issuer`: 命令参数,用于指定操作选项
- `-certificates`: 命令参数,用于指定操作选项

### 命令参数说明

- `-subject`: 命令参数,用于指定操作选项
- `-servername`: 命令参数,用于指定操作选项
- `-dates`: 命令参数,用于指定操作选项
- `-CAfile`: 命令参数,用于指定操作选项
- `-showcerts`: 命令参数,用于指定操作选项
