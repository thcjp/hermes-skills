...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| 关系型数据库-based job queue with priority scheduling, batch claiming, | 支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | postgres-job-queue处理的内容输入 |,  |
| content | string | 否 | postgres-job-queue处理的内容输入 |, 可选值: json/text/markdown |
