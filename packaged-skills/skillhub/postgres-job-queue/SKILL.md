...
### 领域术语
本skill涉及以下领域术语: `begin`, `priorityexplicit`, `scenario`, `implementation`, `worker`, `timestamptz`, `returning`, `retry`, `background`, `event`, `locked`, `approach`, `rowsaffected`, `primary`, `close`
