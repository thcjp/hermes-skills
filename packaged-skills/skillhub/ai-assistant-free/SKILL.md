...
本skill还覆盖以下能力场景: 长文本推理基础工、提供文档评估、核心逻辑提取与基、础风险检测三大能、免费版、针对商业合同、备忘录、提案等长文档、三大基础能力、帮助快速梳理文档、结构与识别明显风、覆盖目的识别、歧义与矛盾检测等、基础分析、适用于合同审查准、备忘录摘要等基础、如需多版本对比、风险转移条款识别、结构改进建议、护栏机制等、高级能力、请升级至、assistant、付费版、提供分析支持、不替代持牌法律意。这些能力在上述核心功能中均有对应处理逻辑。
## 标准输出格式
