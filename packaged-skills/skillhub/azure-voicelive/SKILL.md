...
description: "纯文档型Azure语音SDK技能,麦克风/转写/凭据说明。> **核心功能**: 本技能提供、格式互转、内容提取时使用、化工作流场景等能力。。适用于多种工作场景,提供专业的能力支持。提供专业能力支持,覆盖多场景工作流,支持自动化处理。支持多种输入格式,输出结构化结果,适配独立开发者与小型团队。"
license: "MIT"
tools:
  - read
---
