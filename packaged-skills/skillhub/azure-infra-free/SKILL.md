...
description: "Azure基础设施技能(云写风险需谨慎)。提供专业的能力支持,适用于多种工作场景。提供专业能力支持,覆盖多场景工作流,支持自动化处理。内置错误恢复与降级机制,多格式兼容,适配多源数据。"
license: "MIT"
tools:
  - read
---
...
## Subscription & 租户 Handling

* If the user specifies a subscription/租户, honor it.
