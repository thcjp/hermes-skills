...
| 源能力点 | 支持状态 | 实现方式 |
|:---------|:---------|:---------|
| Performance/SEO/a11y | 支持 | 通过核心功能实现对应能力 |
...
### 领域术语
本skill涉及以下领域术语: `mixed`, `remix`, `page`, `mobile`, `html-css.md`, `vercel`, `foreach`, `astro`, `deploy.md`, `height`, `images`, `environment`, `vite`, `netlify`, `lighthouse`
