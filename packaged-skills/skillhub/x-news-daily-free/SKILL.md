...
本skill还覆盖以下能力场景: 关键词热门新闻、生成基础中文海报、News、Daily、免费版、上指定关键词的热、门新闻、自动将英文标题翻、渲染为基础、海报图片、大视口截图方案、适用于每日新闻简、关键词热搜查看等、基础场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
