...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| Remove signs of AI-generated writing from text | 支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | humanizer处理的内容输入 |,  |
| content | string | 否 | humanizer处理的内容输入 |, 可选值: json/text/markdown |
