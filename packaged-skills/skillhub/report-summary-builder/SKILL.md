...
|---|---|---|
| 基础功能 | 支持 | 支持 |
| Report Summary Build已有日报自动汇总生成 | 不支持 | 支持 |
| Report Summary Build享高级功能与批量处理 | 不支持 | 支持 |
| 高清分辨率与无损输出 | 不支持 | 支持 |
| 批量生成与风格预设 | 不支持 | 支持 |
| 自定义模型微调 | 不支持 | 支持 |
...
| Report Sum | 目标数据与配置参数 | 处理结果与执行状态 |
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | report-summary-builder处理的内容输入 |,  |
| content | string | 否 | report-summary-builder处理的内容输入 |, 可选值: json/text/markdown |
