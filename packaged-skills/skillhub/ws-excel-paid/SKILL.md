...
针对多表合并,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应。

**输入**: 用户提供多表合并相关的配置参数、输入数据和处理选项。

**输出**: 返回多表合并的处理结果。- 验证返回数据的完整性和格式正确性
- 参考`多表合并`的配置文档进行参数调优
### 透视表

针对透视表,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应。

**输入**: 用户提供透视表相关的配置参数、输入数据和处理选项。

**输出**: 返回透视表的处理结果。- 验证返回数据的完整性和格式正确性
- 参考`透视表`的配置文档进行参数调优
### 图表生成

针对图表,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应。
