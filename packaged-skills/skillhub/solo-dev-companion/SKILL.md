...
本skill还覆盖以下能力场景: 全功能、TDD、工作流引擎、阶段检查点与高级、独立开发伙伴专业、版是在免费版基础、上的全功能升级、为独立开发者与一、人公司提供企业级、除核心、执行外、高级回滚、进度追踪集成六大、高级功能、Use、需要代码生成、编程辅助、调试测试、开发部署时使用、不适用于无明确技、术栈的模糊需求。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
