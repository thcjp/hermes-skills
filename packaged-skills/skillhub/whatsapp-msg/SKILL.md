...
本skill还覆盖以下能力场景: WhatsApp、消息全能力版、批量发送、持续同步与高级搜、消息工具、专业版、面向团队与企业用、在免费版基础消息、能力之上新增批量、操作引擎、支持从消息发送到、数据归档的完整工、Use、需要数据分析、报表生成、统计洞察、数据可视化时使用、不适用于实时流数、据处理、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
- `--caption`: 命令参数,用于指定操作选项
- `--from-me`: 命令参数,用于指定操作选项
- `--retry`: 命令参数,用于指定操作选项
...
- `--after`: 命令参数,用于指定操作选项
- `--regex`: 命令参数,用于指定操作选项
- `--has-media`: 命令参数,用于指定操作选项
- `--fulltext`: 命令参数,用于指定操作选项
- `--group`: 命令参数,用于指定操作选项
...
- `--all-chats`: 命令参数,用于指定操作选项
- `--rate_limit`: 命令参数,用于指定操作选项
- `--input`: 命令参数,用于指定操作选项
