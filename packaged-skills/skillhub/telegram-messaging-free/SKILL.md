...
本skill还覆盖以下能力场景: Telegram、Bot、API、基础消息发送与聊、Skill、免费版、获取机器人信息、查询聊天基本信息、所有写操作需用户、适用于基础消息通、聊天信息查询等场。这些能力在上述核心功能中均有对应处理逻辑。
## 工具列表
