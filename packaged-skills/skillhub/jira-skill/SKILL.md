...
本skill还覆盖以下能力场景: Cloud、REST、API、管理事务、状态流转与工时日、支持搜索、集成助手通过、支持模糊搜索、详情查看、工时记录与多维度、核心能力、事务详情与浏览器、快速查看与跳转、变更前校验、邮箱搜索用户并指、添加评论、支持指定日期、按日全员、适用场景、第三方、平台对接、数据同步、独立开发者与一人、公司效率提升、自动化工作流。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
