...
**处理**: 按照skill规范执行堆叠上下文陷阱操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行布局陷阱操作,遵循单一意图原则。
**输出**: 返回布局陷阱的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行Flexbox陷阱操作,遵循单一意图原则。
**输出**: 返回Flexbox陷阱的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行Grid陷阱操作,遵循单一意图原则。
**输出**: 返回Grid陷阱的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行响应式哲学操作,遵循单一意图原则。
**输出**: 返回响应式哲学的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行尺寸函数操作,遵循单一意图原则。
**输出**: 返回尺寸函数的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行现代选择器操作,遵循单一意图原则。
**输出**: 返回现代选择器的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行滚动行为操作,遵循单一意图原则。
**输出**: 返回滚动行为的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行简写陷阱操作,遵循单一意图原则。
**输出**: 返回简写陷阱的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行可访问性基线操作,遵循单一意图原则。
**输出**: 返回可访问性基线的执行结果,包含操作状态和输出数据。
...
本skill还覆盖以下能力场景: 规避堆叠上下文、布局怪癖与现代、CSS、特性误用、规避常见、堆叠上下文失效、响应式策略、性能优化与、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
