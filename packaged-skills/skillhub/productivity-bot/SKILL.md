...
本skill还覆盖以下能力场景: Automation、bot、productivity、tasks、including、data、processing、scheduled、notifications、wor、Use、需要提升效率、自动化流程、批量处理、工作流优化时使用、不适用于需要人工、创意判断的任务。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
