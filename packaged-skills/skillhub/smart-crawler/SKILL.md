...
本skill还覆盖以下能力场景: 企业级知识库爬取、与检索平台、支持多工作空间、分布式调度、增量索引、全文检索与自定义、适合团队与企业规、模化使用、智能爬虫、是面向团队与企业、的全功能知识库爬、Skill、在免费版基础上新、增多工作空间管理、全文检索引擎、自定义导出等高级、核心能力。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
