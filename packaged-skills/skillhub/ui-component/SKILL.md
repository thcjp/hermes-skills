...
license: "MIT"
description: |-
  UI组件HTML/CSS代码生成。表单、表格、卡片、模态框、导航栏，输出完整可运行HTML文件。Use when 需要代码生成、编程辅助、调试测试、开发部署时使用。不适用于无明确技术栈的模糊需求。不适用于无明确技术栈的模糊需求.
tags:
  - Development
  - UI设计
  - 前端
...
tools:
  ...
  - write
homepage: ""
category: "Creative"---# Ui Component
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | ui-component处理的内容输入 |,  |
| content | string | 否 | ui-component处理的内容输入 |, 可选值: json/text/markdown |
