...
summary_zh: "在自治网络中运行工作节点，通过完成链上任务赚取代币奖励。。jinn-node 是一个面向自治网络的链上工作节点技能。部署后，你的 Agent 将持续接收并完成链上任务， 在 Base 网络上"
license: "MIT"
description: |-
...
- 参考`Launchpad 自治项目交互`的配置文档进行参数调优
### 5. 单任务测试与验证
