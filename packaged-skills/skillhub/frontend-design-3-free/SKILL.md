...
brutalist/raw（粗野主义）。选择一种并极致执行，不要混合多种方向。
...
本skill还覆盖以下能力场景: 基础版前端设计技、创建独特界面并避、frontend、design、free、是前端设计技能的、基础版本、创建独特的生产级、slop、和基础字体、动效能力、种高级美学方向、库集成和背景视觉、适合快速创建独特、升级完整版获取全、种美学方向和高级、视觉技巧。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
