...
本skill还覆盖以下能力场景: WhatsApp、Business、API、发送消息、管理模板、处理媒体、支持文本、模板等消息类型、自动化、消息工作流、模板等多种消息类、托管的连接流程与、凭据管理、无需自行配置、涵盖电话号码查询、媒体上传下载、模板创建与审批状、业务资料读取等完、整能力、适用于订单通知、客户支持、预约提醒、营销活动等需要触、用户的业务场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
