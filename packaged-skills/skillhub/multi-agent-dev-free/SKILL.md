...
本skill还覆盖以下能力场景: 基础版子代理编排、开发框架、多代理开发基础版、通过子代理编排执、行实现计划、为每个任务派发新、鲜子代理避免上下、并在每步后进行两、提供智能任务分解、基础两阶段评审三、大核心能力、适用于有明确实现、计划的多任务开发、代码生成与调试等、Agent、平台支持子代理派、发能力。这些能力在上述核心功能中均有对应处理逻辑。
### 输出格式
