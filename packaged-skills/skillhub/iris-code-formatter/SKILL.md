...
**输出**: 返回变量命名规范的执行结果,包含操作状态和输出数据。- 验证执行结果，确认输出符合预期格式
...
**输出**: 返回方法命名规范的执行结果,包含操作状态和输出数据。- 验证执行结果，确认输出符合预期格式
...
**输出**: 返回格式规范的执行结果,包含操作状态和输出数据。- 验证执行结果，确认输出符合预期格式
- 参考`格式规范`相关配置参数进行设置
### 6.1 基本格式
* 方法大括号一律换行显示
* 运算符（`=`、`+`、`-`、`*`、`/`、`_`、`:`）左右加空格
...
**输出**: 返回注释规范的执行结果,包含操作状态和输出数据。- 验证执行结果，确认输出符合预期格式
- 参考`注释规范`相关配置参数进行设置
### 8.1 注释格式
* 单行注释用`#;`，句尾注释用`//`
* 类、方法头注释用`///`
