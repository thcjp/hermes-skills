...
summary_zh: "经连为SkillHub节点的VS Code与Cursor操作代码,40+命令。Operate on code through a VS Code/Cursor IDE connected a"
license: "MIT"
description: |-
...
| 经连为SkillHu | 目标数据与配置参数 | 处理结果与执行状态 |
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | vscode-node处理的内容输入 |,  |
...
中间产物模板参考: `assets/vscode-node_template`
