...
- 执行`基础组件生成`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`基础组件生成`相关配置参数进行设置
### 设计系统令牌
...
- 执行`设计系统令牌`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`设计系统令牌`相关配置参数进行设置
### 批量组件生成
...
本skill还覆盖以下能力场景: 面向团队的企业级、组件工程平台、含设计系统、批量生成、可访问性增强与组、件库管理、组件生成工具专业、版为团队与企业提、供端到端、组件工程能力、涵盖设计系统令牌、可访问性增强与企、业级组件库管理、核心能力、生成与管理、批量组件生成与脚、可访问性审查与增、企业级组件库结构、与文档生成、主题切换与暗色模、式工程化。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
- `--color-danger-500`: 命令参数,用于指定操作选项
- `--color-neutral-0`: 命令参数,用于指定操作选项
- `--spacing-6`: 命令参数,用于指定操作选项
- `--shadow-sm`: 命令参数,用于指定操作选项
- `--radius-md`: 命令参数,用于指定操作选项

### 命令参数说明

- `--font-size-xl`: 命令参数,用于指定操作选项
- `--shadow-md`: 命令参数,用于指定操作选项
- `--spacing-1`: 命令参数,用于指定操作选项
- `--color-neutral-100`: 命令参数,用于指定操作选项
- `--font-size-sm`: 命令参数,用于指定操作选项
...
- `--radius-md`: 命令参数,用于指定操作选项
- `--color-danger-500`: 命令参数,用于指定操作选项
- `--color-primary-700`: 命令参数,用于指定操作选项
- `--color-neutral-100`: 命令参数,用于指定操作选项

### 命令参数说明

- `-euo`: 命令参数,用于指定操作选项
- `-apple-system`: 命令参数,用于指定操作选项
- `--font-weight-bold`: 命令参数,用于指定操作选项
- `--font-size-2xl`: 命令参数,用于指定操作选项
- `--color-primary-500`: 命令参数,用于指定操作选项

### 命令参数说明

- `--shadow-sm`: 命令参数,用于指定操作选项
- `--spacing-4`: 命令参数,用于指定操作选项
- `--radius-sm`: 命令参数,用于指定操作选项
- `--font-weight-regular`: 命令参数,用于指定操作选项
- `--spacing-3`: 命令参数,用于指定操作选项
...
- `-apple-system`: 命令参数,用于指定操作选项
- `--font-weight-bold`: 命令参数,用于指定操作选项
- `--color-primary-50`: 命令参数,用于指定操作选项

### 命令参数说明

- `--color-neutral-900`: 命令参数,用于指定操作选项
- `--shadow-lg`: 命令参数,用于指定操作选项
- `-color-scheme`: 命令参数,用于指定操作选项
- `--spacing-1`: 命令参数,用于指定操作选项
- `--color-neutral-500`: 命令参数,用于指定操作选项

### 命令参数说明

- `--radius-full`: 命令参数,用于指定操作选项
- `-serif`: 命令参数,用于指定操作选项
- `-library`: 命令参数,用于指定操作选项
- `-color-scheme`: 命令参数,用于指定操作选项
- `--color-success-500`: 命令参数,用于指定操作选项
