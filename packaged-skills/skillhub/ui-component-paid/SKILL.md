...
针对基础组件,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应.
**输入**: 用户提供基础组件生成相关的配置参数、输入数据和处理选项.
**输出**: 返回基础组件生成的处理结果。- 验证返回数据的完整性和格式正确性
- 参考`基础组件生成`的配置文档进行参数调优
### 设计系统令牌

针对设计系统令牌,自动解析输入参数、调度任务队列、格式化输出,返回结构化响应.
**输入**: 用户提供设计系统令牌相关的配置参数、输入数据和处理选项.
**输出**: 返回设计系统令牌的处理结果。- 验证返回数据的完整性和格式正确性
- 参考`设计系统令牌`的配置文档进行参数调优
### 批量组件生成
