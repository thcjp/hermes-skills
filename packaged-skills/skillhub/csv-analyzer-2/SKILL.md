...
description: "自然语言分析CSV/Excel,统计/筛选/异常/图表。Analyze CSV files with simple commands. Get instant statistics, filter data, detect anomalies, and e。适用于多种工作场景,提供专业的能力支持。支持多种输入格式,输出结构化结果,适配独立开发者与小型团队。"
license: "MIT"
tools:
  - read
---
