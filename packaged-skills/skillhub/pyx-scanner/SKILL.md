...
- 执行`能力五：团队协作与审计日志`操作，处理输入数据并返回结果
- 验证执行结果，确认输出符合预期格式
- 参考`能力五：团队协作与审计日志`相关配置参数进行设置
### 能力覆盖范围

本skill还覆盖以下能力场景: 企业级、安全检测方案、支持批量扫描、自定义策略与团队、协作审计、安全扫描专业版是、一套面向安全团队、与企业级场景的、Agent、安全检测解决方案、在免费版基础上扩、展出批量扫描与队、志等能力、核心能力、提供批量扫描任务、变更持续监控与告、组织级安全策略与、白名单管理、漏洞详情分析与修、扫描结果团队协作、与审计存档。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
