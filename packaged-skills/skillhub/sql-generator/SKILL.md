...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| 自然语言转SQL、SQL解释、性能优化、建表语句、测试数据生成、数据库迁移、SQL速查表 | 支持 | 支持 |
| SQL generator from | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | sql-generator处理的内容输入 |,  |
| content | string | 否 | sql-generator处理的内容输入 |, 可选值: json/text/markdown |
