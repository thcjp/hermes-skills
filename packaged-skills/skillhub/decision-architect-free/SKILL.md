...
本skill还覆盖以下能力场景: 基础结构化决策支、持与认知偏差检测、帮助避免拍脑袋决、Agent、的基础结构化决策、支持系统、与认知偏差检测两、大核心能力、按决策类型自动匹、类常见认知偏差并、标注潜在信号、适用于产品、个人日常权衡场景、帮助用户避免拍脑、袋决策与框架错配。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
