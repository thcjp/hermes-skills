...
本skill还覆盖以下能力场景: robust、friendly、method、macOS、screens、via、SkillHub、用户需要、mac、snapshot、相关功能时使用、不适用于超出本技、能能力范围的复杂、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
