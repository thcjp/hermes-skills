...
`stock-filter-skills`按照以下流程处理用户请求:
...
本skill涉及以下领域术语: `并发请求提高效率`, `股票筛选模块`, `使用预设并增加计`, `搜索关键词`, `逗号分隔的文章`, `使用本技能`, `获取热点详情`, `多条件筛选股票`, `股票时使用本工具`, `认证密钥`, `创建因子预设`, `抖音热点模块`, `联系后端管理员申`, `获取因子预设列表`, `获取股票详细指标`
