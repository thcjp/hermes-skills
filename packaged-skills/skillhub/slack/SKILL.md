...
summary_zh: "通过slack工具管理Slack消息:回应、置顶、发送/编辑/删除、成员与表情查询。Slack 消息管理。通过 slack 工具对 Slack 工作区进行消息操作,涵盖五大动作组: reac"
license: "MIT"
description: |-
...
|---|---|---|
| 基础功能 | 支持 | 支持 |
| Slack 消息管理过slack工具管理 | 不支持 | 支持 |
| Slack 消息管理成员与表情查询 | 不支持 | 支持 |
| 多渠道消息批量发送 | 不支持 | 支持 |
| 消息模板与变量注入 | 不支持 | 支持 |
| 送达状态实时回调 | 不支持 | 支持 |
