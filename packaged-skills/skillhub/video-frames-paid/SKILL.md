...
本skill还覆盖以下能力场景: 企业级视频帧提取、与剪辑工具、支持批量处理、区间抓取、分辨率调整、水印添加等高级能、视频帧提取专业版、Use、需要视频处理、音频编辑、媒体转换、配音生成时使用、不适用于版权受保、护的媒体内容处理、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
- `--wm-position`: 命令参数,用于指定操作选项
- `--wm-color`: 命令参数,用于指定操作选项
- `--wm-opacity`: 命令参数,用于指定操作选项

### 命令参数说明

- `--min-interval`: 命令参数,用于指定操作选项
- `-list`: 命令参数,用于指定操作选项
- `--retry-failed`: 命令参数,用于指定操作选项
- `--wm-font-size`: 命令参数,用于指定操作选项
- `--output-dir`: 命令参数,用于指定操作选项

### 命令参数说明

- `-from-url`: 命令参数,用于指定操作选项
- `-footage`: 命令参数,用于指定操作选项
- `-right`: 命令参数,用于指定操作选项
- `--wm-x`: 命令参数,用于指定操作选项
...
- `--wm-y`: 命令参数,用于指定操作选项
- `--text-watermark`: 命令参数,用于指定操作选项
- `--input`: 命令参数,用于指定操作选项
- `--scene-threshold`: 命令参数,用于指定操作选项
