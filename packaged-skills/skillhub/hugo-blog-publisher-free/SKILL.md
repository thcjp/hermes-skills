...
description: |-
  ...
  执行Git推送并返回部署链接。适用于独立开发者、企业团队和自动化工作流场景。
tools:
  - read
  - exec
...
本skill还覆盖以下能力场景: Markdown、文章发布到静态站、点生成器博客并推、送到代码仓库、免费版、自动分析内容提取、创建标签分类映射、添加截断标记、推送并返回部署链、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
