...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| Build custom dashboards from any data source with local hosting and | 支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| content | string | 否 | dashboard处理的内容输入 |, 可选值: json/text/markdown |
