...
| 源能力点 | 支持状态 | 实现方式 |
|:---------|:---------|:---------|
| Explorers | 支持 | 通过核心功能实现对应能力 |
| Socialscan | 支持 | 通过核心功能实现对应能力 |
| Explorer | 支持 | 通过核心功能实现对应能力 |
| MonadVision | 支持 | 通过核心功能实现对应能力 |
| Network | 支持 | 通过核心功能实现对应能力 |
| Mainnet | 支持 | 通过核心功能实现对应能力 |
| Monadscan | 支持 | 通过核心功能实现对应能力 |
| Networks | 支持 | 通过核心功能实现对应能力 |
...
本skill涉及以下领域术语: `faucet`, `funding`, `requires`, `docs`, `defaults`, `hardhat`, `technical`, `interact`, `deployment`, `viem/chains`, `correct`, `inform`, `return`, `important`, `verification`
...
- `--no-commit`: 命令参数,用于指定操作选项
- `--private-key`: 命令参数,用于指定操作选项
- `-std`: 命令参数,用于指定操作选项
- `--broadcast`: 命令参数,用于指定操作选项
- `--rpc-url`: 命令参数,用于指定操作选项
...
- `-H`: 命令参数,用于指定操作选项
- `-X`: 命令参数,用于指定操作选项
- `-encode`: 命令参数,用于指定操作选项
- `--show-standard-json-input`: 命令参数,用于指定操作选项

### 命令参数说明

- `-X`: 命令参数,用于指定操作选项
- `-Type`: 命令参数,用于指定操作选项
- `-License-Identifier`: 命令参数,用于指定操作选项
- `-H`: 命令参数,用于指定操作选项
