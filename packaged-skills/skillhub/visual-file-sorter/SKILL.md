...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| 自动遍历下载文件夹或桌面，利用视觉模型“看”文件内容并重命名，最后归档到指定分类目录 | 支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | visual-file-sorter处理的内容输入 |,  |
| content | string | 否 | visual-file-sorter处理的内容输入 |, 可选值: json/text/markdown |
