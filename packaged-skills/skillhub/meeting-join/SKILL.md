...
summary_zh: "企业级AI会议机器人,支持可视化头像、屏幕共享、实时协作、批量会议与团队管理,适合企业与团队场景。。AI会议助手专业版为企业与团队提供全方位的智能会议机器人解决方案。在免费版语音会议能力之上"
license: "MIT"
edition: "pro"
description: |-
...
A: 协作式语音策略在会议中作为辅助角色参与，通过文字消息提供建议和提醒，不直接控制会议流程；直接策略则允许 Agent 主动发起语音发言、控制议程节奏与调度发言顺序。协作式适合需要人工主导的正式会议，直接策略适合自动化程度高的例行会议.
### Q4: 批量会议的并发能力如何?
