...
1. `-blue-500`: 命令参数,用于指定操作选项
2. `-sr-only`: 命令参数,用于指定操作选项
3. `-not-allowed`: 命令参数,用于指定操作选项
4. `-webkit-scrollbar`: 命令参数,用于指定操作选项
5. `-primary`: 命令参数,用于指定操作选项
...
- `-wrap`: 命令参数,用于指定操作选项
- `-balance`: 命令参数,用于指定操作选项
- `-design-system`: 命令参数,用于指定操作选项

### 命令参数说明

- `-hide`: 命令参数,用于指定操作选项
- `-green-500`: 命令参数,用于指定操作选项
- `-ms-overflow-style`: 命令参数,用于指定操作选项
- `-serif`: 命令参数,用于指定操作选项
- `--brand-50`: 命令参数,用于指定操作选项

### 命令参数说明

- `-none`: 命令参数,用于指定操作选项
- `-purple`: 命令参数,用于指定操作选项
- `-items`: 命令参数,用于指定操作选项
- `-y-2`: 命令参数,用于指定操作选项
- `-D`: 命令参数,用于指定操作选项
...
- `-reduce`: 命令参数,用于指定操作选项
- `-red-500`: 命令参数,用于指定操作选项
- `-secondary`: 命令参数,用于指定操作选项
- `-out`: 命令参数,用于指定操作选项
- `-flex`: 命令参数,用于指定操作选项
...
- `-D`: 命令参数,用于指定操作选项
- `--brand-100`: 命令参数,用于指定操作选项
- `-fade-in`: 命令参数,用于指定操作选项
- `-color`: 命令参数,用于指定操作选项
- `-lh`: 命令参数,用于指定操作选项
...
- `-width`: 命令参数,用于指定操作选项
- `--brand-700`: 命令参数,用于指定操作选项
- `-radius`: 命令参数,用于指定操作选项
- `--brand-600`: 命令参数,用于指定操作选项
- `--brand-500`: 命令参数,用于指定操作选项

### 命令参数说明

- `-shadow`: 命令参数,用于指定操作选项
- `-offset-2`: 命令参数,用于指定操作选项
- `-D`: 命令参数,用于指定操作选项
- `-visible`: 命令参数,用于指定操作选项
