...
本skill还覆盖以下能力场景: 通讯应用消息发送、群组管理和多、Agent、讨论工具、免费版、支持文本、贴纸等多种消息类、支持投票、群组创建、历史搜索和多、协作讨论、通过协议库桥接通、讯应用、提供完整的消息交、互能力、适用于独立、开发者、企业团队和自动化、工作流场景、不适用于无通讯应、用账号的场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
