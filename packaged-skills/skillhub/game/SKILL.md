...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| The instant game design engine for AI agents | 支持 | 支持 |
| Describe any game concept | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |

## 核心能力

- The instant game design engine for AI agents
- Describe any game concept
  in one sentence and get a
#
## 适用场景
