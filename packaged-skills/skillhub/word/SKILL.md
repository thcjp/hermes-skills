...
| Memory template | 支持 | 通过核心功能实现对应能力 |
...
### 领域术语
本skill涉及以下领域术语: `bypass`, `docx`, `live-control-patterns.md`, `oauth`, `osascript`, `ignoring`, `treating`, `execution-matrix.md`, `reusable`, `memory-template.md`, `environment`, `setup.md`, `broader`, `confirm`, `microsoft`
