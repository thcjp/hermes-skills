...
本skill还覆盖以下能力场景: 企业级视频上传与、流媒体管理平台、支持自定义编码、批量上传、缩略图管理与转码、视频上传专业版、Use、需要视频处理、音频编辑、媒体转换、配音生成时使用、不适用于版权受保、护的媒体内容处理、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
