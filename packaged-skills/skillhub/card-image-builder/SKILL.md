...
本skill还覆盖以下能力场景: 企业级卡片图生成、支持全模板、卡片图生成器专业、面向企业和专业内、容团队的全功能卡、片图片生成平台、核心能力、全模板支持、长文卡片、风格长图、公众号封面、批量生成与目录递、归处理、自定义模板创建与、水印与版权信息嵌、模板版本管理与团、队共享。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
