...
| 源能力点 | 支持状态 | 实现方式 |
|:---------|:---------|:---------|
| What to detect / extract | 支持 | 通过核心功能实现对应能力 |
| What URL(s) to target | 支持 | 通过核心功能实现对应能力 |
...
本skill涉及以下领域术语: `before`, `chrome`, `list`, `resolve`, `wait`, `post`, `imports`, `similarly`, `cloudflare`, `free`, `verify`, `after`, `find`, `otherwise`, `return`
