...
description: "用Piper本地文字转语音发语音消息。Local text-to-speech using Piper for voice message delivery。Use when。触发关键词: using, local, speech, text, piper, tts, beware。提供专业能力支持,覆盖多场景工作流,支持自动化处理。"
license: "MIT"
tools:
  - read
---
