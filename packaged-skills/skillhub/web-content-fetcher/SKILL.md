...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| 网页内容获取工具 | 当常规爬虫被过滤时，使用替代服务获取网页内容 | 支持 | 支持 |
| ai - 最稳定 2) markdown | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | web-content-fetcher处理的内容输入 |,  |
| content | string | 否 | web-content-fetcher处理的内容输入 |, 可选值: json/text/markdown |
