...
本skill还覆盖以下能力场景: 消息排版基础指南、涵盖核心语法规则、禁用范式与基础通、免费版、原生排版语法的核、心规则说明、常见禁用范式与替、以及通知类基础消、覆盖三大基础能力、列表的写法与效果、双星号的替代方案、订单确认与物流更、适用于个人开发者、通知消息、日常消息排版优化、等基础场景、如需完整模板库、风格规范、差异对照、内容类型排版建议、等高级能力、请升级至、styling、guide、付费版。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
