...
本skill还覆盖以下能力场景: 邮件发送自动化、支持多供应商、模板与、协议的邮件发送自、Skill、邮箱等主流服务商、提供纯文本与、双模式、多附件并行上传、测试邮件校验、加密传输与企业级、凭据管理、适用于发信通知、报表投递、告警推送、营销触达等需要程、序化邮件输出的自、动化场景。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
