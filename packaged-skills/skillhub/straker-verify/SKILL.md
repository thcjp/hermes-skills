...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| Straker Verify 核心处理 - 基于行业标准审查 | 支持 | 支持 |
| Straker Verify 智能分析 - 输出审查报告评级报告 | 不支持 | 支持 |
| Straker Verify 批量处理 - 提供可操作改进建议 | 不支持 | 支持 |
| Straker Verify 自定义配置 - 支持全维度全维度评估 | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |

## 核心能力

- Straker Verify 结果导出 - 基于行业标准审查
- Straker Verify 实时监控 - 输出审查报告评级报告
- Straker Verify 错误重试 - 提供可操作改进建议
- Straker Verify 多格式支持 - 支持全维度全维度评估
#
## 适用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | straker-verify处理的内容输入 |, 默认: 全部维度 |
