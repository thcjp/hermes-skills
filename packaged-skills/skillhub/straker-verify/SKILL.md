...
本skill还覆盖以下能力场景: Professional、powered、translation、optional、human、verification、Supports、languages、Use、需要文本翻译、多语言转换、本地化处理时使用、不适用于专业医学、法律翻译认证、适用于独立开发者、企业团队和自动化、工作流场景。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
