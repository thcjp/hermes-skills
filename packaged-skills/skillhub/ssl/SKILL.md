...
### 领域术语
本skill涉及以下领域术语: `triggers`, `err_cert_authority_invalid`, `sslcertificatekeyfile`, `oauth`, `sslcertificatechainfile`, `types`, `doesn`, `sslcertificatefile`, `urls`, `nginx`, `activate`, `encrypt`, `errors`, `cover`, `apache`
