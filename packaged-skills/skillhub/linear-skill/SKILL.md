...
| 源能力点 | 支持状态 | 实现方式 |
|:---------|:---------|:---------|
| Mention IDs, states, assignees, blockers, and follow-up actions. | 支持 | 通过核心功能实现对应能力 |
...
本skill涉及以下领域术语: `user`, `workflows`, `safety`, `list`, `sprint`, `labels`, `prerequisites`, `scope`, `model`, `summarize`, `createproject`, `runtime`, `release`, `createcomment`, `references/api.md`
