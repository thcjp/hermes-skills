...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| This skill is a disclosed social-listening workflow that uses Xpoz and | 支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | social-sentiment处理的内容输入 |,  |
...
中间产物模板参考: `assets/social-sentiment_template`
