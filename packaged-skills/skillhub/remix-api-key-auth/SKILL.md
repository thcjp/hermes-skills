...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| Configure and verify bearer API key authentication for Remix agent publishing | 支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | remix-api-key-auth处理的内容输入 |,  |
...
```json
{
  ...
  "data": {
    "final_result": {
      "auth_result": "auth_result_value",
      "auth_metadata": "auth_metadata_value",
...
中间产物模板参考: `assets/remix-api-key-auth_template`
