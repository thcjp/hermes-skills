...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| A comprehensive generation skill | 支持 | 支持 |
| Can generate images, videos, and audio\ | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | dlazy-generate处理的内容输入 |,  |
| content | string | 否 | dlazy-generate处理的内容输入 |, 可选值: json/text/markdown |
