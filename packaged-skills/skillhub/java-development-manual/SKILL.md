...
执行【强制】,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供【强制】相关的配置参数、输入数据和处理选项。

**输出**: 返回【强制】的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`【强制】`相关配置参数进行设置
### 【推荐】

执行【推荐】,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供【推荐】相关的配置参数、输入数据和处理选项。

**输出**: 返回【推荐】的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`【推荐】`相关配置参数进行设置
### 【参考】

执行【参考】,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供【参考】相关的配置参数、输入数据和处理选项。

**输出**: 返回【参考】的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`【参考】`相关配置参数进行设置
#
## 适用场景
