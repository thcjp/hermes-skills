...
本skill还覆盖以下能力场景: porteden、CLI、读取与搜索、Gmail、Outlook、邮件的基础版、email、邮箱邮件、支持日期范围筛选、输出降低、适用于个人用户邮、件快速查阅与基础、搜索场景。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
