...
执行邮件列表,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供邮件列表相关的配置参数、输入数据和处理选项。

**输出**: 返回邮件列表的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`邮件列表`相关配置参数进行设置
### 基础筛选

执行基础筛选,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供基础筛选相关的配置参数、输入数据和处理选项。

**输出**: 返回基础筛选的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`基础筛选`相关配置参数进行设置
### 关键词搜索

执行关键词搜索,自动处理参数解析、任务调度和结果格式化,返回结构化输出。

**输入**: 用户提供关键词搜索相关的配置参数、输入数据和处理选项。

**输出**: 返回关键词搜索的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`关键词搜索`相关配置参数进行设置
#
## 使用流程
