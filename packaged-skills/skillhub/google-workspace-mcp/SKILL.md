...
本skill还覆盖以下能力场景: Cloud、Console、OAuth、登录即用、项工具、覆盖邮件、表格与联系人管理、presto、登录方式访问、全家桶、建项目、API、client、secret、json、等繁琐步骤、邮件搜索收发、日程管理与空闲时、段查找、文件检索下载、文档增改查、空间消息、个人资料及、时区查询共、适用于独立开发者、日常办公自动化、企业团队协同排程、以及跨、服务的自动化工作、流编排。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
