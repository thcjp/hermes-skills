...
`zhuchenggong-doubao-image-gen`按照以下流程处理用户请求:
...
本skill还覆盖以下能力场景: 图片生成技能、视觉设计师专用、创意设计领域的专、辅助工具、基于高人气开源、Skill、深度优化升级、移除风险代码、增强安全性和稳定、适用场景、内容创作、设计生成、多媒体制作、独立开发者与一人、公司效率提升、自动化工作流与智、能决策辅助。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
