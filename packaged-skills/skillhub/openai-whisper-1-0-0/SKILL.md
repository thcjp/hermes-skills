...
summary: "用Whisper CLI本地语音转文字,免API Key(付费增强版)"
license: "Proprietary"
description: |-
...
| 能力 | 免费版 | 付费版 |
|:-----|:-------|:-------|
| Local speech-to-text with the Whisper CLI (no API key) | 支持 | 支持 |
| 0, local, speech, text, whisper, llm-provider | 不支持 | 支持 |
| 批量处理 | 不支持 | 支持 |
| 高级配置 | 不支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| content | string | 否 | openai-whisper-1-0-0处理的内容输入 |,  |
| content | string | 否 | openai-whisper-1-0-0处理的内容输入 |, 可选值: json/text/markdown |
...
### Q3: llm-provider Whisper 1.0.0有什么限制？
A: 
