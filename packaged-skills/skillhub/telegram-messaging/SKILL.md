...
本skill还覆盖以下能力场景: Telegram、Bot、API、管理聊天、处理文件与自动化、机器人工作流、Skill、支持发送文本、投票等多类型消息、管理聊天信息与成、检索聊天历史、转发与编辑消息、生成与撤销邀请链、处理内联键盘回调、设置机器人命令列、所有写操作需用户、读操作可直接调用、覆盖部署通知推送、群组投票反馈、历史检索转发、社区邀请链接生命、周期管理等场景。这些能力在上述核心功能中均有对应处理逻辑。
## 工具列表
