...
本skill还覆盖以下能力场景: 自动化配方库、企业模板、调试工具包、支撑从个人到企业、的全场景自动化、自动化配方手册专、业版是面向从个人、到企业的全场景自、动化配方系统、在免费版、个配方基础上扩展、新增配方生成器框、条件分支、并行执行、错误处理、版本管理与回滚七、大高级能力、Use、需要提升效率、自动化流程、批量处理、工作流优化时使用、不适用于需要人工、创意判断的任务。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
...
1. `-report配方`: 命令参数,用于指定操作选项
2. `-news`: 命令参数,用于指定操作选项
3. `-flow配方`: 命令参数,用于指定操作选项
4. `-reminder配方`: 命令参数,用于指定操作选项
5. `-news-monitor`: 命令参数,用于指定操作选项
...
- `--v2`: 命令参数,用于指定操作选项
- `--v1`: 命令参数,用于指定操作选项
- `-schedule配方`: 命令参数,用于指定操作选项
- `-check配方`: 命令参数,用于指定操作选项

### 命令参数说明

- `-publish配方`: 命令参数,用于指定操作选项
- `-urgent-reminder`: 命令参数,用于指定操作选项
- `--mock-input`: 命令参数,用于指定操作选项
- `--period`: 命令参数,用于指定操作选项
- `-notes配方`: 命令参数,用于指定操作选项

### 命令参数说明

- `-monitor配方`: 命令参数,用于指定操作选项
- `-optimize配方`: 命令参数,用于指定操作选项
- `-generate配方`: 命令参数,用于指定操作选项
- `--file`: 命令参数,用于指定操作选项
- `--last-run`: 命令参数,用于指定操作选项
