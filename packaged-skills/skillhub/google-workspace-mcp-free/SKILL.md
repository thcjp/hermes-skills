...
本skill还覆盖以下能力场景: Cloud、Console、OAuth、登录即用、的基础读取能力、覆盖邮件检索、日程查看、文件下载与文档表、格读取、presto、登录方式访问、建项目、API、client、secret、json、等繁琐步骤、免费版提供、邮件搜索与读取、文件检索与下载、文档检索与文本提、表格区域读取等基、础能力、适合个人开发者体、自动化办公、会议创建、Chat、Slides、等高级能力见付费。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
