...
本skill还覆盖以下能力场景: 五步法、融合心理学原理、打磨高情商沟通回、复与冲突调解方案、Communication、Crafter、Pro、是面向复杂人际沟、通场景的专业级消、息打磨工具、融合心理学原理与、结构化表达框架、帮助用户在高压对、冲突调解、跨文化沟通、敏感反馈等场景中、产出高情商、高说服力的回复、核心能力、五大沟通原则与心、理动力学分析、识别防御机制与情、绪触发点、针对不同关系亲疏、与权力位差精准定、确保回复在共情、行动力等维度达标。这些能力在上述核心功能中均有对应处理逻辑。
## 适用场景
