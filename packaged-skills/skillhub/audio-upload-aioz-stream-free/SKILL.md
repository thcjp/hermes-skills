...
本skill还覆盖以下能力场景: AIOZ、以默认配置上传音、频文件、适合快速发布、的音频上传技能免、通过三步流程、将本地音频文件上、流媒体平台、支持默认快速上传、使用默认编码配置、上传完成后返回、适用于播客发布、语音内容托管等基、础场景、本免费版仅支持默。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
