...
- `--source-address-prefixes`: 命令参数,用于指定操作选项
- `--nsg-name`: 命令参数,用于指定操作选项

### 命令参数说明

- `-ssh`: 命令参数,用于指定操作选项
- `-automation-sp`: 命令参数,用于指定操作选项
- `--destination-port-ranges`: 命令参数,用于指定操作选项
- `--parameters`: 命令参数,用于指定操作选项
- `--ids`: 命令参数,用于指定操作选项
