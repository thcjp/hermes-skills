...
本skill还覆盖以下能力场景: Convert、JSON、input、into、YAML、format、Expanso、Edge、pipelines、CLI、MCP、server、integration、核心能力。这些能力在上述核心功能中均有对应处理逻辑。
## 使用流程
