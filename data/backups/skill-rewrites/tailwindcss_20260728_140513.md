...
| 写Tailwind工 | 目标数据与配置参数 | 处理结果与执行状态 |
| 暗色模式 | 目标数据与配置参数 | 处理结果与执行状态 |
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | tailwindcss处理的内容输入 |,  |
| content | string | 否 | tailwindcss处理的内容输入 |, 可选值: json/text/markdown |
