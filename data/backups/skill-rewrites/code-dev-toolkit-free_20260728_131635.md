...
summary: "规划、实现、验证、测试的完整编码工作流,支持个人偏好记忆与步骤化开发。面向个人开发者的代码开发工作流工具,提供规划、执行、验证、测试的完整开发流程。核心能力:"
license: MIT
edition: free
description: "面向个人开发者的代码开发工作流工具,包含规划、执行、验证、测试的完整开发流程。核心能力:. 适用于需要code dev toolkit相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 开发工具
  - 编码工作流
  - 开发流程
...
| 参数名 | 类型 | 必填 | 说明 |
|---|---|---|---|
| input | string | 是 | 代码开发工具包免费版处理的输入数据或指令 |
...
**处理**: 解析五步开发工作流的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回五步开发工作流的响应数据,包含状态码、结果和日志.
### 2. 用户偏好记忆
...
**处理**: 解析用户偏好记忆的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回用户偏好记忆的响应数据,包含状态码、结果和日志.
### 3. 步骤化任务拆分
...
**处理**: 解析步骤化任务拆分的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回步骤化任务拆分的响应数据,包含状态码、结果和日志.
...
**处理**: 解析验证检查清单的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回验证检查清单的响应数据,包含状态码、结果和日志.
...
```json
{
  "success": true,
  "data": {
    "result": "代码开发工具包免费版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "code devkit"
    }
  },
