...
version: "1.2.10"
displayName: 命理大师
summary: 全体系命理大师—八字四柱、紫微斗数、奇门遁甲、六爻、梅花易数、塔罗、星盘，为您提供专业的命理分析和服务。
license: MIT
description: |
  命理大师是一款综合性的命理分析工具，涵盖了八字四柱、紫微斗数、奇门遁甲、六爻、梅花易数、塔罗、星盘等多个命理体系。它基于深度优化的开源Skill，移除了风险代码，增强了安全性和稳定性。
