...
summary_zh: "微云网盘全功能版：12 类操作、分类查询、分享外链、批量删除、移动重命名与版本管理。。微云工具箱（专业版）面向团队与企业用户，提供微云网盘的全部 12 类 MCP工具能力：目录浏览、分类查询"
license: "MIT"
edition: "pro"
description: |-
...
|---|---|---|
| 基础功能 | 支持 | 支持 |
| 微云工具箱(专业版)分类查询 | 不支持 | 支持 |
| 微云工具箱(专业版)移动重命名与版本管理 | 不支持 | 支持 |
| 复杂工作流可视化编排 | 不支持 | 支持 |
| 条件分支与异常重试 | 不支持 | 支持 |
| 定时触发与事件驱动 | 不支持 | 支持 |
