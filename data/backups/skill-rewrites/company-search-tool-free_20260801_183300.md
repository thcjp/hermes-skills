...
license: MIT
edition: free
description: "企业查询助手免费版是面向个人用户的轻量企业信息查询工具。通过内置公用API Key开箱即用，兼容查公司基本信息、法人、股东、对外投资、工商变更等核心维度。Use. 面向需要company search tool相关能力的开发场景,包含结构化的工作流程和可复用的模板,帮助用户快速完成任务并保持代码质量."
tags:
  - 企业查询
  - company
  - search
...
**处理**: 解析企业模糊搜索的输入参数,完成核心逻辑,生成结构化输出.
**输出**: 返回企业模糊搜索的响应数据,包含返回码、数据和处理记录.
### 2. 企业基本信息查询

**处理**: 解析企业基本信息查询的输入参数,完成核心逻辑,生成结构化输出.
**输出**: 返回企业基本信息查询的响应数据,包含返回码、数据和处理记录.
### 3. 结果展示
## 输入格式
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
...
**处理**: 解析结果展示的输入参数,完成核心逻辑,生成结构化输出.
**输出**: 返回结果展示的响应数据,包含返回码、数据和处理记录.
**能力覆盖范围**：本技能覆盖以下场景关键词：企业查询免费版、支持公司基本信息、对外投资、工商变更查询、企业查询助手免费、版是面向个人用户、的轻量企业信息查、询工具、通过内置公用、Key、开箱即用、支持查公司基本信、工商变更等核心维、Use、when、SEO、关键词分析、排名提升、搜索流量优化时使、不适用于黑帽、适用于独立开发者、企业团队和自动化、工作流场景等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
...
| 对比维度 | 企业查询助手(免费版) | 传统手动方式 | 通用脚本工具 |
|---------|------------|-------------|------------|
| 自动化程度 | 全流程自动 | 完全手动 | 部分自动 |
| 错误处理 | 内置错误恢复 | 依赖人工经验 | 基本try-catch |
| 可复用性 | 参数化配置 | 一次性脚本 | 模板化 |
| 安全合规 | 内置安全检查 | 无安全保障 | 无安全保障 |
| 适用场景 | 企业查询免费版，支持公司基本信息、股东、法人、对外投资、工商变更查询.。企业查询 | 通用场景 | 通用场景 |

## 核心功能

- **自动化执行**: 企业查询免费版，支持公司基本信息、股东、法人、对外投资、工商变更查询.。企业查询助手免费版是面向个人用户的轻量企业信息查
