...
license: MIT
edition: free
description: "Go安全漏洞扫描免费版,为个人Go开发者包含依赖漏洞查验与修正指导能力. 适用于需要go security vuln tool相关能力的开发场景,包含结构化的工作流程和可复用的模板,帮助用户快速完成任务并保持代码质量. 适用于需要go security vuln tool相关能力的开发场景,包含结构化的工作流程和配置指引."
tags:
  - 安全
  - security
  - vuln
