...
summary_zh: "经gitmcp.io读GitHub仓库(权限较广需谨慎)。This skill is mostly transparent about reading GitHub through gitm"
license: "MIT"
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| content | string | 否 | repo-reader-tool处理的内容输入 |,  |
...
中间产物模板参考: `assets/repo-reader-tool_template`
