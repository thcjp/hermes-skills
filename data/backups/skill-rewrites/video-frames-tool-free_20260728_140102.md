...
license: MIT
edition: free
description: "视频帧提取免费版，专注于为个人用户包含简洁视频帧抓取能力。核心能力:. 适用于需要video frames tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - Creative
  - 视频处理
  - 帧提取
...
video_frames_free:
  ...
  default_quality: 2           # JPEG 质量（2=优秀）
  supported_inputs:
    - mp4
    - mov
    - avi
