...
version: "1.0.0"
displayName: "AnthroVision Telegram Body Scan Free"
summary: "Automate body scanning and measurement using Telegram."
summary_zh: "使用Telegram自动化身体扫描和测量。"
license: "MIT"
description: |-
  The AnthroVision Telegram Body Scan Free is a user-friendly tool designed to streamline body scanning and measurement processes through Telegram. It allows users to submit videos for analysis and receive basic measurement results. This tool is ideal for individuals seeking basic body measurements for fitness tracking or body size assessment.
...
2. **Clothing Matching**: Users can choose appropriate clothing based on their body size by using AnthroVision Telegram Body Scan Free, improving the shopping experience.
...
1. **Keep Original Frontmatter** - Do not modify the YAML frontmatter part
2. **Keep Core Function Descriptions** - Do not lose the core information of the original content
3. **Enhance All Dimensions**:
   - Function completeness: Ensure that function descriptions are detailed, input/output formats are clear, and boundary conditions are covered
   ...
   - Innovation: There are differentiation advantages compared to similar solutions, and unique value is highlighted
4. **Content Must Be Strongly Related to AnthroVision Telegram Body Scan Free Domain** - Do not write generic templated content
