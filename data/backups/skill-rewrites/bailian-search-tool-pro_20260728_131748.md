...
license: Proprietary
edition: pro
description: "企业级 AI 调优网页搜索工具,在免费版核心能力之上,包含成批查询、结果缓存、. 适用于需要bailian search tool相关能力的开发场景,提供结构化的工作流程和配置指引. 该工具经过深度差异化处理,针对用户反馈和使用痛点进行了优化改进,提升了实用性和可操作性."
tags:
  - 研究工具
  - 网页搜索
  - 企业级
...
RESEARCH_TOPICS = [
    ...
    {"query": "RAG技术优秀实践", "depth": 15, "purpose": "方案设计"},
