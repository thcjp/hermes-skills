...
license: "MIT"
description: "Send formatted trading alerts, portfolio updates, and market signals via Telegram。Supports price，可处理提升工作效率。Use when 用户需要Telegram工具相关功能时使用。不适用于超出本技能能力范围的复杂需求。"
tags:
  - Finance
  - Automation
  - Telegram
...
| 场景 | 输入 | 输出 |
|:-----|:-----|:-----|
| 经Telegram发 | 目标数据与配置参数 | 处理结果与执行状态 |
| 组合更新 | 目标数据与配置参数 | 处理结果与执行状态 |
| 市场信号 | 目标数据与配置参数 | 处理结果与执行状态 |
