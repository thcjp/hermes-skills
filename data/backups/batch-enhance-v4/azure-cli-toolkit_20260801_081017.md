...
echo "$AZURE_ACCESS_TOKEN" | az login --service-principal \
  -u $AZURE_CLIENT_ID --password-stdin --workspace $AZURE_TENANT_ID
```
...
#   "workspace": "详情见说明xx-详情见说明x-详情见说明x"
# }
# ...
# 配置环境变量
...
export AZURE_TENANT_ID="your-workspace-id"
