...
version: 1.0.1
displayName: 文档处理大师
summary: "Word文档全流程处理,从创建到修订到邮件合并,正式文档一站搞定。文档处理大师——全面处理Word文档,从创建到编辑,从修订到邮件合并,覆盖正式文档全生命周期。合同/报告/方案/手册/论文,"
summary_zh: "Word文档全流程处理,从创建到修订到邮件合并,正式文档一站搞定。文档处理大师——全面处理Word文档,从创建到编辑,从修订到邮件合并,覆盖正式文档全生命周期。合同/报告/方案/手册/论文,"
license: MIT
