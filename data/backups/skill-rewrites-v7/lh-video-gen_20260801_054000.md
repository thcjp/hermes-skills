...
license: "MIT"
description: |-
  Generate vertical short videos (9:16) from a Markdown script。Parses script sections, generates T。Use when 用户需要lh-video-gen相关功能时使用。不适用于超出本技能能力范围的复杂需求。适用于独立开发者、企业团队和自动化工作流场景。
tags:
  - Creative
  - 视频处理
  - 媒体
