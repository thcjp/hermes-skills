...
version: 1.0.1
displayName: "卖货文案手"
summary: "文案干瘪没转化?FAB卖点+6种情绪钩子+4种CTA,快速生成高转化卖货文案。卖货文案手是一款高转化卖货文案生成工具,解决文案干瘪无转化痛点. 基于FAB法则提炼卖点,结合6种情绪钩子与4种"
summary_zh: "文案干瘪没转化?FAB卖点+6种情绪钩子+4种CTA,快速生成高转化卖货文案。卖货文案手是一款高转化卖货文案生成工具,解决文案干瘪无转化痛点. 基于FAB法则提炼卖点,结合6种情绪钩子与4种"
license: "MIT"
description: |-
  ...
  - 6种情绪钩子生成
  - 4种CTA话术注入
  - 5平台风格自动适配。Use when 需要生成营销文案、写作内容、标题优化、内容创作时使用。不适用于纯技术文档撰写。
homepage: ""
tags:
  - 卖货文案
  - 营销转化
...
### 内容安全
- **广告合规**: 自动过滤虚假宣传/绝对化用语(最/领先/唯一)/医疗承诺
