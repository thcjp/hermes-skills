...
summary_zh: "一人做古诗词内容厂牌,6种融合模式+平仄校验+意境评分,图文短视频双输出。诗词匠心是一款古诗词融合故事编织工具,打造古诗词内容厂牌. 支持6种融合模式、平仄韵律校验、意境评分,图文与短视频双"
license: "MIT"
description: |-
  ...
  - 平仄韵律自动校验
  - 意境融合度评分
  - 图文+短视频双输出。Use when 需要视频处理、音频编辑、媒体转换、配音生成时使用。不适用于版权受保护的媒体内容处理。
homepage: ""
tags:
  - 古诗词
  - 内容创作
