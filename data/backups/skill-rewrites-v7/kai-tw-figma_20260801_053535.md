...
license: "MIT"
description: |-
  Interact with Figma files to read structure, export layers as images, and retrieve comments. 支持Figma文件结构读取、图层导出和评论管理。Use when 需要文件处理、文档转换、格式互转、内容提取时使用。不适用于加密文件破解。
tags:
  - figma
  - 图层导出
  - 评论
