...
license: "MIT"
description: "Python基础版,编写可靠Python代码的基础能力,覆盖可变默认参数陷阱识别、import规范与基础异常处理.核心功能包括检测def foo(items=[])等可变默认参数陷阱并推荐None初始化方案、模块导入顺序规范检查与基础异常捕获规范.适用于Python项目代码审查与质量保障场景,帮助开发者规避常见编码陷阱."
  - 可变默认参数陷阱识别与修复
