...
summary_zh: "AI分析市场数据智能定价,多策略配置+动态调价+利润最大化。电商定价策略师是一款AI驱动的电商定价决策工具. 支持市场数据多维分析、5种定价策略智能推荐、多平台价格监控与利润最大化测算. 核"
license: "MIT"
description: |-
  ...
  - 市场数据多维分析
  - 多平台价格监控
  - 动态调价建议与利润最大化测算。Use when 需要数据分析、报表生成、统计洞察、数据可视化时使用。不适用于实时流数据处理。
homepage: ""
tags:
  - 电商
  - 定价策略
