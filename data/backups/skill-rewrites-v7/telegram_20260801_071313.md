...
license: "MIT"
description: "SkillHub skill for designing Telegram Bot API workflows and command-driven conversations using di，可处理提升工作效率。Use when 需要设计创作、UI设计、海报制作、品牌视觉时使用。不适用于3D建模和动画制作。"
tags:
  - Integrations
  - Telegram
  - 社交
