...
```json
{
  ...
  "data": {
    ...
    "publish_results": [
      {"platform": "kdp", "success": true, "book_url": "https://kdp.amazon.com/book/未指定"},
...
```json
{
  ...
  "data": {
    ...
    "outline_tree": {
      "title": "Python自动化实战",
      "chapters": [
        {"title": "领先章 自动化基础", "sections": ["1.1 为什么要自动化", "1.2 Python自动化工具生态"]},
...
```json
{
  ...
  "data": {
    ...
    "outline_tree": {
      "title": "AI写作指南",
      "chapters": [
        {"chapter_index": 1, "title": "领先章 AI写作基础", "sections": [{"section_index": "1.1", "title": "什么是AI写作"}, {"section_index": "1.2", "title": "AI写作工具对比"}]},
