...
license: "MIT"
description: "神经记忆增强系统基础版,基于扩散激活机制的联想记忆系统,通过神经图谱遍历实现概念关联召回.记忆以神经图谱形式组织,神经元之间通过类型化突触连接,频繁共同访问的记忆自动强化.适用于需要跨会话记忆召回与概念关联检索的Agent场景,替代关键词匹配实现语义级记忆查找,支持时间、实体、概念三类神经元联动检索."
