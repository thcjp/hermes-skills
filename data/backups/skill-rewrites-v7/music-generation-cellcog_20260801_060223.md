...
license: "MIT"
description: |-
  AI music generation powered by CellCog。Original instrumental and vocal tracks, 5 seconds to 10 m。Use when 用户需要music-generation-cellcog相关功能时使用。不适用于超出本技能能力范围的复杂需求。
tags:
  - Creative
  - 音乐生成
  - 音频
