...
license: "MIT"
description: |-
  WeChat Mini Program development skill for building, debugging, previewing, testing, publishing, a。Use when 用户需要miniprogram-development相关功能时使用。不适用于超出本技能能力范围的复杂需求。
tags:
  - api
  - 按流程执
  - 依赖说明
