...
description: "Sonos音箱命令行控制工具,支持播放控制、音量调节与分组管理,适合个人家庭使用"
license: Proprietary
...
**处理**: 按照skill规范执行分组管理操作,遵循单一意图原则。
**输出**: 返回分组管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行播放列表操作,遵循单一意图原则。
**输出**: 返回播放列表的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行状态查询操作,遵循单一意图原则。
**输出**: 返回状态查询的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行定时控制操作,遵循单一意图原则。
**输出**: 返回定时控制的执行结果,包含操作状态和输出数据。
