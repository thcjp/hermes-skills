...
license: Proprietary
edition: pro
description: Word文档工具V1 - （专业版）。可生成提升工作效率
        ...
        for i, spec in enumerate(specs):
            ...
            for section in spec.get("sections", []):
                if section["type"] == "heading":
                    engine.add_heading(section["text"], section.get("level", 1))
                elif section["type"] == "paragraph":
                    engine.add_paragraph(section["text"])
                elif section["type"] == "list":
                    engine.add_list(section["items"], section.get("ordered", False))
                elif section["type"] == "table":
                    engine.add_table(section["data"])
