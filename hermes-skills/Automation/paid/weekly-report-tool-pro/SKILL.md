...
summary: "企业级周报管理系统,支持多源数据采集、团队聚合、模板管理与自动分发。核心能力: 工作汇报领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
...
**处理**: 解析多源数据自动采集的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多源数据自动采集的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队周报聚合与管理者汇总
团队周报聚合与管理者汇总

**处理**: 解析团队周报聚合与管理者汇总的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队周报聚合与管理者汇总的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 项目进度追踪与里程碑状态
项目进度追踪与里程碑状态

**处理**: 解析项目进度追踪与里程碑状态的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回项目进度追踪与里程碑状态的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析周报自动分发的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回周报自动分发的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 周报写作器专业版处理的输入数据或指令 |
...
- **自动化执行**: 企业级周报管理系统,支持多源数据采集、团队聚合、模板管理与自动分发。核心能力: 工作汇报领域的专业化 AI 辅助工具,提
