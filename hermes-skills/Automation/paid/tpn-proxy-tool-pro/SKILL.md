...
summary: "全功能去中心化代理平台，支持多代理并发、自动轮换、熔断与性能监控。面向数据工程团队与安全测试人员的全功能去中心化SOCKS5代理平台，支持多代理并发管理、自动轮换、请求熔断与性能监控。核心能"
license: Proprietary
edition: pro
description: "面向数据工程团队与安全测试人员的全功能去中心化SOCKS5代理平台，支持多代理并发管理、自动轮换、请求熔断与性能监控。核心能力：在免费版基础上新增多代理会话池、自动轮换策略、请求重试与熔断机制、代理性能监控仪表盘、x402按需支付流程与批量请求引擎。Use。Use when 需要数据分析、报表生成、统计洞察、数据可视化时使用。不适用于实时流数据处理。"
  when 需要数据分析、报表生成、统计洞察、数据可视化时使用。不适用于实时流数据处理.
tags: 数据采集,分析,self,proxy_id,proxy,def
tools:
  - read
  - exec
  - write
...
| x402按需支付 | 加密支付 | 基础功能由Agent平台提供密钥 |
...
专业版支持x402加密支付协议，基础功能由Agent平台提供密钥，适合自治代理使用：
...
| 对比维度 | 代理网络工具专业版 | 传统手动方式 | 通用脚本工具 |
|---------|------------|-------------|------------|
| 自动化程度 | 全流程自动 | 完全手动 | 部分自动 |
| 错误处理 | 内置错误恢复 | 依赖人工经验 | 基本try-catch |
| 可复用性 | 参数化配置 | 一次性脚本 | 模板化 |
| 安全合规 | 内置安全检查 | 无安全保障 | 无安全保障 |
| 适用场景 | 全功能去中心化代理平台，支持多代理并发、自动轮换、熔断与性能监控。面向数据工程团 | 通用场景 | 通用场景 |