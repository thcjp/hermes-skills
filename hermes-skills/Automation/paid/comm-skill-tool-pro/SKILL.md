...
license: Proprietary
edition: pro
description: "核心能力: 沟通协作领域的专业化 AI 辅助工具,提供企业级高级功能支持。Use when 需要AI模型调用、智能对话、Agent编排、LLM应用时使用。不适用于需要100%确定性的关键决策。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。"
...
**处理**: 解析跨渠道消息管理与统一收件箱的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回跨渠道消息管理与统一收件箱的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 情感分析与沟通健康度监测
情感分析与沟通健康度监测

**处理**: 解析情感分析与沟通健康度监测的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回情感分析与沟通健康度监测的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 关系图谱
关系图谱:可视化沟通网络与互动频率

**处理**: 解析关系图谱的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回关系图谱的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 沟通策略优化建议与 A/B 测
沟通策略优化建议与 A/B 测试

**处理**: 解析沟通策略优化建议与 A/B 测的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回沟通策略优化建议与 A/B 测的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队沟通规范与品牌语调一致性检
团队沟通规范与品牌语调一致性检查

**处理**: 解析团队沟通规范与品牌语调一致性检的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队沟通规范与品牌语调一致性检的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级沟通智能系、支持跨渠道消息管、关系图谱与沟通策、核心能力、沟通协作领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
- **自动化执行**: 企业级沟通智能系统,支持跨渠道消息管理、情感分析、关系图谱与沟通策略优化。核心能力: 沟通协作领域的专业化 AI 辅助工
