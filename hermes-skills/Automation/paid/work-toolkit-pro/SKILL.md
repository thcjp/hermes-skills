...
summary: "企业级办公效率系统,支持文档管理、流程自动化、团队协作与知识沉淀。核心能力: 办公效率领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 办公效率领域的专业化 AI 辅助工具,提供企业级高级功能支持。Use when 需要提升效率、自动化流程、批量处理、工作流优化时使用。不适用于需要人工创意判断的任务。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。提供结构化输出和错误处理机制。"
...
本工具是 **办公效率** 领域的 **PRO 版本** AI Skill,专为企业级场景与专业用户设计。通过自然语言指令驱动 AI Agent 执行任务,提供高级功能、批量操作与团队协同.
...
**处理**: 解析企业文档管理与版本控制的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回企业文档管理与版本控制的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 审批流程自动化与跟踪
审批流程自动化与跟踪

**处理**: 解析审批流程自动化与跟踪的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回审批流程自动化与跟踪的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 团队协作空间与知识共享
团队协作空间与知识共享

**处理**: 解析团队协作空间与知识共享的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队协作空间与知识共享的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 智能文档分类与全文检索
智能文档分类与全文检索

**处理**: 解析智能文档分类与全文检索的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回智能文档分类与全文检索的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与企业 OA/ERP/CRM 
与企业 OA/ERP/CRM 集成

**处理**: 解析与企业 OA/ERP/CRM 的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回与企业 OA/ERP/CRM 的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级办公效率系、支持文档管理、团队协作与知识沉、核心能力、办公效率领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 办公工具包专业版处理的输入数据或指令 |
...
- **自动化执行**: 企业级办公效率系统,支持文档管理、流程自动化、团队协作与知识沉淀。核心能力: 办公效率领域的专业化 AI 辅助工具,提供
