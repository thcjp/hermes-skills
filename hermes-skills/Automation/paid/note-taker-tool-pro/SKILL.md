...
summary: "企业级任务管理系统,支持多项目、标签系统、数据分析与团队任务共享。核心能力: 任务管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 任务管理领域的专业化 AI 辅助工具,提供企业级高级功能支持。Use when 需要项目管理、任务规划、进度跟踪、团队协作时使用。不适用于实际人员绩效评估。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。提供结构化输出和错误处理机制。"
...
**处理**: 解析多项目管理与标签分类系统的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多项目管理与标签分类系统的响应数据,包含状态码、结果和日志.
...
**处理**: 解析团队任务共享与分配的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队任务共享与分配的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 与日历集成自动安排任务
与日历集成自动安排任务

**处理**: 解析与日历集成自动安排任务的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回与日历集成自动安排任务的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 数据导出 CSV/JSON 供
数据导出 CSV/JSON 供分析

**处理**: 解析数据导出 CSV/JSON 供的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回数据导出 CSV/JSON 供的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级任务管理系、支持多项目、标签系统、数据分析与团队任、核心能力、任务管理领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 笔记记录器专业版处理的输入数据或指令 |
...
- **自动化执行**: 企业级任务管理系统,支持多项目、标签系统、数据分析与团队任务共享。核心能力: 任务管理领域的专业化 AI 辅助工具,提供
