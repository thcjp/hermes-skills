...
summary: "企业级知识管理系统,支持团队协作、全文检索、知识图谱与 AI 智能摘要。核心能力: 知识管理领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 知识管理领域的专业化 AI 辅助工具,提供企业级高级功能支持。Use when 需要AI模型调用、智能对话、Agent编排、LLM应用时使用。不适用于需要100%确定性的关键决策。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。"
...
**处理**: 解析团队协作笔记与共享知识库的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队协作笔记与共享知识库的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 全文检索与语义搜索
全文检索与语义搜索

**处理**: 解析全文检索与语义搜索的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回全文检索与语义搜索的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 知识图谱可视化与关系分析
知识图谱可视化与关系分析

**处理**: 解析知识图谱可视化与关系分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回知识图谱可视化与关系分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### AI 智能摘要与知识合成
AI 智能摘要与知识合成

**处理**: 解析AI 智能摘要与知识合成的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回AI 智能摘要与知识合成的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 多格式导入导出(Markdow
多格式导入导出(Markdown/Notion/Obsidian)

**处理**: 解析多格式导入导出(Markdow的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多格式导入导出(Markdow的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 笔记工具包专业版处理的输入数据或指令 |
...
- **自动化执行**: 企业级知识管理系统,支持团队协作、全文检索、知识图谱与 AI 智能摘要。核心能力: 知识管理领域的专业化 AI 辅助工具
