...
license: Proprietary
edition: pro
description: "笔记同步CLI专业版是在免费版基础上的全功能升级，为重度知识工作者提供企业级Markdown笔记库管理能力。除核心高频操作外，解锁批量操作、多Vault并行管理、自定义模板系统、Git自动同步、LLM智能整理、跨设备同步六大高级功能。Use when 需要AI模型调用、智能对话、Agent编排、LLM应用时使用。不适用于需要100%确定性的关键决策。"
