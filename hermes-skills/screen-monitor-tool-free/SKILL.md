...
description: "双模式屏幕共享工具,支持单次截图与定时监控,适合个人使用与远程协助"
license: Proprietary
...
**处理**: 按照skill规范执行双模式运行操作,遵循单一意图原则。
