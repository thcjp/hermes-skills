...
description: "提供Git常见操作辅助、冲突解决指引、提交规范检查与安全操作清单,适合开发者日常使用。"
license: Proprietary
...
**处理**: 按照skill规范执行常见操作辅助操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行冲突解决指引操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行提交规范检查操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行安全操作检查操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行常用配置模板操作,遵循单一意图原则。
