...
description: "AI生成内容验证与策略检查工具,支持黑白名单管理、内容分类与基础策略执行,适合个人开发者内容审核。"
license: Proprietary
...
**处理**: 按照skill规范执行内容策略检查操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行黑白名单管理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行内容分类标记操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行验证结果记录操作,遵循单一意图原则。
