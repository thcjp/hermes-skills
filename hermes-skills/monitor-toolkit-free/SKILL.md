...
description: "轻量级服务监控工具,支持HTTP/SSL/进程/磁盘检查,状态变更告警,适合个人项目"
license: Proprietary
...
**处理**: 按照skill规范执行HTTP 接口监控操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行SSL 证书检测操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行进程与端口检查操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行磁盘空间监控操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行状态变更告警操作,遵循单一意图原则。
