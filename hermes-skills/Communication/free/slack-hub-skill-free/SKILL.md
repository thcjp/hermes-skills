...
description: "Slack基础消息发送与公共频道列表，Bot Token直连Web API"
license: MIT
...
> **升级提示**：线程回复、工作区内容搜索、用户DM发送、频道名自动解析、速率限制感知重试等高级功能仅在 slack-hub-skill 付费版中提供。- 验证执行结果，确认输出符合预期格式
- 参考`公共频道列表`相关配置参数进行设置
#
## 适用场景
