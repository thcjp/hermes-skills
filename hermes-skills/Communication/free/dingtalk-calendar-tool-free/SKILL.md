...
description: "使用 mcporter CLI 管理钉钉日程,支持创建日程、查询闲忙与会议室预订"
license: Proprietary
...
**处理**: 按照skill规范执行创建日程并设置标题、时间与参与操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行查询指定时间范围内的日程列表操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行查询他人闲忙状态操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行查询空闲会议室并预订操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行更新和删除日程操作,遵循单一意图原则。
