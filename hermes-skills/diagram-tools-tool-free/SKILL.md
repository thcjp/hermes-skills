...
description: "支持 Mermaid 和 Graphviz 生成流程图、思维导图、时序图等多种图表"
license: Proprietary
...
**处理**: 按照skill规范执行使用 Mermaid 语法生成操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行使用 Graphviz DOT操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行支持思维导图、甘特图、饼图等多操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行提供主题颜色配置操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行生成数据图表(柱状图/折线图/操作,遵循单一意图原则。
