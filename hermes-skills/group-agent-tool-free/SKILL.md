...
description: "极简多Agent群组协作，像微信群一样拉群、@提及、广播与成员管理"
license: Proprietary
...
**处理**: 按照skill规范执行能力1：极简群组管理四件套操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力2：@提及定向通信操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力3：群公告与广播操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力4：消息归档查询操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力5：群组主题频道操作,遵循单一意图原则。
