...
description: "个人任务与日程管理工具,支持添加、查询、修改与归档任务"
license: Proprietary
...
**处理**: 按照skill规范执行添加任务到清单并设置截止日期操作,遵循单一意图原则。
**输出**: 返回添加任务到清单并设置截止日期的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行列出今日、本周或全部任务操作,遵循单一意图原则。
**输出**: 返回列出今日、本周或全部任务的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行修改任务标题、截止日期与状态操作,遵循单一意图原则。
**输出**: 返回修改任务标题、截止日期与状态的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行完成并归档任务操作,遵循单一意图原则。
**输出**: 返回完成并归档任务的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行查看任务历史记录操作,遵循单一意图原则。
**输出**: 返回查看任务历史记录的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
