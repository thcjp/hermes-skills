...
description: "生成结构化周报,包含本周完成、下周计划与问题风险,适合个人工作汇报"
license: Proprietary
...
**处理**: 按照skill规范执行按标准模板生成周报(本周完成/操作,遵循单一意图原则。
**输出**: 返回按标准模板生成周报(本周完成/的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行整合 Git 提交记录与任务系操作,遵循单一意图原则。
**输出**: 返回整合 Git 提交记录与任务系的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行支持 Markdown 格式输操作,遵循单一意图原则。
**输出**: 返回支持 Markdown 格式输的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行自定义周报模板操作,遵循单一意图原则。
**输出**: 返回自定义周报模板的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行导出为多种格式操作,遵循单一意图原则。
**输出**: 返回导出为多种格式的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
