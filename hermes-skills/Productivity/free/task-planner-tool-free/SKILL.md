...
description: "本地优先的任务规划工具,帮助拆解复杂任务、设定截止日期与管理子任务"
license: Proprietary
...
**处理**: 按照skill规范执行拆解复杂任务为可管理的子任务操作,遵循单一意图原则。
**输出**: 返回拆解复杂任务为可管理的子任务的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行为任务和子任务设定截止日期操作,遵循单一意图原则。
**输出**: 返回为任务和子任务设定截止日期的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行管理任务依赖关系操作,遵循单一意图原则。
**输出**: 返回管理任务依赖关系的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行标记任务为里程碑操作,遵循单一意图原则。
**输出**: 返回标记任务为里程碑的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行记录任务备注与上下文操作,遵循单一意图原则。
**输出**: 返回记录任务备注与上下文的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
