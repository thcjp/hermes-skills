...
description: "轻量数据可视化面板，聚合邮件、会话、任务多源数据，token保护，5秒自动刷新，一站式监控。"
license: Proprietary
...
**处理**: 按照skill规范执行功能一：多源数据聚合操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能二：token保护Web UI操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能三：5秒自动刷新操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能四：时间筛选操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能五：基础图表展示操作,遵循单一意图原则。
