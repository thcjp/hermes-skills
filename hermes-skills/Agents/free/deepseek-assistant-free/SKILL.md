...
description: "基于DeepSeek API的中文对话助手，支持通用对话、代码生成与基础推理能力。"
license: Proprietary
...
**处理**: 按照skill规范执行能力一：模型选择指引操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力二：对话请求模板操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力四：Token 成本预估操作,遵循单一意图原则。
