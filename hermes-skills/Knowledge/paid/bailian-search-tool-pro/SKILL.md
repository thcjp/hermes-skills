...
summary: "企业级AI搜索,支持批量查询、结果缓存、并发搜索与搜索分析,面向团队生产场景。企业级 AI 优化网页搜索工具,在免费版核心能力之上,提供批量查询、结果缓存、"
license: Proprietary
edition: pro
description: "企业级 AI 优化网页搜索工具,在免费版核心能力之上,提供批量查询、结果缓存、。Use when 需要SEO优化、关键词分析、排名提升、搜索流量优化时使用。不适用于黑帽SEO手段。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。"
...
| 参数名 | 类型 | 必填 | 说明 |
|:-----|:-----|:-----|:-----|
| input | string | 是 | 百炼搜索工具-专业版处理的输入数据或指令 |
...
RESEARCH_TOPICS = [
    ...
    {"query": "RAG技术优选实践", "depth": 15, "purpose": "方案设计"},
...
- **自动化执行**: 企业级AI搜索,支持批量查询、结果缓存、并发搜索与搜索分析,面向团队生产场景。企业级 AI 优化网页搜索工具,在免费版核
