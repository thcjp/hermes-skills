...
license: Proprietary
edition: pro
description: "论文写作助手专业版,面向高校、研究机构和企业研发团队提供深度的学术写作解决方案。支持批量文档处理、团队协作、查重检测、多语言学术规范、跨文档引用管理等高级能力。Use。Use when 需要文本翻译、多语言转换、本地化处理时使用。不适用于专业医学法律翻译认证。适用于独立开发者、企业团队和自动化工作流场景。"
...
**处理**: 解析批量文档处理的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回批量文档处理的响应数据,包含状态码、结果和日志.
...
**处理**: 解析团队协作写作的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回团队协作写作的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析跨文档引用网络的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回跨文档引用网络的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析多语言学术规范的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多语言学术规范的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 解析学术伦理检查的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回学术伦理检查的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
```json
{
  "success": true,
  "data": {
    "result": "论文写作助手专业版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "thesis helper pro"
    }
  },
...
- **自动化执行**: 企业级学术写作平台,支持批量文档处理、团队协作、查重检测与多语言学术规范。论文写作助手专业版,面向高校、研究机构和企业研
