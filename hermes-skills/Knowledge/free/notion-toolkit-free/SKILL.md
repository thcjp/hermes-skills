...
description: "通过 Notion API 创建和管理页面、数据库与块,支持搜索、查询与内容更新"
license: Proprietary
...
**输入**: 用户提供搜索页面和数据源(数据库)所需的指令和必要参数。
**处理**: 按照skill规范执行搜索页面和数据源(数据库)操作,遵循单一意图原则。
**输出**: 返回搜索页面和数据源(数据库)的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 获取页面内容与块结构
获取页面内容与块结构

**输入**: 用户提供获取页面内容与块结构所需的指令和必要参数。
**处理**: 按照skill规范执行获取页面内容与块结构操作,遵循单一意图原则。
**输出**: 返回获取页面内容与块结构的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 在数据源中创建页面并设置属性
在数据源中创建页面并设置属性

**输入**: 用户提供在数据源中创建页面并设置属性所需的指令和必要参数。
**处理**: 按照skill规范执行在数据源中创建页面并设置属性操作,遵循单一意图原则。
**输出**: 返回在数据源中创建页面并设置属性的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 查询数据源并过滤排序
查询数据源并过滤排序

**输入**: 用户提供查询数据源并过滤排序所需的指令和必要参数。
**处理**: 按照skill规范执行查询数据源并过滤排序操作,遵循单一意图原则。
**输出**: 返回查询数据源并过滤排序的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 更新页面属性与添加块
更新页面属性与添加块

**输入**: 用户提供更新页面属性与添加块所需的指令和必要参数。
**处理**: 按照skill规范执行更新页面属性与添加块操作,遵循单一意图原则。
**输出**: 返回更新页面属性与添加块的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
