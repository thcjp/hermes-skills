...
description: "命令行任务与笔记管理工具,支持添加、列表、完成、优先级与提醒功能"
license: Proprietary
...
**输入**: 用户提供添加任务到待办列表所需的指令和必要参数。
**处理**: 按照skill规范执行添加任务到待办列表操作,遵循单一意图原则。
**输出**: 返回添加任务到待办列表的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 列出所有当前事项
列出所有当前事项

**输入**: 用户提供列出所有当前事项所需的指令和必要参数。
**处理**: 按照skill规范执行列出所有当前事项操作,遵循单一意图原则。
**输出**: 返回列出所有当前事项的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 标记事项为已完成
标记事项为已完成

**输入**: 用户提供标记事项为已完成所需的指令和必要参数。
**处理**: 按照skill规范执行标记事项为已完成操作,遵循单一意图原则。
**输出**: 返回标记事项为已完成的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 设置事项优先级
设置事项优先级

**输入**: 用户提供设置事项优先级所需的指令和必要参数。
**处理**: 按照skill规范执行设置事项优先级操作,遵循单一意图原则。
**输出**: 返回设置事项优先级的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 查看今日与本周事项
查看今日与本周事项

**输入**: 用户提供查看今日与本周事项所需的指令和必要参数。
**处理**: 按照skill规范执行查看今日与本周事项操作,遵循单一意图原则。
**输出**: 返回查看今日与本周事项的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
