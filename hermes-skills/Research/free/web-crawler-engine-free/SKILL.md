...
description: "轻量级网页与社区数据抓取工具，支持本地归档、搜索查询与新鲜度检查。"
license: Proprietary
...
**处理**: 按照skill规范执行能力一：网页内容抓取操作,遵循单一意图原则。
**输出**: 返回能力一：网页内容抓取的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力二：社区消息归档操作,遵循单一意图原则。
**输出**: 返回能力二：社区消息归档的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行能力三：本地全文搜索操作,遵循单一意图原则。
**输出**: 返回能力三：本地全文搜索的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行能力四：数据新鲜度检查操作,遵循单一意图原则。
**输出**: 返回能力四：数据新鲜度检查的执行结果,包含操作状态和输出数据。
