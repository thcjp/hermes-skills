...
description: "通过自然语言指令驱动本地 Chrome 浏览器的轻量级自动化工具,适合个人开发者日常网页交互"
license: Proprietary
...
**处理**: 按照skill规范执行自然语言指令驱动操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行元素发现与截图操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行本地浏览器模式操作,遵循单一意图原则。
