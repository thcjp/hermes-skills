...
description: "轻量级RSS/Atom订阅阅读器,支持分类管理、关键词过滤与多种输出格式,适合个人内容研究"
license: Proprietary
...
**处理**: 按照skill规范执行订阅源数量建议操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持内置定时调度(需手动或系操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持邮件/IM推送操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行输出格式固定为三种(列表/id操作,遵循单一意图原则。
