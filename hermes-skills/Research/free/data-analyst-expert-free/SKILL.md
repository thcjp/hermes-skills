...
description: "面向委派任务的数据分析助手,支持文件操作、代码执行与结论结构化输出的免费核心能力。"
license: Proprietary
...
**处理**: 按照skill规范执行1 任务理解框架操作,遵循单一意图原则。
**输出**: 返回1 任务理解框架的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行2 文件操作规范操作,遵循单一意图原则。
**输出**: 返回2 文件操作规范的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行3 代码执行驱动操作,遵循单一意图原则。
**输出**: 返回3 代码执行驱动的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行4 结论结构化输出操作,遵循单一意图原则。
**输出**: 返回4 结论结构化输出的执行结果,包含操作状态和输出数据。
