...
description: "Discord Bot开发入门指南，覆盖命令注册、消息处理、认证安全等核心能力。"
license: Proprietary
...
**处理**: 按照skill规范执行能力一：Bot 创建与 Token 管理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力二：斜杠命令注册操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力三：消息收发操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力四：交互响应操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行能力五：基础权限配置操作,遵循单一意图原则。
