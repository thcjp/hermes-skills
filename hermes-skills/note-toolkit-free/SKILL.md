...
description: "知识捕获与连接系统,支持自动组织、检索与笔记间关联,纯本地存储保护隐私"
license: Proprietary
...
**处理**: 按照skill规范执行从任意上下文捕获笔记操作,遵循单一意图原则。
**输出**: 返回从任意上下文捕获笔记的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行按主题自动分类与组织操作,遵循单一意图原则。
**输出**: 返回按主题自动分类与组织的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行搜索并检索相关笔记操作,遵循单一意图原则。
**输出**: 返回搜索并检索相关笔记的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行建立笔记间显式连接操作,遵循单一意图原则。
**输出**: 返回建立笔记间显式连接的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行会议准备操作,遵循单一意图原则。
**输出**: 返回会议准备的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
