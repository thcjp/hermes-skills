...
description: "AI 写作团队负责人,协调研究、结构、风格与质量检查,产出高质量文档"
license: Proprietary
...
**处理**: 按照skill规范执行研究协调操作,遵循单一意图原则。
**输出**: 返回研究协调的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行结构规划操作,遵循单一意图原则。
**输出**: 返回结构规划的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行风格匹配操作,遵循单一意图原则。
**输出**: 返回风格匹配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行多轮迭代操作,遵循单一意图原则。
**输出**: 返回多轮迭代的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
