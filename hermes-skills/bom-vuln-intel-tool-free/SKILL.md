...
description: "软件物料清单(SBOM)生成与依赖漏洞检查工具,支持基础包扫描与OSV/GHSA查询,适合个人开发者日常使用。"
license: Proprietary
...
**处理**: 按照skill规范执行包信息查询操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行基础SBOM生成操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行OSV漏洞查询操作,遵循单一意图原则。
