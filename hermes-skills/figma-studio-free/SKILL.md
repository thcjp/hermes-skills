...
description: "轻量级Figma设计文件读取工具，覆盖文件解析、评论管理与图片导出，60秒上手。"
license: Proprietary
...
**处理**: 按照skill规范执行功能1：OAuth2认证流程操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能2：文件与节点读取操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能3：评论管理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能4：设计令牌提取操作,遵循单一意图原则。
