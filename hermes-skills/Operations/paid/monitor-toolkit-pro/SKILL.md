...
summary: "企业级监控平台,支持多目标批量监控、告警升级、历史趋势分析与团队协作。企业级监控工具专业版,面向团队与生产环境运维。核心能力:"
license: Proprietary
edition: pro
description: "企业级监控工具专业版,面向团队与生产环境运维。核心能力:。Use when 需要系统监控、日志分析、运维告警、部署管理时使用。不适用于物理硬件维修。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。提供结构化输出和错误处理机制。支持多场景应用和灵活配置。"
  - 多目标批量监控与分布式探针
...
- **数据库**: SQLite(默认)或 MySQL/数据库(大规模部署)
...
- **自动化执行**: 企业级监控平台,支持多目标批量监控、告警升级、历史趋势分析与团队协作。企业级监控工具专业版,面向团队与生产环境运维。核心
