...
description: "个人效率助手,帮助记录想法、追踪进度、整理笔记与生成工作总结"
license: Proprietary
...
**输入**: 用户提供快速记录想法与待办事项所需的指令和必要参数。
**处理**: 按照skill规范执行快速记录想法与待办事项操作,遵循单一意图原则。
**输出**: 返回快速记录想法与待办事项的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 追踪任务进度与状态
追踪任务进度与状态

**输入**: 用户提供追踪任务进度与状态所需的指令和必要参数。
**处理**: 按照skill规范执行追踪任务进度与状态操作,遵循单一意图原则。
**输出**: 返回追踪任务进度与状态的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 整理笔记并按主题分类
整理笔记并按主题分类

**输入**: 用户提供整理笔记并按主题分类所需的指令和必要参数。
**处理**: 按照skill规范执行整理笔记并按主题分类操作,遵循单一意图原则。
**输出**: 返回整理笔记并按主题分类的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 生成每日工作日报
生成每日工作总结

**输入**: 用户提供生成每日工作总结所需的指令和必要参数。
**处理**: 按照skill规范执行生成每日工作总结操作,遵循单一意图原则。
**输出**: 返回生成每日工作总结的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 查看历史记录与统计
查看历史记录与统计

**输入**: 用户提供查看历史记录与统计所需的指令和必要参数。
**处理**: 按照skill规范执行查看历史记录与统计操作,遵循单一意图原则。
**输出**: 返回查看历史记录与统计的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
