...
description: "管理 Python 项目环境,支持虚拟环境创建、依赖安装与环境诊断"
license: Proprietary
...
**输入**: 用户提供检测当前 Python 环境与所需的指令和必要参数。
**处理**: 按照skill规范执行检测当前 Python 环境与操作,遵循单一意图原则。
**输出**: 返回检测当前 Python 环境与的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 创建或刷新项目虚拟环境
创建或刷新项目虚拟环境

**输入**: 用户提供创建或刷新项目虚拟环境所需的指令和必要参数。
**处理**: 按照skill规范执行创建或刷新项目虚拟环境操作,遵循单一意图原则。
**输出**: 返回创建或刷新项目虚拟环境的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 安装项目依赖与开发包
安装项目依赖与开发包

**输入**: 用户提供安装项目依赖与开发包所需的指令和必要参数。
**处理**: 按照skill规范执行安装项目依赖与开发包操作,遵循单一意图原则。
**输出**: 返回安装项目依赖与开发包的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 运行测试与工具检查
运行测试与工具检查

**输入**: 用户提供运行测试与工具检查所需的指令和必要参数。
**处理**: 按照skill规范执行运行测试与工具检查操作,遵循单一意图原则。
**输出**: 返回运行测试与工具检查的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 环境诊断与故障排查
环境诊断与故障排查

**输入**: 用户提供环境诊断与故障排查所需的指令和必要参数。
**处理**: 按照skill规范执行环境诊断与故障排查操作,遵循单一意图原则。
**输出**: 返回环境诊断与故障排查的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
