...
description: "通过 porteden CLI 安全管理 Google 与 Outlook 日历,支持事件查询、创建与更新"
license: Proprietary
...
**处理**: 按照skill规范执行列出所有日历及 ID操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行查询今日/本周/自定义范围事件操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行按关键词搜索事件操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行创建事件并设置参与人与位置操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行更新和删除事件操作,遵循单一意图原则。
