...
description: "轻量级XML与JSON互转工具，覆盖属性处理、命名空间与单文件转换，60秒上手。"
license: Proprietary
...
**处理**: 按照skill规范执行功能1：双向转换约定操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能2：命名空间处理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能3：CDATA与注释处理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行功能4：JSON转XML规则操作,遵循单一意图原则。
