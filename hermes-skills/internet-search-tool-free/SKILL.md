...
description: "基于 SearXNG 的多引擎聚合搜索工具，支持分类路由与智能查询，聚合多个搜索引擎结果，适合个人日常信息检索。"
license: Proprietary
...
**处理**: 按照skill规范执行不支持批量查询操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持结果导出操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持自定义引擎配置操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持搜索结果缓存操作,遵循单一意图原则。
