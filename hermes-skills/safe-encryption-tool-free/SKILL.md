...
description: "基于SAFE CLI的文件加密解密工具,支持量子安全算法,适合个人数据保护"
license: Proprietary
...
**处理**: 按照skill规范执行文件加密操作,遵循单一意图原则。
**输出**: 返回文件加密的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行文件解密操作,遵循单一意图原则。
**输出**: 返回文件解密的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行量子安全算法操作,遵循单一意图原则。
**输出**: 返回量子安全算法的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行元数据嵌入操作,遵循单一意图原则。
**输出**: 返回元数据嵌入的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行跨平台操作,遵循单一意图原则。
**输出**: 返回跨平台的执行结果,包含操作状态和输出数据。
