...
description: "通过 gcalcli 管理 Google 日历事件,支持创建、列出和删除日程,适合个人时间管理"
license: Proprietary
...
**输入**: 用户提供列出指定日期范围内的日程事件所需的指令和必要参数。
**处理**: 按照skill规范执行列出指定日期范围内的日程事件操作,遵循单一意图原则。
...
**输入**: 用户提供创建新日历事件并设置标题、时间所需的指令和必要参数。
**处理**: 按照skill规范执行创建新日历事件并设置标题、时间操作,遵循单一意图原则。
...
**输入**: 用户提供按关键词搜索并删除事件所需的指令和必要参数。
**处理**: 按照skill规范执行按关键词搜索并删除事件操作,遵循单一意图原则。
...
**输入**: 用户提供支持 CalDAV 协议备份所需的指令和必要参数。
**处理**: 按照skill规范执行支持 CalDAV 协议备份操作,遵循单一意图原则。
...
**输入**: 用户提供命令行快速操作无需打开浏览器所需的指令和必要参数。
**处理**: 按照skill规范执行命令行快速操作无需打开浏览器操作,遵循单一意图原则。
