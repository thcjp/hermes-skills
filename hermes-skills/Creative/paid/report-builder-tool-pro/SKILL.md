...
summary: "企业级报告管理系统,支持多源数据聚合、智能摘要、模板管理与自动分发。核心能力: 工作汇报领域的专业化 AI 辅助工具,提供企业级高级功能支持."
license: Proprietary
edition: pro
description: "核心能力: 工作汇报领域的专业化 AI 辅助工具,提供企业级高级功能支持。Use when 需要数据分析、报表生成、统计洞察、数据可视化时使用。不适用于实时流数据处理。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。输出结果可直接使用，减少二次加工成本。提供结构化输出和错误处理机制。"
...
**处理**: 解析多源数据聚合的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回多源数据聚合的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### AI 智能摘要与关键信息提炼
AI 智能摘要与关键信息提炼

**处理**: 解析AI 智能摘要与关键信息提炼的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回AI 智能摘要与关键信息提炼的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 报告模板管理与企业品牌适配
报告模板管理与企业品牌适配

**处理**: 解析报告模板管理与企业品牌适配的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回报告模板管理与企业品牌适配的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 自动分发
自动分发:邮件/IM/Webhook 推送

**处理**: 解析自动分发的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回自动分发的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作

### 报告数据分析
报告数据分析:工作趋势与效率洞察

**处理**: 解析报告数据分析的输入参数,完成核心逻辑,返回结构化响应.
**输出**: 返回报告数据分析的响应数据,包含状态码、结果和日志.
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**能力覆盖范围**：本skill的核心能力覆盖以下场景关键词：企业级报告管理系、支持多源数据聚合、模板管理与自动分、核心能力、工作汇报领域的专、辅助工具、提供企业级高级功、能支持等。这些关键词对应description中声明的使用场景,均已在上述能力点中提供对应的操作支持.
## 使用场景
...
| 参数名 | 类型 | 必填 | 说明 |
|---:|---:|---:|---:|
| input | string | 是 | 报告汇总构建器专业版处理的输入数据或指令 |
...
```json
{
  "success": true,
  "data": {
    "result": "报告汇总构建器专业版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "report builder pro"
    }
  },
...
- **自动化执行**: 企业级报告管理系统,支持多源数据聚合、智能摘要、模板管理与自动分发。核心能力: 工作汇报领域的专业化 AI 辅助工具,提
