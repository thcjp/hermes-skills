...
description: "创建 SEO 优化博客文章,包含关键词集成、元描述生成与结构化标题,适合个人博主"
license: Proprietary
...
**处理**: 按照skill规范执行根据目标关键词生成 SEO 友操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行自动撰写 150-160 字符操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行生成 H2/H3 层级结构化大操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行自然融入主关键词与长尾变体操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行提供内链外链建议与图片 Alt操作,遵循单一意图原则。
