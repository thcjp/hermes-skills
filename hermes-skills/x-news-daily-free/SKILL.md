...
description: "抓取 X.com 关键词热门新闻 Top 10，生成基础中文海报。"
license: MIT
...
执行Top 10 提取操作,处理用户输入并返回结果。

**输入**: 用户提供Top 10 提取所需的参数和指令。

**输出**: 返回Top 10 提取的处理结果。- 验证执行结果，确认输出符合预期格式
- 参考`Top 10 提取`相关配置参数进行设置
### 自动中英翻译
