...
description: "统一 Web 仪表盘管理任务队列、监控系统指标与查看网络状态"
license: Proprietary
...
**输入**: 用户提供实时监控 CPU/内存/负载与所需的指令和必要参数。
**处理**: 按照skill规范执行实时监控 CPU/内存/负载与操作,遵循单一意图原则。
...
**输入**: 用户提供任务队列查看与管理所需的指令和必要参数。
**处理**: 按照skill规范执行任务队列查看与管理操作,遵循单一意图原则。
...
**输入**: 用户提供完成当前任务与清空队列所需的指令和必要参数。
**处理**: 按照skill规范执行完成当前任务与清空队列操作,遵循单一意图原则。
...
**输入**: 用户提供日志输出流查看与过滤所需的指令和必要参数。
**处理**: 按照skill规范执行日志输出流查看与过滤操作,遵循单一意图原则。
...
**输入**: 用户提供CLI 快速状态检查所需的指令和必要参数。
**处理**: 按照skill规范执行CLI 快速状态检查操作,遵循单一意图原则。
