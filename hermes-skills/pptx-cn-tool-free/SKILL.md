...
description: "创建与编辑中文 PowerPoint 演示文稿,支持中文排版优化与本地化模板"
license: Proprietary
...
**处理**: 按照skill规范执行创建中文演示文稿并优化排版操作,遵循单一意图原则。
**输出**: 返回创建中文演示文稿并优化排版的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行编辑现有幻灯片中文内容操作,遵循单一意图原则。
**输出**: 返回编辑现有幻灯片中文内容的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行中文字体与间距管理操作,遵循单一意图原则。
**输出**: 返回中文字体与间距管理的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行支持中文模板应用操作,遵循单一意图原则。
**输出**: 返回支持中文模板应用的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
