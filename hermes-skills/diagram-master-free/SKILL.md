...
description: "专业SVG图表生成工具，支持架构图、流程图、时序图等九种图表类型，暗色主题自包含输出。"
license: Proprietary
...
**处理**: 按照skill规范执行九种图表类型操作,遵循单一意图原则。
**输出**: 返回九种图表类型的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行语义化配色系统操作,遵循单一意图原则。
**输出**: 返回语义化配色系统的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行排版规则操作,遵循单一意图原则。
**输出**: 返回排版规则的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行SVG图层渲染顺序操作,遵循单一意图原则。
**输出**: 返回SVG图层渲染顺序的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行组件模式操作,遵循单一意图原则。
**输出**: 返回组件模式的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行中文文本适配操作,遵循单一意图原则。
**输出**: 返回中文文本适配的执行结果,包含操作状态和输出数据。
