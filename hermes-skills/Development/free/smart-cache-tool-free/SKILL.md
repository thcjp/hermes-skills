...
description: "智能缓存管理工具,支持LRU/LFU策略与自动失效,适合个人项目性能优化"
license: Proprietary
...
**处理**: 按照skill规范执行LRU 缓存策略操作,遵循单一意图原则。
**输出**: 返回LRU 缓存策略的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行LFU 缓存策略操作,遵循单一意图原则。
**输出**: 返回LFU 缓存策略的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行TTL 自动过期操作,遵循单一意图原则。
**输出**: 返回TTL 自动过期的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行命中率统计操作,遵循单一意图原则。
**输出**: 返回命中率统计的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行手动管理操作,遵循单一意图原则。
**输出**: 返回手动管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行持久化支持操作,遵循单一意图原则。
**输出**: 返回持久化支持的执行结果,包含操作状态和输出数据。
