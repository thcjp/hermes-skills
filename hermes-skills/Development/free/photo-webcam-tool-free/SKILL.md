...
description: "网络摄像头快照获取工具,支持收藏列表管理与图片下载,适合个人使用"
license: Proprietary
...
**处理**: 按照skill规范执行收藏列表管理操作,遵循单一意图原则。
