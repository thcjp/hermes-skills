...
description: "Python开发优选实践助手,避免可变默认参数、导入陷阱与常见运行时问题"
license: Proprietary
...
**输入**: 用户提供常见陷阱检测所需的指令和必要参数。
**处理**: 按照skill规范执行常见陷阱检测操作,遵循单一意图原则。
**输出**: 返回常见陷阱检测的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供类型系统指导所需的指令和必要参数。
**处理**: 按照skill规范执行类型系统指导操作,遵循单一意图原则。
**输出**: 返回类型系统指导的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供集合操作规范所需的指令和必要参数。
**处理**: 按照skill规范执行集合操作规范操作,遵循单一意图原则。
**输出**: 返回集合操作规范的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供函数式编程所需的指令和必要参数。
**处理**: 按照skill规范执行函数式编程操作,遵循单一意图原则。
**输出**: 返回函数式编程的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供并发编程建议所需的指令和必要参数。
**处理**: 按照skill规范执行并发编程建议操作,遵循单一意图原则。
**输出**: 返回并发编程建议的执行结果,包含操作状态和输出数据。
...
**输入**: 用户提供导入管理所需的指令和必要参数。
**处理**: 按照skill规范执行导入管理操作,遵循单一意图原则。
**输出**: 返回导入管理的执行结果,包含操作状态和输出数据。

### 7. 测试编写

pytest 框架使用,mock 与 fixtures 优选实践。

**输入**: 用户提供测试编写所需的指令和必要参数。
**处理**: 按照skill规范执行测试编写操作,遵循单一意图原则。
**输出**: 返回测试编写的执行结果,包含操作状态和输出数据。
