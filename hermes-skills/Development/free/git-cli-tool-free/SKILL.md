...
description: "提供Git CLI快速参考、状态检查、暂存提交与分支同步,适合开发者日常命令行操作。"
license: Proprietary
...
**处理**: 按照skill规范执行快速参考表操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行仓库状态检查操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行暂存与提交操作,遵循单一意图原则。
