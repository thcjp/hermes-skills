...
description: "轻量级代码仓库 issue/PR 归档搜索工具，支持本地缓存查询与新鲜度检测，适合个人开发者日常代码仓库管理。"
license: Proprietary
...
**处理**: 按照skill规范执行单次仅支持查询 1 个仓库操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行归档数据需手动更新同步操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持重复 issue 聚类分操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持多仓库批量管理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行不支持团队协作共享操作,遵循单一意图原则。
