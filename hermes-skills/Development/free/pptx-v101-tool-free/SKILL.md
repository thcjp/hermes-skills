...
description: "创建与编辑 PowerPoint 演示文稿,注重布局保真与内容质量的双重保障"
license: Proprietary
...
**处理**: 按照skill规范执行选择正确的工作流(读取/编辑/操作,遵循单一意图原则。
**输出**: 返回选择正确的工作流(读取/编辑/的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行清点幻灯片布局与占位符操作,遵循单一意图原则。
**输出**: 返回清点幻灯片布局与占位符的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行内容与占位符精准匹配操作,遵循单一意图原则。
**输出**: 返回内容与占位符精准匹配的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行保留演示文稿视觉语言操作,遵循单一意图原则。
**输出**: 返回保留演示文稿视觉语言的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行内容质量与视觉质量分别检查操作,遵循单一意图原则。
**输出**: 返回内容质量与视觉质量分别检查的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
