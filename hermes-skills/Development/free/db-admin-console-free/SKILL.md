...
description: "数据库表结构设计、数据操作、查询优化与事务安全的免费核心能力,支持基础 DDL/DML 操作。"
license: Proprietary
...
**处理**: 按照skill规范执行1 表结构设计操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行2 数据插入操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行3 查询优化操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行4 类型处理操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行5 事务安全操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行6 数据库维护操作,遵循单一意图原则。
