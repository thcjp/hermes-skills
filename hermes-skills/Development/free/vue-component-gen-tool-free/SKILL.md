...
description: "面向个人开发者的Vue 3组件模板生成工具,支持Composition API与TypeScript单文件组件。Use when 用户需要vue-component-gen-tool-free相关功能时使用。不适用于超出本技能能力范围的复杂需求。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。"
license: Proprietary
...
| API 类型 | 语法 | 推荐度 | 说明 |
| --- | --- | --- | --- |
| `composition` | `<script setup>` | 推荐 | Vue 3 优选实践,简洁高效 |
