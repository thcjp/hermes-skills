...
description: "macOS屏幕截图与录屏工具,支持全屏截图、区域截图与基础录屏,适合个人开发者快速捕获屏幕内容。"
license: Proprietary
...
**处理**: 按照skill规范执行全屏截图操作,遵循单一意图原则。
**输出**: 返回全屏截图的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行区域截图操作,遵循单一意图原则。
**输出**: 返回区域截图的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行窗口截图操作,遵循单一意图原则。
**输出**: 返回窗口截图的执行结果,包含操作状态和输出数据。
- 执行此能力时使用`input_params`参数,支持创建/查询/导出操作
...
**处理**: 按照skill规范执行基础屏幕录制操作,遵循单一意图原则。
**输出**: 返回基础屏幕录制的执行结果,包含操作状态和输出数据。
