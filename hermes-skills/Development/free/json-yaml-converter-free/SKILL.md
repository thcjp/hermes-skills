...
description: "轻量级JSON与YAML互转工具，覆盖缩进规范、注释保留与单文件转换，60秒上手。"
license: Proprietary
...
**处理**: 按照skill规范执行功能1：双向无损转换操作,遵循单一意图原则。
**输出**: 返回功能1：双向无损转换的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能2：缩进规范与风格控制操作,遵循单一意图原则。
**输出**: 返回功能2：缩进规范与风格控制的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能3：锚点与别名处理操作,遵循单一意图原则。
**输出**: 返回功能3：锚点与别名处理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行功能4：多文档YAML处理操作,遵循单一意图原则。
**输出**: 返回功能4：多文档YAML处理的执行结果,包含操作状态和输出数据。
