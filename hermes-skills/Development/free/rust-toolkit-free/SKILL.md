...
description: "Rust开发优选实践助手,避免所有权、借用与生命周期常见陷阱,适合个人学习"
license: Proprietary
...
**处理**: 按照skill规范执行生命周期标注操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行Trait 与泛型操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行Cargo 配置操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行编译错误解读操作,遵循单一意图原则。
