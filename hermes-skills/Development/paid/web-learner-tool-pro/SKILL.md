...
license: Proprietary
edition: pro
description: "自主学习助手专业版,面向企业团队和专业研究人员提供深度的知识获取能力。支持批量主题学习、知识库管理、定时知识更新、团队协作等高级功能。Use。Use when 需要提升效率、自动化流程、批量处理、工作流优化时使用。不适用于需要人工创意判断的任务。适用于独立开发者、企业团队和自动化工作流场景。支持中文交互，无需复杂配置即开即用。"
...
```json
{
  "success": true,
  "data": {
    "result": "自主学习助手专业版处理结果",
    "execution_time": "0.5s",
    "metadata": {
      "version": "1.0",
      "processor": "web learner pro"
    }
  },
...
- **自动化执行**: 企业级知识获取平台,支持批量学习、知识库管理、定时更新与团队协作。自主学习助手专业版,面向企业团队和专业研究人员提供深度
