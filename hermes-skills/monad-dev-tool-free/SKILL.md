...
description: "Monad区块链DApp开发助手,支持合约部署、验证与前端集成,适合个人开发者快速上手"
license: Proprietary
...
**处理**: 按照skill规范执行测试网合约部署操作,遵循单一意图原则。
**输出**: 返回测试网合约部署的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行合约验证操作,遵循单一意图原则。
**输出**: 返回合约验证的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行标准合约模板操作,遵循单一意图原则。
**输出**: 返回标准合约模板的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行钱包管理操作,遵循单一意图原则。
**输出**: 返回钱包管理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行前端集成指导操作,遵循单一意图原则。
**输出**: 返回前端集成指导的执行结果,包含操作状态和输出数据。
