...
description: "CSV、JSON、XML、YAML、TOML 等格式互转的免费核心能力,支持单文件快速转换。"
license: Proprietary
...
**处理**: 按照skill规范执行1 支持的格式矩阵操作,遵循单一意图原则。
**输出**: 返回1 支持的格式矩阵的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行2 嵌套结构保留操作,遵循单一意图原则。
**输出**: 返回2 嵌套结构保留的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行3 类型智能推断操作,遵循单一意图原则。
**输出**: 返回3 类型智能推断的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行4 编码自动处理操作,遵循单一意图原则。
**输出**: 返回4 编码自动处理的执行结果,包含操作状态和输出数据。
...
**处理**: 按照skill规范执行5 边界情况处理操作,遵循单一意图原则。
**输出**: 返回5 边界情况处理的执行结果,包含操作状态和输出数据。
