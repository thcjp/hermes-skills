...
description: "轻量级Telegram Bot配置与跨实例聊天工具,支持用户艾特、消息收发与基础群组管理。"
license: Proprietary
...
**处理**: 按照skill规范执行Bot 创建与配置操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行跨实例聊天操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行用户艾特(@提及)操作,遵循单一意图原则。
...
**处理**: 按照skill规范执行基础群组管理操作,遵循单一意图原则。
